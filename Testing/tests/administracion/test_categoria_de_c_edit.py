...
def test_edit_categoria_de_capacitaciones(browser) :
    ...
    create_categoria_capacitaciones = Edit_Categoria_de_Capacitaciones(browser)
    ...
    create_categoria_capacitaciones.update_categoria_de_capacitaciones(campo_buscar_xpath, trespuntos_btn_xpath, btn2_editar, guardar_xpath)
