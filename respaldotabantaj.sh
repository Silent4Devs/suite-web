...
backup_dir="/var/respaldos/data/backups/$backup_time"
...
docker compose exec postgres-tabantaj env PGPASSWORD="secret" pg_dump -U "homestead" "homestead" | gzip -9 >"$backup_dir/dumps/tabantaj.sql.gz"
