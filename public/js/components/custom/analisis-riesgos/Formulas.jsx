                ...
                formulas.map((item,index)=>{
                    return(
                        <React.Fragment key={index}>
                            <RecordFormula item={item} handleChangeTitle={handleChangeTitle} handleChangeStatus={handleChangeStatus}
                                           deleteFormula={deleteFormula} options={options} handleChangeSection={handleChangeSection}/>
                        </React.Fragment>
                    )
                })
            }
