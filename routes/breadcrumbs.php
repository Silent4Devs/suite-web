...
Breadcrumbs::for('admin.iso27001.guia', function ($trail) {
    $trail->push('Sistema de Gestión', route('admin.iso27001.guia'));
});

Breadcrumbs::for('admin.analisisdebrechas.index', function ($trail) {
    $trail->push('Sistema de Gestión', route('admin.iso27001.guia'));
    $trail->push('Contexto', route('admin.iso27001.guia') . '#contexto');
...
Breadcrumbs::for('dashboard-iso27001', function ($trail) {
    $trail->parent('admin.iso27001.guia');
...
// $trail->parent('admin.iso27001.guia');                   generar reporte-------------
// $trail->push('', route('admin..index'));
// });

Breadcrumbs::for('admin.comiteseguridads.index', function ($trail) {
    $trail->parent('admin.iso27001.guia');
    $trail->push('Liderazgo', route('admin.iso27001.guia') . '#liderazgo');
...
//  	$trail->parent('admin.iso27001.guia');
//     $trail->push('Soporte',route('admin.iso27001.guia').'#soporte');
...
Breadcrumbs::for('admin.planificacion-controls.index', function ($trail) {
    $trail->parent('admin.iso27001.guia');
    $trail->push('Operación', route('admin.iso27001.guia') . '#operacion');
...
Breadcrumbs::for('admin.indicadores-sgsis.index', function ($trail) {
    $trail->parent('admin.iso27001.guia');
    $trail->push('Evaluacion', route('admin.iso27001.guia') . '#evaluacion');
...
Breadcrumbs::for('admin.accion-correctivas.index', function ($trail) {
    $trail->parent('admin.iso27001.guia');
    $trail->push('Mejora', route('admin.iso27001.guia') . '#mejora');
