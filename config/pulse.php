    ...
    */
    ...
    'recorders' => [
        ...
        \Vcian\Pulse\PulseActiveSessions\Recorders\PulseActiveSessionRecorder::class => [
            ...
            'sample_rate' => env('PULSE_ACTIVE_SESSIONS_SAMPLE_RATE', 1),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        \Schmeits\Pulse\DatabaseTableInfo\Recorders\TableInfoRecorder::class => [
            'enabled' => env('PULSE_TABLE_INFO_ENABLED', true),
            'sample_rate' => env('PULSE_TABLE_INFO_SAMPLE_RATE', 1),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
        ...
        \Vcian\Pulse\PulseDockerMonitor\Recorders\PulseDockerMonitorRecorder::class => [
            'enabled' => env('PULSE_DOCKER_MONITOR_ENABLED', true),
            'sample_rate' => env('PULSE_DOCKER_MONITOR_SAMPLE_RATE', 1),
            'ignore' => [
                // '/^Package\\\\Jobs\\\\/',
            ],
        ],
