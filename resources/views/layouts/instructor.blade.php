...
<nav>
    <div class="nav nav-tabs" id="curso" role="tablist">
        <a class="nav-link" id="nav-info-curso-tab" data-toggle="tab" href="#nav-info-curso" role="tab"
            aria-controls="nav-info-curso" aria-selected="false">
            Información del curso
        </a>

        <a class="nav-link active" id="nav-leccion-curso-tab" data-toggle="tab" href="#nav-leccion-curso" role="tab"
            aria-controls="nav-leccion-curso" aria-selected="true">
            Lecciones curso
        </a>
        ...
        <a class="nav-link" id="nav-estudiantes-curso-tab" data-toggle="tab" href="#nav-estudiantes-curso"
            role="tab" aria-controls="nav-estudiantes-curso" aria-selected="false">
            Estudiantes
        </a>
        <a class="nav-link" id="nav-evaluaciones-curso-tab" data-toggle="tab" href="#nav-evaluaciones-curso"
...
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tab-pane mb-4 fade show active" id="nav-leccion-curso" role="tabpanel"
