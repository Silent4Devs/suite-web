...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/appBar/TBappBar.css') }}{{ config('app.cssVersion') }}">

    <link rel="stylesheet" href="{{ asset('css/menuBurger/TBmenuBurger.css') }}{{ config('app.cssVersion') }}">
    @yield('styles')
    @livewireStyles
</head>
