...
@section('content')
    <style>
        ...
        .botones_vistas_gantt a {
            ...
            color: var(--color-tbj) font-size: 9pt;
            cursor: pointer;
            border: 1px solid var(--color-tbj) border-radius: 5px;
            text-align: center;
            vertical-align: middle;
        }

        .botones_vistas_gantt a:hover {
            border: 1px solid var(--color-tbj) background-color: var(--color-tbj) color: #fff;
        }
        ...
        <div class="botones_vistas_gantt">
            <div class="row">
                ...
                <div class="text-right col-8 caja_botones_menu">
                    ...
                    <a href="#" id="tabla_gantt_click" data-tabs="tabla_gantt"
                        onclick="initTable();cambiarTitulo('Tabla');" class="btn_gantt_tabla_vista"><i
