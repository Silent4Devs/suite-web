                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-9">
                            <label for="activo_informacion"><i class="fas fa-folder-plus iconos-crear"></i>Nombre del Activo
                        ...
                        <div class="form-group col-sm-12 multi_select_box">
                            <label for="contenedores"><i class="fas fa-boxes iconos-crear"></i>Contenedor(es) asociado(s)
                                al</label>
                            <select style="height:150px;" class="multi_select select2 col-sm-12" multiple size="3"
                                name="contenedores[]">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="id_area_responsable"><i
                                    class="fas fa-street-view iconos-crear"></i>Dirección</label>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label for="nombre_direccion"><i class="fas fa-street-view iconos-crear"></i>Nombre
                                Dirección</label>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            <label for="codigo_proceso"><i class="fas fa-barcode iconos-crear"
                                    style="margin-top: 8px"></i>Código</label>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            ...
                                            <select class="custom-select my-1 mr-sm-2" id="name_direccion_id"
                                                name="name_direccion_id">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label for="vp_envio"><i class="fas fa-list-ol iconos-crear"></i>Nombre
                                                VP</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <label for="informacion_total">¿Requiere la información en su
                                                totalidad?</label>
                        ...
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-6">
                                            <label for="otro_envioExt"><i
                                                    class="fas fa-folder-plus iconos-crear"></i>Otro</label>
                                            <input
                                                class="form-control {{ $errors->has('tro_envioExt') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            <label for="acceso_informacionExt"> ¿Tiene acceso a todos los medios requeridos
                                                por su operación para transmitir la información?</label>
                                        ...
                                        <div class="form-group col-sm-12">
                                            <label for="requiere_info"><i class="fas fa-folder-plus iconos-crear"></i>En
                                                caso que no, ¿cuáles se requieren?
                                            </label>
                                            <input
                            ...
                            <div class="card-header" id="AlmacenamientoOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left" type="button"
                                        data-toggle="collapse" data-target="#AlmacenamientoOne" aria-expanded="true"
                            ...
                            <div id="AlmacenamientoOne" class="collapse show" aria-labelledby="AlmacenamientoheadingOne"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="almacenamiento_aplicacion"
                                            name="almacenamiento_aplicacion" placeholder="...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="carpeta_compartida_almacenamiento"
                                            name="carpeta_compartida_almacenamiento" placeholder="...">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="otra_AppCarpeta_almacenamiento"
                                            name="otra_AppCarpeta_almacenamiento" placeholder="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="otro_almacenamiento_fisico"
                                            name="otro_almacenamiento_fisico" placeholder="...">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="ubicacion_fisica"
                                            name="ubicacion_fisica" placeholder="...">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="acceso_requerido"
                                            name="acceso_requerido" placeholder="...">
                                    </div>
                                    <div class="form-group">
                                        <label for="tiempo_almacenamiento">Tiempo de almacenamiento (con base a
                                            regulaciones, reglas internas y/o necesidades de negocio)</label>
                                        <input type="text" class="form-control" id="tiempo_almacenamiento"
                                            name="tiempo_almacenamiento" placeholder="...">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12" id="contenedor-activos">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" class="form-control" id="eliminacion_digital"
                                name="eliminacion_digital" placeholder="...">
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="question">¿Se tiene conocimiento si a quien se le comparte la información la borra
                                una vez concluido su uso?</label>
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="question_3">3. ¿El activo de información contiene DATOS PERSONALES DE
                                IDENTIFICACIÓN, FINANCIEROS y/o PATRIMONIALES?</label>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="integridad_id"><i
                                    class="bi bi-file-earmark-post iconos-crear"></i>Integridad</label>
                            <select
                                class="form-control select2 {{ $errors->has('responsable') ? 'is-invalid' : '' }}  sumatoria-select"
                                name="integridad_id" id="integridad_id">
                                @foreach ($integridads as $integridad)
                                    <option data-integridadValor="{{ $integridad->id }}"
                                        value="{{ $integridad->valor }}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="valor_criticidad"><i class="fas fa-exclamation-triangle iconos-crear"></i>Nivel de
                                Criticidad del AI</label>
                            <div class="form-control" id="valorCriticidadTxt"></div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="valor_criticidad"><i class="fas fa-exclamation-triangle iconos-crear"></i>Valor de
                                Criticidad del AI</label>
                            <i class="fas fa-info-circle" style="font-size:12pt; float: right;"
                                title="Fecha de finalización de la
                    actividad" data-toggle="modal"
                                data-target="#infoCriticidad"></i>
                            <input class="form-control text-center" id="valor_criticidad" name="valor_criticidad"
                                readonly />
                        </div>
