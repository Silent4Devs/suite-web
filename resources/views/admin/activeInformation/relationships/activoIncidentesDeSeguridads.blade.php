@can('incidentes_de_seguridad_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-primary" href="{{ route('admin.incidentes-de-seguridads.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table
                class=" table table-bordered table-striped table-hover datatable datatable-activoIncidentesDeSeguridads">
                <thead>
                    <tr>
                        <th width="10">
                            ...
                            <td>
                                @can('incidentes_de_seguridad_show')
                                    <a class="btn btn-xs tb-btn-primary"
                                        href="{{ route('admin.incidentes-de-seguridads.show', $incidentesDeSeguridad->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('incidentes_de_seguridad_edit')
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('admin.incidentes-de-seguridads.edit', $incidentesDeSeguridad->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
                                ...
                                @can('incidentes_de_seguridad_delete')
                                    <form
                                        action="{{ route('admin.incidentes-de-seguridads.destroy', $incidentesDeSeguridad->id) }}"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-activoIncidentesDeSeguridads:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
