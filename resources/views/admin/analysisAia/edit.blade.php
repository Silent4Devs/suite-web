...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <form action="{{ route('admin.analisis-aia.update', $cuestionario->id) }}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mt-3">
                        ...
                        <input type="text" name="titular_puesto" id="titular_puesto" class="form-control" maxlength="255"
                            placeholder="..." required value="{{ old('titular_puesto', $cuestionario->titular_puesto) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="titular_correo" id="titular_correo" class="form-control" maxlength="255"
                            placeholder="..." required value="{{ old('titular_correo', $cuestionario->titular_correo) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" name="suplente_extencion" id="suplente_extencion"
                            class="form-control extencion1" placeholder="..." min="0" max="9999"
                            value="{{ old('suplente_extencion', $cuestionario->suplente_extencion) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="number" name="supervisor_extencion" id="supervisor_extencion"
                            class="form-control extencion2" placeholder="..." min="0" max="9999"
                ...
                <div class="row" x-data="{ periodicidad_flujo: false }">
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="flujo_q_1" id="flujo_q_1" class="form-control" maxlength="255"
                            placeholder="..." required value="{{ old('flujo_q_1') }}">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <input type="text" name="flujo_q_2" id="flujo_q_2" class="form-control" maxlength="255"
                            placeholder="..." required value="{{ old('flujo_q_2') }}">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="flujo_q_5" class="required">5. ¿Cómo valida que el proceso se realizó correctamente?
                            (Carta o firma de aceptación, Acuse de Recibido, Notificación, etc.)</label>
                        @error('flujo_q_5')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_5" id="flujo_q_5" class="form-control" maxlength="255"
                            placeholder="..." required value="{{ old('flujo_q_5') }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        <input type="text" style="text-align: center;" class="form-control form-control-sm" required
                            name="app_puerto" placeholder="..."
                            value="{{ old('app_puerto', $cuestionario->app_puerto) }}">
                    </div>
                    <div class="form-group col-sm-3">
                        <input type="text" style="text-align: center;" class="form-control form-control-sm" required
                    ...
                    <label class="col-sm-3 col-form-label">Acceso a la aplicación desde dispositivos móviles: (SI /
                        NO)</label>
                    ...
                    <div class="form-group col-sm-3">
                        <select class="form-control form-control-sm" name="app_interaccion_otras_apps" required>
                            <option value disabled
                                {{ old('app_interaccion_otras_apps', null) === null ? 'selected' : '' }}>
                                Selecciona una opción</option>
                            @foreach (App\Models\AnalisisAIA::TipoInternetSelect as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <div class="form-group col-sm-3">
                        <select class="form-control form-control-sm" name="bd_interaccion_otras_apps" required>
                            <option value disabled
                                {{ old('bd_interaccion_otras_apps', null) === null ? 'selected' : '' }}>
                                Selecciona una opción</option>
                            @foreach (App\Models\AnalisisAIA::TipoInternetSelect as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <div class="form-group col-sm-3">
                        <select class="form-control form-control-sm" name="otro_interaccion_otras_apps">
                            <option value disabled
                                {{ old('otro_interaccion_otras_apps', null) === null ? 'selected' : '' }}>
                                Selecciona una opción</option>
                            @foreach (App\Models\AnalisisAIA::TipoInternetSelect as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <label class="col-sm-3 col-form-label">Softwares adicionales, especificar versiones y puertos en caso
                        de
                    ...
                    <label class="col-sm-3 col-form-label">Lenguaje de desarrollo, especificar versiones y puertos en caso
                        de
                ...
                <div class="row mt-3">
                    <div class="col-sm-12 form-group">
                        <label>7. En caso de contingencia, ¿Qué infraestructura, bases de datos o utilerías serían los
                            mínimos
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-3">
                        <select class="form-control form-control-sm" name="contingencia_app_servidor" required>
                            <option value disabled
                                {{ old('contingencia_app_servidor', null) === null ? 'selected' : '' }}>
                                Selecciona una opción</option>
                            @foreach (App\Models\AnalisisAIA::TipoServerSelect as $key => $label)
                                <option value="{{ $key }}"
                    ...
                    <div class="form-group col-sm-3">
                        <select class="form-control form-control-sm" name="contingencia_otro_servidor">
                            <option value disabled
                                {{ old('contingencia_otro_servidor', null) === null ? 'selected' : '' }}>
                                Selecciona una opción</option>
                            @foreach (App\Models\AnalisisAIA::TipoServerSelect as $key => $label)
                                <option value="{{ $key }}"
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <a id="btnAgregarTipo" onclick="event.preventDefault();" style="font-size:12pt; float: right;"
                            data-toggle="modal" data-target="#tiempos_recuperacion" title="Dar click"><i
                                class="fas fa-info-circle"></i></a>
                        <label for="respaldo_q_20" class="required">
                            13. Tiempos de Respaldo (RPO), Recuperación (RTO), Trabajo en Contingencia (WRT) y Máximo Tiempo
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rpo_mes" id="rpo_mes" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('rpo_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rpo_semana" id="rpo_semana" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="52"
                            value="{{ old('rpo_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rpo_dia" id="rpo_dia" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="365" value="{{ old('rpo_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rpo_hora">Hora(s)</label>
                        @error('rpo_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rpo_hora" id="rpo_hora" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120"
                            value="{{ old('rpo_hora') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rto_mes" id="rto_mes" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('rto_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rto_semana" id="rto_semana" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="52" value="{{ old('rto_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="rto_dia" id="rto_dia" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="365" value="{{ old('rto_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rto_hora">Hora(s)</label>
                        @error('rto_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rto_hora" id="rto_hora" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('rto_hora') }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="wrt_mes" id="wrt_mes" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('wrt_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="wrt_semana" id="wrt_semana" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="52" value="{{ old('wrt_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="wrt_dia" id="wrt_dia" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="365" value="{{ old('wrt_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="wrt_hora" id="wrt_hora" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('wrt_hora') }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="mtpd_mes" id="mtpd_mes" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('mtpd_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        @error('mtpd_semana')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="mtpd_semana" id="mtpd_semana" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="52" value="{{ old('mtpd_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="mtpd_dia" id="mtpd_dia" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="365" value="{{ old('mtpd_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        ...
                        <input type="number" name="mtpd_hora" id="mtpd_hora" class="form-control form-control-sm"
                            placeholder="..." required min="0" max="120" value="{{ old('mtpd_hora') }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_14" class="required">14. ¿Se tiene respaldo de base de datos, código fuente, scripts, etc.?</label>
                        @error('respaldo_q_14')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_14" id="respaldo_q_14" class="form-control"
                            maxlength="255" placeholder="..." required value="{{ old('respaldo_q_14') }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_15" class="required">15. ¿Cuál es la periodicidad del respaldo?</label>
                        @error('respaldo_q_15')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_15" id="respaldo_q_15" class="form-control"
                            maxlength="255" placeholder="..." required value="{{ old('respaldo_q_15') }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_16" class="required">16. ¿Qué tipo de respaldo se aplica? (Incremental, Full, etc.)</label>
                        @error('respaldo_q_16')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_16" id="respaldo_q_16" class="form-control"
                            maxlength="255" placeholder="..." required value="{{ old('respaldo_q_16') }}">
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label class="required">18. Por favor, indique el nivel de impacto en los que el proceso se ha
                            visto
                            involucrado.</label>
