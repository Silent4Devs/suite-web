...
@section('content')
    ...
    <div class="card card-t">
        <div class="row">
            <div class="col-md-2">
                <img src="{{ asset('assets/Rectángulo 2344@2x.png') }}" style="margin: 11px 10px 10px 10px;width:500px;"
                    class="img-fluid">
            </div>
            <div class="col-md-10">
                <div class="" style="margin:16px 0px 8px 0px;">
                    <p class="titulo-card mb-2">Crea tu template</p>
    ...
    <div>
        ...
        <div>
            <a href="{{ route('admin.top') }}">
                <button type="button" class="btn btn-dark" style="margin:0px 0px 8px 480px;">Dark</button>
            </a>
        </div>
    </div>
@endsection
