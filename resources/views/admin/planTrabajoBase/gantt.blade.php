...
@section('scripts')
    ...
    <div id="gantEditorTemplates" style="display:none;">
        <div class="__template__" type="GANTBUTTONS">
            ...
            <button type="button" class="button textual icon dropdown-toggle icons_propios_gantt" data-toggle="dropdown"
        ...
        <div class="__template__" type="TASKROW">
            ...
            <td class="gdfCell"><input type="text" name="progress" class="validated" entrytype="PERCENTILE" autocomplete="off" value="(#=obj.progress?obj.progress:''#)" (#=obj.progressByWorklog?"readOnly":"readOnly"#) (#=obj.isParent()? 'disabled':''#)></td>
        ...
        <div class="__template__" type="TASK_EDITOR">
            ...
            <input type="text" name="progress" id="progress" size="7" class="formElements validated percentile" autocomplete="off" maxlength="255" value="" oldvalue="1" entrytype="PERCENTILE" (#=obj.isParent()? 'disabled':''#)>
            </td>
            </tr>
