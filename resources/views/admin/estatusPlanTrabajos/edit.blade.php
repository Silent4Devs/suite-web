...
@section('content')
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.estatus-plan-trabajos.update', [$estatusPlanTrabajo->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('estado') ? 'is-invalid' : '' }}" type="text"
                        name="estado" id="estado" value="{{ old('estado', $estatusPlanTrabajo->estado) }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion"
                        id="descripcion">{{ old('descripcion', $estatusPlanTrabajo->descripcion) }}</textarea>
