...
@section('content')
    <div class="card mt-4">
        <div class="col-md-10 col-sm-9 py-3 card-body verde_silent align-self-center" style="margin-top: -40px;">
            <h3 class="mb-1  text-center text-white"><strong> Registrar: </strong> Estatus de Plan de Trabajo </h3>
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.estatus-plan-trabajos.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="estado"><i
                            class="fas fa-file-alt iconos-crear"></i>{{ trans('cruds.estatusPlanTrabajo.fields.estado') }}</label>
                ...
                <div class="form-group">
                    <label for="descripcion"><i
                            class="fas fa-file-signature iconos-crear"></i>{{ trans('cruds.estatusPlanTrabajo.fields.descripcion') }}</label>
