...
@section('content')
    ...
    <div id="inicio_usuario" class="row" style="">
        ...
        <div class="d-mobile w-100">
            ...
            <h3 style="color: #3086AF; margin-top:30px; text-align: center;">{{ $usuario->empleado ? $usuario->empleado->name : 'Sin empleado'}}</h3>
            <h5 style="color: #000; margin-top:15px; text-align: center;">{{ $usuario->empleado ? $usuario->empleado->puesto : 'Sin empleado' }}</h5>
            <h6 style="color: #788BAC; margin-top:15px; text-align: center;">{{ $usuario->empleado ? $usuario->empleado->area->area : 'Sin empleado'}}</h6>
            <h6 style="color: #747474; margin-top:15px; text-align: center;"><strong style="color:#3086AF;">Empleado:</strong> {{ $usuario->empleado ? $usuario->empleado->n_empleado : 'Sin empleado'}}</h6>
                        ...
                        @if (!empty($panel_rules->n_empleado))
                            @if ($panel_rules->n_empleado)
                                <div class="form-group">
                                    ...
                                    <div class="text-muted">
                                        {{ $usuario->empleado ? $usuario->empleado->n_empleado : 'Dato no registrado' }}
                                    </div>
                                </div>
                            @endif
                            @if ($panel_rules->email)
                                <div class="form-group">
                                    ...
                                    <div class="text-muted">
                                        {{ $usuario->empleado ? $usuario->empleado->email : 'Dato no registrado'}}
                                    </div>
                                </div>
                            @endif
                            @if ($panel_rules->fecha_ingreso)
                                <div class="form-group">
                                    ...
                                    <div class="text-muted">
                                        {{ $usuario->empleado ? \Carbon\Carbon::parse($usuario->empleado->antiguedad)->format('d/m/Y') : 'Dato no registrado' }}
                                    </div>
                                </div>
                            @endif
