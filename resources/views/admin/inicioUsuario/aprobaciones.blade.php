...
<div>
    @foreach ($mis_documentos as $documento)
        @if(!($documento->archivo == 'archivado'))
            ...
            <div class="modal fade" id="alert_aprob_arch{{ $documento->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                  <div class="modal-body">
                    <div class="delete">
                        ...
                        <div class="mt-4">
                            <form action="{{route('admin.inicio-Usuario.aprobacion.archivar', $documento->id)}}" method="POST">
                                @csrf
