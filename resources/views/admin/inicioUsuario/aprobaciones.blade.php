...
<div class="card-body datatable-fix pb-0">
    <div class="row">
        ...
        <div class="col-12">
            <h5 class="p-0 m-0 text-muted" style="border-bottom: solid 2px #345183;">Requeridos: Documentos que debo
                aprobar </h5>
            @include('admin.inicioUsuario.aprobaciones.documentos-debo-aprobar.index')
        </div>
        <div class="col-12">
            <h5 class="p-0 m-0 text-muted" style="border-bottom: solid 2px #345183;">Solicitados: Documentos que me
                deben
                aprobar</h5>
