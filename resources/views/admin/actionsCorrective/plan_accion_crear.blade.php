@can('planaccion_correctiva_create')
    ...
    <div class="card mt-5" style="border: none;">
        <div style="margin-bottom: 10px; margin-left:12px; border:none;" class="row">
            <div class="col-12 text-right">
                <div class="btn btn-primary boton_verde">
    ...
    <div class="fondo_negro">
        <div class="ventana">
            ...
            <div class="card mt-4">
                <div class="col-md-10 col-sm-9 py-3 card-body verde_silent align-self-center"
            ...
            -->
                        <div class="form-group col-12">
                            ...
                            <input class="form-control {{ $errors->has('actividad') ? 'is-invalid' : '' }}"
                                type="text" name="actividad" id="actividad" value="{{ old('actividad', '') }}"
                                required>
