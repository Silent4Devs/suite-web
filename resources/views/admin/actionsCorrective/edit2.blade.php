    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.accion-correctivas.update', [$accionCorrectiva->id]) }}"
                ...
                <div class="form-group">
                    <label
                        for="fecha_verificacion">{{ trans('cruds.accionCorrectiva.fields.fecha_verificacion') }}</label>
                ...
                <div class="form-group">
                    <label
                        for="responsable_accion_id">{{ trans('cruds.accionCorrectiva.fields.responsable_accion') }}</label>
