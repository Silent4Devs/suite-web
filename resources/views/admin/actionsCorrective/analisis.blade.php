<div class="form-group col-12">
    ...
    <select class="form-control {{ $errors->has('metodo_causa') ? 'is-invalid' : '' }}" name="metodo_causa"
        ...
        @foreach (App\Models\AccionCorrectiva::METODO_CAUSA_SELECT as $key => $label)
            <option value="{{ $key }}" {{ old('metodo_causa', '') === (string) $key ? 'selected' : '' }}>
                {{ $label }}</option>
        @endforeach
    </select>
...
<div class="form-group col-md-12 col-lg-12 col-sm-12">
    <label for="solucion"><i class="far fa-file-alt iconos-crear"></i>Descripción de la solución
    </label>
...
<div class="form-group col-sm-12 col-md-6 col-lg-6">
    ...
    <input class="form-control date {{ $errors->has('fecha_compromiso') ? 'is-invalid' : '' }}" type="date"
        name="fecha_compromiso" id="fecha_compromiso" value="{{ old('fecha_compromiso') }}">
...
<div class="form-group col-sm-12 col-md-4 col-lg-4">
    ...
    <select class="form-control  {{ $errors->has('id_atencion') ? 'is-invalid' : '' }}" name="id_atencion"
        id="id_atencion">
...
<div class="form-group col-sm-12 col-md-4 col-lg-4">
    ...
    <select class="form-control  {{ $errors->has('id_autorizo') ? 'is-invalid' : '' }}" name="id_autorizo"
        id="id_autorizo">
        <option selected value="" disabled>-- Selecciona un área --</option>
        @foreach ($empleados as $empleado)
            <option data-puesto="{{ $empleado->puesto }}" value="{{ $empleado->id }}"
...
<div class="col-sm-12 col-md-12 col-lg-12 form-group">
    <label for="documentometodo"><i class="fas fa-folder-open iconos-crear"></i>Adjuntar
        Documento</label>
    <div class="custom-file">
        <input type="file" name="files[]" multiple class="form-control" id="documentometodo">
