    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dmaics.store") }}" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-12">
                <label for="mejora_id"><i class="fas fa-chart-bar iconos-crear"></i>{{ trans('cruds.dmaic.fields.mejora') }}</label>
                <select class="form-control select2 {{ $errors->has('mejora') ? 'is-invalid' : '' }}" name="mejora_id" id="mejora_id">
                    @foreach($mejoras as $id => $mejora)
                        <option value="{{ $id }}" {{ old('mejora_id') == $id ? 'selected' : '' }}>{{ $mejora }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                <label for="definir"><i class="fas fa-file-signature iconos-crear"></i>{{ trans('cruds.dmaic.fields.definir') }}</label>
            ...
            <div class="form-group col-md-6">
                <label for="medir"><i class="fas fa-signal iconos-crear"></i>{{ trans('cruds.dmaic.fields.medir') }}</label>
            ...
            <div class="form-group col-md-6">
                <label for="analizar"><i class="fas fa-search iconos-crear"></i>{{ trans('cruds.dmaic.fields.analizar') }}</label>
            ...
            <div class="form-group col-md-6">
                <label for="implementar"><i class="fas fa-chart-bar iconos-crear"></i>{{ trans('cruds.dmaic.fields.implementar') }}</label>
                <textarea class="form-control {{ $errors->has('implementar') ? 'is-invalid' : '' }}" name="implementar" id="implementar">{{ old('implementar') }}</textarea>
            ...
            <div class="form-group col-md-6">
                <label for="controlar"><i class="fas fa-sitemap iconos-crear"></i>{{ trans('cruds.dmaic.fields.controlar') }}</label>
            ...
            <div class="form-group col-md-6">
                <label for="leccionesaprendidas"><i class="fas fa-book iconos-crear"></i>{{ trans('cruds.dmaic.fields.leccionesaprendidas') }}</label>
                <textarea class="form-control {{ $errors->has('leccionesaprendidas') ? 'is-invalid' : '' }}" name="leccionesaprendidas" id="leccionesaprendidas">{{ old('leccionesaprendidas') }}</textarea>
