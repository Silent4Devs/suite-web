                        ...
                        <select class="form-control {{ $errors->has('id_area') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($areas as $area)
                                <option value="{{ $area->id }}"
                                        {{ old('id_area', $indicadoresSgsi->id_area) == $area->id ? 'selected' : '' }}>
                                    {{ $area->area }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select class="form-control {{ $errors->has('id_proceso') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($procesos as $proceso)
                                <option value="{{ $proceso->id }}"
                                        {{ old('id_proceso', $indicadoresSgsi->id_proceso) == $proceso->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 col-md-2 col-lg-2 anima-focus">
                        <input class="form-control {{ $errors->has('meta') ? 'is-invalid' : '' }}"
                               ...
                               name="meta"
                               id="meta"
                               value="{{ old('meta', $indicadoresSgsi->meta) }}"
                               required>
                    ...
                    <div class="form-group col-sm-6 col-md-4 col-lg-4 anima-focus">
                        <input class="form-control {{ $errors->has('frecuencia') ? 'is-invalid' : '' }}"
                               ...
                               name="frecuencia"
                               id="frecuencia"
                               value="{{ old('frecuencia', $indicadoresSgsi->frecuencia) }}"
                               required>
                    ...
                    <div class="form-group col-sm-6 col-md-2 col-lg-2 anima-focus">
                        <input class="form-control {{ $errors->has('no_revisiones') ? 'is-invalid' : '' }}"
                               ...
                               id="no_revisiones"
                               min="0"
                               value="{{ old('no_revisiones', $indicadoresSgsi->no_revisiones) }}"
                               required>
