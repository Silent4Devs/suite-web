...
<div class="row">
    ...
    <div class="form-group col-sm-3">
        ...
        <div class="pt-2 pl-2 text-center card"
            style="height:35px; box-shadow: 0px 0px 0px 1px rgba(77, 72, 77, 0.133)">
...
<div class="mb-3 row">
    ...
    <div class="col-lg-3 info-personal">
        <div class="text-center" style="border:1px solid #ccc; border-radius:5px;">
            <div style="width: 100%; height: 85px; background-color: var(--color-tbj)"></div>
    ...
    <div class="col-lg-3 info-personal">
        <div class="text-center" style="border:1px solid #ccc; border-radius:5px;">
            ...
            <div class="caja_img_perfil">
                <img
                    src="{{ asset('storage/empleados/imagenes') }}/{{ $documento->aprobador ? $documento->aprobador->avatar : 'user.png' }}">
            </div>
            <h6><strong
                    style="color:var(--color-tbj)font-size:12pt;">{{ $documento->aprobador ? $documento->aprobador->name : 'Sin registro' }}</strong>
            </h6>
