        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.alcance-sgsis.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        <label for="fecha_entrada"><i class="far fa-calendar-alt iconos-crear"></i>Fecha de entrada en
                            vigor</label>
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <select class="form-control select2 {{ $errors->has('reviso_alcance') ? 'is-invalid' : '' }}"
