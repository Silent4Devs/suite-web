...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="py-3 col-md-10 col-sm-9 card-body verde_silent align-self-center" style="margin-top: -40px;">
            <h3 class="mb-1 text-center text-white"><strong> Editar: </strong> Matriz ISO31000</h3>
        </div>
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <input class="form-control {{ $errors->has('proveedores') ? 'is-invalid' : '' }}" type="text"
                            name="proveedores" value="{{ old('proveedores', $activosmatriz31000->proveedores) }}">
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <input class="form-control {{ $errors->has('servicio') ? 'is-invalid' : '' }}" type="text"
                            name="servicio" value="{{ old('servicio', $activosmatriz31000->servicio) }}">
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        <select class="procesoSelect form-control" name="id_proceso" id="id_proceso">
                            ...
                            @foreach ($procesos as $proceso)
                                <option
                                    {{ old('id_proceso', $activosmatriz31000->id_proceso) == $proceso->id ? ' selected="selected"' : '' }}
