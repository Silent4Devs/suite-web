            ...
            <form method="POST" action="{{ route('admin.glosarios.update', $glosario) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text"
                        name="numero" id="numero" value="{{ old('numero', $glosario->numero) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('norma') ? 'is-invalid' : '' }}" type="text"
                        name="norma" id="norma" value="{{ old('norma', $glosario->norma) }}" required>
                    @if ($errors->has('norma'))
                        <div class="invalid-feedback">
                            {{ $errors->first('norma') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('concepto') ? 'is-invalid' : '' }}" type="text"
                        name="concepto" id="concepto" value="{{ old('concepto', $glosario->concepto) }}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control {{ $errors->has('explicacion') ? 'is-invalid' : '' }}" name="explicacion"
                        id="explicacion">{{ old('explicacion', $glosario->explicacion) }}</textarea>
