            ...
            <table id="dom" class="responsive-table" style="width: 100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>“medios para garantizar que el acceso a los activos esté autorizado y restringido según los
                            requisitos comerciales y de seguridad”</td>
                        <td>El control de acceso es una forma de limitar el acceso a un sistema o a recursos físicos o
                            ...
                            formas, pero las credenciales que no se pueden transferir brindan la mayor seguridad.</td>
                    </tr>
                    <tr>
                        <td>3.2</td>
                        <td>Ataque</td>
                        <td>"Intentar destruir, exponer, alterar, deshabilitar, robar u obtener acceso no autorizado o hacer
                            un uso no autorizado de un activo"</td>
                        <td>Los ataques cibernéticos son los mas comunes hoy en día. Un ciber ataque es un ataque contra un
                            ...
                            malware, ransomware , kits de explotación y otros métodos.</td>
                    </tr>
                    <tr>
                        <td>3.3.</td>
                        <td>Auditoría</td>
                        <td>Proceso sistemático, independiente y documentado para obtener evidencia de auditoría y evaluarla
                        ...
                        <td>Una auditoría incluye una verificación que garantice que la seguridad de la información cumple
                            ...
                            evaluación de los riesgos de los activos.</td>
                    ...
                    <tr>
                        ...
                        <td>El alcance de una auditoria generalmente incluye una descripción de las áreas físicas, unidades
                            organizacionales, actividades y procesos, así como el periodo de tiempo cubierto</td>
                    ...
                    <tr>
                        ...
                        <td>En el contexto de los sistemas informáticos, la autenticación es un proceso que garantiza y
                    ...
                    <tr>
                        ...
                        <td>¿Qué es la autenticidad? ¿Qué entendemos por autenticidad en Seguridad de la Información? La
                            ...
                            domésticos y usuarios empresariales</td>
                    ...
                    <tr>
                        ...
                        <td>Los sistemas de almacenamiento de datos son los que en definitiva nos garantizan la
                            ...
                            con autorización para acceder a ella.</td>
                    ...
                    <tr>
                        ...
                        <td>Se ha realizado un trabajo considerable para desarrollar medidas e indicadores que puedan
                            ...
                            proporcionan información socialmente significativa con respecto al desempeño.</td>
                    ...
                    <tr>
                        ...
                        <td>Hoy más que nunca, en el mundo interconectado y moderno se revela como algo absolutamente
                            ...
                            corporativa actual de una organización.</td>
                    ...
                    <tr>
                        ...
                        <td>Propiedad por la que la información no se pone a disposición o se divulga a personas, entidades
                            o procesos no autorizados </td>
                        <td>La confidencialidad, cuando nos referimos a sistemas de información, permite a los usuarios
                            ...
                            * Los controles de acceso aseguran que las acciones del usuario permanezcan dentro de sus roles.
                            ...
                            sistema definidos pueden integrarse.</td>
                    ...
                    <tr>
                        ...
                        <td>La conformidad es el “cumplimiento de un requisito”. Cumplir significa cumplir o cumplir con los
                    ...
                    <tr>
                        ...
                        <td>Como vemos las consecuencias son algo relacionado con los eventos y los objetivos de la
                            ...
                            contexto empresarial en el que se utiliza.</td>
                    ...
                    <tr>
                        ...
                        <td>Si la mejora se define como acciones que se traducen en una mejora de los resultados, entonces
                    ...
                    <tr>
                        ...
                        <td>Los controles de seguridad son medidas de seguridad técnicas o administrativas para evitar,
                    ...
                    <tr>
                        ...
                        <td>Declaración que describe lo que se debe lograr como resultado de la implementación de controles
                            (3.14)</td>
                        <td>Este concepto hace posible cumplir con la filosofía de la norma ISO 27001 donde la base de la
                    ...
                    <tr>
                        ...
                        <td>Una no conformidad es cualquier incumplimiento de un requisito. VEASE 3.11
                            ...
                            inmediatas de una no conformidad.</td>
                    ...
                    <tr>
                        ...
                        <td>Una acción correctiva se define como la acción tomada para evitar la repetición de una no
                            conformidad mediante la identificación y tratamiento de las causas que la provocaron.</td>
                    ...
                    <tr>
                        ...
                        <td>Las medidas o indicadores derivados son aquellos que se establecen en base a otro indicador
                            ...
                            cálculos de promedios o conteo de ocurrencias de la variable o medida base.</td>
                    ...
                    <tr>
                        ...
                        <td>Se refiere a la información necesaria que una organización debe controlar y mantener actualizada
                            ...
                            * Evidencias o registros de los resultados obtenidos en cualquier proceso del sistema de gestión
                            o de la organización</td>
                        <td>En un sistema de gestión no debemos pasar por alto el control y la organización de nuestra
                            ...
                            costoso y un gasto de tiempo y recursos que no siempre es necesario.</td>
                    ...
                    <tr>
                        <td>3.20 </td>
                        <td>Efectividad</td>
                        <td>En qué medida se realizan las actividades planificadas y se logran los resultados planificados.
                        </td>
                        <td>Un sistema de Gestión para la seguridad de la información es un conjunto de elementos
                    ...
                    <tr>
                        ...
                        <td>Un evento de seguridad es cualquier ocurrencia observable que sea relevante para la seguridad de
                    ...
                    <tr>
                        ...
                        <td>Entorno externo en el que la organización busca alcanzar sus objetivos el contexto externo puede
                            incluir :
                            ...
                            entorno externo)</td>
                        <td>Para definir correctamente el contexto externo podríamos comenzar por un análisis del entorno
                            ...
                            peligros naturales, los desechos peligrosos y las tendencias relacionadas.</td>
                    ...
                    <tr>
                        ...
                        <td>Sistema por el cual las actividades de seguridad de la información de una organización son
                            dirigidas y controladas.</td>
                        <td>El gobierno de la seguridad de la información es la estrategia de una empresa para reducir el
                            ...
                            detección de intrusos, alarmas y cámaras.</td>
                    ...
                    <tr>
                        <td>3.24 </td>
                        <td>Órgano Rector</td>
                        <td>Persona o grupo de personas que son responsables del desempeño de la organización. El órgano
                            rector puede ser una junta directiva o consejo de administración. </td>
                        <td>En el caso de la seguridad de la información el órgano rector será el responsable del desempeño
                            ...
                            reside en los órganos rectores de cada organización.</td>
                    ...
                    <tr>
                        ...
                        <td>Los indicadores para la evaluación de la seguridad de la información a menudo sirven como
                            ...
                            como sistemas de iluminación, detección de intrusos, alarmas y cámaras.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Este es un concepto relacionado con el desarrollo de procesos de medición que determinen qué
                            ...
                            necesidades de los diferentes usuarios.</td>
                    </tr>

                    <tr>
                        <td>3.27</td>
                        <td>Instalaciones de Procesamiento de Información</td>
                        <td>Cualquier sistema de procesamiento de información, servicio o infraestructura, o la ubicación
                            física que lo alberga.</td>
                        <td>Las instalaciones de procesamiento de información en una empresa, deben ser consideradas como un
                            ...
                            ser tangible o intangible; así como, un hardware o un software.</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Preservación de la confidencialidad, integridad y disponibilidad de la información
                            ...
                            repudio y la confiabilidad también pueden estar involucrados.</td>
                        <td>La seguridad de la información como vemos tiene por objetivo la protección de la
                            ...
                            un sistema de información.</td>
                    </tr>

                    <tr>
                        <td>3.29 </td>
                        <td>Continuidad de la Seguridad de la Información</td>
                        <td>Procesos y procedimientos para garantizar la continuidad de las operaciones de seguridad de la
                            información</td>
                        <td>El termino continuidad de la seguridad de la información se utiliza dentro de la norma ISO 27001
                            ...
                            que acceda por teletrabajo y procesan datos confidenciales.</td>
                    </tr>

                    <tr>
                        <td>3.30 </td>
                        <td>Evento de Seguridad de la Información</td>
                        <td>Ocurrencia identificada de un sistema, servicio o estado de red que indica un posible
                            incumplimiento de la política de seguridad de la información o falla de los controles o una
                            situación desconocida que puede ser relevante para la seguridad.</td>
                        <td>Podríamos considerar como un evento en la seguridad de la información a cualquier cambio
                            ...
                            cada caso con el propósito de generar una acción.</td>
                    </tr>

                    <tr>
                        <td>3.31</td>
                        <td>Incidente de Seguridad de la Información</td>
                        <td>Un evento o una serie de eventos de seguridad de la información no deseados o inesperados que
                        ...
                        <td>Un incidente de seguridad de la información puede definirse también como cualquier evento que
                    ...
                    <tr>
                        ...
                        <td>Conjunto de procesos para detectar, informar, evaluar, responder, tratar y aprender de los
                            incidentes de seguridad de la información.</td>
                        <td>El conjunto de procesos para tratar los incidentes de la seguridad de la información debe
                            ...
                            anómalo o irregularidad en el sistema, los datos o el comportamiento del usuario.</td>
                    </tr>
                </tbody>
            </table>
        </div>
