...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Competencium">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'id', name: 'id' },
{ data: 'nombrecolaborador_name', name: 'nombrecolaborador.name' },
{ data: 'perfilpuesto', name: 'perfilpuesto' },
{ data: 'certificados', name: 'certificados', sortable: false, searchable: false },
