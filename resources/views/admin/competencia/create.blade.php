            ...
            <form method="POST" action="{{ route('admin.competencia.store') }}" enctype="multipart/form-data" class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control select2 {{ $errors->has('nombrecolaborador') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($nombrecolaboradors as $id => $nombrecolaborador)
                            <option value="{{ $id }}" {{ old('nombrecolaborador_id') == $id ? 'selected' : '' }}>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('perfilpuesto') ? 'is-invalid' : '' }}" type="text"
                        name="perfilpuesto" id="perfilpuesto" value="{{ old('perfilpuesto', '') }}">
                ...
                <div class="form-group col-12">
                    <label for="certificados"><i class="far fa-file iconos-crear"></i>Certificados (Archivo PDF o
                        JPG)</label>
