                    ...
                    <div class="col-12">
                       ...
                       <table class="table w-100 mt-4 mb-4" id="contactos_externos_table" style="width:100%">
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input class="form-control date {{ $errors->has('fecha_aut_presidencia') ? 'is-invalid' : '' }}" type="datetime-local"
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input class="form-control date {{ $errors->has('fecha_aut_viceoperaciones') ? 'is-invalid' : '' }}" type="datetime-local"
                                name="fecha_aut_viceoperaciones" id="fecha_aut_viceoperaciones" value="{{ old('fecha_aut_viceoperaciones') }}">
