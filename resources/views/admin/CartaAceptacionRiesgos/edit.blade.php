...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.carta-aceptacion.update', [$cartaAceptacion->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-lg-4 col-sm-12">
                            ...
                            <input class="form-control {{ $errors->has('folio_riesgo') ? 'is-invalid' : '' }}"
                                name="folio_riesgo" id="folio_riesgo"
                        ...
                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                            <label for="fecharegistro"> <i class="far fa-calendar-alt iconos-crear"></i> Fecha y hora del
                                riesgo</label>
                        ...
                        <div class="form-group col-sm-12 col-md-4 col-lg-4">
                            <label for="fechaaprobacion"> <i class="far fa-calendar-alt iconos-crear"></i> Fecha de
                                aprobación del riesgo</label>
                            <input class="form-control date {{ $errors->has('fechaaprobacion') ? 'is-invalid' : '' }}"
                                type="datetime-local" name="fechaaprobacion" id="fechaaprobacion"
                                value="{{ old('fechaaprobacion') }}"
                        ...
                        <div class="form-group col-md-4 col-lg-4 col-sm-12">
                            ...
                            <input class="form-control mt-2 {{ $errors->has('activo_folio') ? 'is-invalid' : '' }}"
                                name="activo_folio" id="activo_folio"
                        ...
                        <div class="form-group col-md-8 col-lg-8 col-sm-12">
                            ...
                            <input class="form-control {{ $errors->has('nombre_activo') ? 'is-invalid' : '' }}"
                        ...
                        <div class="form-group col-md-6 col-lg-6 col-sm-12">
                            <label for="criticidad_activo"><i class="fab fa-cloudscale iconos-crear"></i>Criticidad del
                                Activo
                            </label>
                            <input class="form-control {{ $errors->has('criticidad_activo') ? 'is-invalid' : '' }}"
                                name="criticidad_activo" id="criticidad_activo"
                        ...
                        <div class="form-group col-md-6 col-lg-6 col-sm-12">
                            <label for="descripcion_tecnologico"><i class="far fa-file-alt iconos-crear"></i>Descripción
                                del Impacto al Tecnológico
                            </label>
                        ...
                        <table class="table w-100 mt-4 mb-4" id="contactos_externos_table" style="width:100%">
                            ...
                            <tbody id="contenedor_contactos_externos">
                                <tr>
                                    <th>Muy alto</th>
                                    <th style="background-color:rgb(240, 240, 150);">Riesgo catastrófico que puede afectar
                                        la permanencia del n_registro
                                        y que genera impactos graves.
                                    </th>
                                </tr>
                                <tr>
                                    <th>Alto</th>
                                    <th style="background-color:rgb(240, 240, 150);">Riesgo intolerable para la
                                        organización que genera impactos relevantes.
                                    </th>
                                </tr>
                                <tr>
                                    <th>Medio</th>
                                    <th style="background-color:rgb(240, 240, 150);">Riesgo moderado para la organización
                                        que genera impactos significativos.
                                    </th>
                                </tr>
                                <tr>
                                    <th>Bajo</th>
                                    <th style="background-color:rgb(240, 240, 150);">Riesgo tolerable para la organización
                                        que no genera impactos significativos.
                                    </th>
                                </tr>
                                <tr>
                                    <th>Muy bajo</th>
                                    <th style="background-color:rgb(240, 240, 150);">Sin riesgo para la organización y no
                                        genera algún impacto significativo.
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select class="form-control select2 {{ $errors->has('legal') ? 'is-invalid' : '' }}"
                                name="legal">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->legal) == '1' ? 'selected' : '' }} value="1">1
                                </option>
                                <option {{ old('2', $cartaAceptacion->legal) == '2' ? 'selected' : '' }} value="2">2
                                </option>
                                <option {{ old('3', $cartaAceptacion->legal) == '3' ? 'selected' : '' }} value="3">3
                                </option>
                                <option {{ old('4', $cartaAceptacion->legal) == '4' ? 'selected' : '' }} value="4">4
                                </option>
                                <option {{ old('5', $cartaAceptacion->legal) == '5' ? 'selected' : '' }} value="5">5
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select class="form-control select2 {{ $errors->has('cumplimiento') ? 'is-invalid' : '' }}"
                                name="cumplimiento">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->cumplimiento) == '1' ? 'selected' : '' }}
                                    value="1">1</option>
                                <option {{ old('2', $cartaAceptacion->cumplimiento) == '2' ? 'selected' : '' }}
                                    value="2">2</option>
                                <option {{ old('3', $cartaAceptacion->cumplimiento) == '3' ? 'selected' : '' }}
                                    value="3">3</option>
                                <option {{ old('4', $cartaAceptacion->cumplimiento) == '4' ? 'selected' : '' }}
                                    value="4">4</option>
                                <option {{ old('5', $cartaAceptacion->cumplimiento) == '5' ? 'selected' : '' }}
                                    value="5">5</option>
                            </select>
                        </div>

                        <div class="form-group col-md-4 col-sm-12">
                            <label for="operacional"><i
                                    class="fas fa-project-diagram iconos-crear"></i>Operacional</label><br>
                            <select class="form-control select2 {{ $errors->has('operacional') ? 'is-invalid' : '' }}"
                                name="operacional">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->operacional) == '1' ? 'selected' : '' }}
                                    value="1">1</option>
                                <option {{ old('2', $cartaAceptacion->operacional) == '2' ? 'selected' : '' }}
                                    value="2">2</option>
                                <option {{ old('3', $cartaAceptacion->operacional) == '3' ? 'selected' : '' }}
                                    value="3">3</option>
                                <option {{ old('4', $cartaAceptacion->operacional) == '4' ? 'selected' : '' }}
                                    value="4">4</option>
                                <option {{ old('5', $cartaAceptacion->operacional) == '5' ? 'selected' : '' }}
                                    value="5">5</option>
                            </select>
                        </div>

                        <div class="form-group col-md-4 col-sm-12">
                            <label for="reputacional"><i
                                    class="fas fa-newspaper iconos-crear"></i>Reputacional</label><br>
                            <select class="form-control select2 {{ $errors->has('reputacional') ? 'is-invalid' : '' }}"
                                name="reputacional" id="reputacional">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->reputacional) == '1' ? 'selected' : '' }}
                                    value="1">1</option>
                                <option {{ old('2', $cartaAceptacion->reputacional) == '2' ? 'selected' : '' }}
                                    value="2">2</option>
                                <option {{ old('3', $cartaAceptacion->reputacional) == '3' ? 'selected' : '' }}
                                    value="3">3</option>
                                <option {{ old('4', $cartaAceptacion->reputacional) == '4' ? 'selected' : '' }}
                                    value="4">4</option>
                                <option {{ old('5', $cartaAceptacion->reputacional) == '5' ? 'selected' : '' }}
                                    value="5">5</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select class="form-control select2 {{ $errors->has('financiero') ? 'is-invalid' : '' }}"
                                name="financiero">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->financiero) == '1' ? 'selected' : '' }}
                                    value="1">1</option>
                                <option {{ old('2', $cartaAceptacion->financiero) == '2' ? 'selected' : '' }}
                                    value="2">2</option>
                                <option {{ old('3', $cartaAceptacion->financiero) == '3' ? 'selected' : '' }}
                                    value="3">3</option>
                                <option {{ old('4', $cartaAceptacion->financiero) == '4' ? 'selected' : '' }}
                                    value="4">4</option>
                                <option {{ old('5', $cartaAceptacion->financiero) == '5' ? 'selected' : '' }}
                                    value="5">5</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-4 col-sm-12">
                            ...
                            <select class="form-control select2 {{ $errors->has('tecnologico') ? 'is-invalid' : '' }}"
                                name="tecnologico">
                                <option value="" selected>Selecciona una opción</option>
                                <option {{ old('1', $cartaAceptacion->tecnologico) == '1' ? 'selected' : '' }}
                                    value="1">1</option>
                                <option {{ old('2', $cartaAceptacion->tecnologico) == '2' ? 'selected' : '' }}
                                    value="2">2</option>
                                <option {{ old('3', $cartaAceptacion->tecnologico) == '3' ? 'selected' : '' }}
                                    value="3">3</option>
                                <option {{ old('4', $cartaAceptacion->tecnologico) == '4' ? 'selected' : '' }}
                                    value="4">4</option>
                                <option {{ old('5', $cartaAceptacion->tecnologico) == '5' ? 'selected' : '' }}
                                    value="5">5</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-12 col-lg-12 col-sm-12">
                            <label for="aceptacion_riesgo"><i class="fas fa-exclamation-triangle iconos-crear"></i>Razón
                                por la que se debe aceptar el riesgo
                            </label>
                            <input class="form-control {{ $errors->has('aceptacion_riesgo') ? 'is-invalid' : '' }}"
                                name="aceptacion_riesgo" id="aceptacion_riesgo"
                        ...
                        <div class="form-group col-md-12 col-lg-12 col-sm-12 mb-4">
                            <label for="controles_id" style="margin-left: 15px; margin-bottom:5px; margin-right: 0px;"><i
                                    class="fas fa-lock iconos-crear"></i>Políticas/Control asociados al Riesgo</label>
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input class="form-control date {{ $errors->has('fecha_vp_aut') ? 'is-invalid' : '' }}"
                                type="date" name="fecha_vp_aut" id="fecha_vp_aut"
                                value="{{ old('fecha_vp_aut') }}">
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            <label for="fecha_aut_presidencia"> <i class="far fa-calendar-alt iconos-crear"></i> Fecha de
                                Autorización</label>
                            <input
                                class="form-control date {{ $errors->has('fecha_aut_presidencia') ? 'is-invalid' : '' }}"
                                type="date" name="fecha_aut_presidencia" id="fecha_aut_presidencia"
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            <label for="vice_operaciones_id"><i class="fas fa-user-tie iconos-crear"></i>Vicepresidencia
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-lg-6">
                            ...
                            <input
                                ...
                                type="date" name="fecha_aut_viceoperaciones" id="fecha_aut_viceoperaciones"
                        ...
                        <div class="form-group col-md-12 col-lg-12 col-sm-12">
                            <label for="recomendaciones"><i class="fas fa-lock iconos-crear"></i>Recomendaciones
                                Mandatorias de Seguridad
                            </label>
                            <textarea class="form-control {{ $errors->has('recomendaciones') ? 'is-invalid' : '' }}" name="recomendaciones"
                                id="recomendaciones">{{ old('recomendaciones', $cartaAceptacion->recomendaciones) }}</textarea>
