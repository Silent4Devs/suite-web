            ...
            <form method="POST" action="{{ route('admin.incidentes-de-seguridads.store') }}" enctype="multipart/form-data"
                ...
                <div class="form-group col-12">
                    ...
                    <input class="form-control {{ $errors->has('folio') ? 'is-invalid' : '' }}" type="text"
                        name="folio" id="folio" value="{{ old('folio', '') }}" required>
                    @if ($errors->has('folio'))
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control date {{ $errors->has('fechaocurrencia') ? 'is-invalid' : '' }}"
                        type="text" name="fechaocurrencia" id="fechaocurrencia" value="{{ old('fechaocurrencia') }}">
                ...
                <div class="form-group col-12">
                    ...
                    <select class="form-control select2 {{ $errors->has('activos') ? 'is-invalid' : '' }}" name="activos[]"
                        ...
                        @foreach ($activos as $id => $activo)
                            <option value="{{ $id }}" {{ in_array($id, old('activos', [])) ? 'selected' : '' }}>
                                {{ $activo }}</option>
                        @endforeach
                    </select>
