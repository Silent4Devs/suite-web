    ...
    <div class="col">
        ...
        <ul class="list-group" style="margin-top:50px;">
          ...
          <li class="list-group-item" style="cursor:pointer; ">
            ...
            <a data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Obtener el apoyo de la alta dirección<i class="fas fa-arrow-circle-right" style="float:right;"></i>
            </a>
          ...
          <li class="list-group-item" style="cursor:pointer;">
            ...
            <a class="black-text" id="profile-tab-just" data-toggle="tab" href="#observacion2" role="tab"
               aria-controls="profile-just"
               aria-selected="false">  Elaborar el proyecto <i class="fas fa-arrow-circle-right"style="float:right;"></i>
