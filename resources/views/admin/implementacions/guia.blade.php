...
<div class="row">
    ...
    <div class="col-6">
        ...
        <ul class="list-group" style="margin-top:50px;">
          ...
          <li id="cierre1" class="list-group-item" style="cursor:pointer; ">

            Obtener el apoyo de la alta dirección<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span>
          ...
          <li id="cierre2" class="list-group-item" style="cursor:pointer;">

              Elaborar el proyecto<span><i class="fas fa-arrow-circle-right"style="float:right;"></i></span>
          ...
          <li class="list-group-item abierto3">Definir el control de documentos y registros <span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item abierto4">Analizar el Contexto de la Organización<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item abierto5">Identifica partes interesadas y sus requerimientos<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
        </ul>



        <ul class="list-group">
          <li class="list-group-item" style="margin-top:50px;"><h2 class="text-primary">Planificación</h2></li>
          <li class="list-group-item">Obtener el apoyo de la alta dirección<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item">Obtener el apoyo de la alta dirección<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item">Obtener el apoyo de la alta dirección<span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item">Obtener el apoyo de la alta dirección <span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
          <li class="list-group-item">Obtener el apoyo de la alta dirección <span><i class="fas fa-arrow-circle-right" style="float:right;"></i></span></li>
    ...
    <div class="col" id="malo">
         ...
         <div>
           ...
           <div class="card" style="margin-top:50px;">
            ...
            <div class="card-body ">
              <a href="#"><p class=" blue-text">1. Beneficios de la implementación de la Norma ISO/IEC 27001:2013 en mi Organización</p></a>
              <a href="#"><p class="light-blue-text">2. Presentación ejecutiva de la Implementación de la Norma ISO/IEC 27001:2013.</p></a>
            </div>
        ...
        <div class="col-12" id="bueno" style="display:none">
