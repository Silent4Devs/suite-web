...
<div class="card card-body text-black  fondo_secundario mb-3" align="justify">
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>En este capítulo la norma nos da unas indicaciones de la aplicabilidad de la norma ISO 27001 y de cómo usarla. </p>
...
<div class="card card-body text-black  fondo_secundario mb-3" align="justify">
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>
                                    ...
                                    La implementación de un SGSI en una empresa significa:
                                    <ul>
                                        <li>Adoptar procesos formales</li>
                                        <li>Definir responsabilidades de cara a la seguridad de la información</li>
                                        <li>Establecer políticas, planes y procedimientos para la seguridad de la información</li>
                                    </ul>
                                </p>
                                <p>
                                    <h6>BENEFICIOS </h6>
                                    Abordar la seguridad de la información en una organización mediante un sistema de gestión nos aporta las siguientes ventajas:
                                </p>
                                <p>
                                    <h6 class="subtitulo">1. Mejora Continua</h6>
                                    Gestionar la seguridad de la información supone establecer procesos específicos para la gestión que nos ayuden a:
                                    <ul>
                                        <li>Desarrollar una cultura de la seguridad en una empresa</li>
                                        <li>Implantar de forma gradual el control de la seguridad de la información</li>
                                        <li>Garantizar el crecimiento y la mejora continua de la Seguridad de la información</li>
                                    </ul>
                                </p>
                                <p>
                                    <h6 class="subtitulo">2. Ajustarse a las necesidades de cada Empresa</h6>
                                ...
                                <p>
                                    <h6 class="subtitulo">3. Establecer controles adecuados para la seguridad de la información</h6>
                                ...
                                <p>
                                    <h6 class="subtitulo">2. Procesos sobre la seguridad de la información</h6>
                                ...
                                <p>
                                    <h6>ESTRUCTURA NORMATIVA ISO 27001</h6>
                                ...
                                <p>
                                    <h6 class="subtitulo">1. ISO 27001 Requisitos para un sistema de Gestión (SGSI)  </h6>
...
<br>6.1.3 Tratamiento de riesgos de la seguridad de la informaciónLa empresa debe definir y aplicar un proceso de tratamiento de riesgos de la seguridad de la información.La empresa debe conservar información documentada sobre el proceso de tratamiento de riesgos de la seguridad de la información.
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Asignar recursos para enfocarse en las áreas de mayor importancia;</p>
                                <p>• Toma de decisiones estratégicas sobre cómo gestionar los principales riesgos de seguridad de la información y alcanzar los objetivos.</p>
...
<br>e) Como se realizará la evaluación de resultados
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>Las opciones de tratamiento de riesgo incluyen las siguientes opciones:</p>
                                <p>• Evasión: detener las actividades o procesar la información que está expuesta al riesgo.</p>
                                <p>• Eliminación: Suprimir la fuente del riesgo.</p>
                                <p>• Cambio de probabilidad: Implementar un control que disminuya los incidentes de seguridad de la información.</p>
                                <p>• Cambio en las consecuencias: Implementar un control que disminuya el impacto si llegase a ocurrir un incidente.</p>
                                <p>• Transferencia del riesgo: Externalizar una actividad o proceso a un tercero que tenga mayor capacidad para administrar el riesgo.</p>
                                <p>• Aceptar el riesgo: Si la organización no tiene disponible un método de tratamiento de riesgos real, o si el costo del método de tratamiento de riesgos se considera mayor que el costo de impacto, la organización puede tomar la decisión de aceptar el riesgo, lo cual será aprobado por la gerencia.</p>
                            </div>
...
<br>d) Conservar la información documentada apropiada, como evidencia de la competencia
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Establecer métodos para evaluar si la persona adecuada tiene los conocimientos y las habilidades adecuados.</p>

                                <p>El auditor quiere que tenga documentos que detallen los requisitos de conocimientos y habilidades. Cuando crea que se cumplen los requisitos, es necesario utilizar registros como certificados de formación, registros de asistencia a cursos o evaluaciones de capacidad internas como respaldo.</p>
                            </div>
...
<br>c) Las implicaciones dela no conformidad con los requisitos del Sistema de Gestión de Seguridad de la Información
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Cómo pueden ayudar a las organizaciones a proteger la información y cómo ayudarán a las organizaciones a lograr los objetivos de seguridad de la información.</p>
                                <p>• Qué políticas, procedimientos y medidas de control se relacionan con ellos, y cuáles son las consecuencias de no cumplir con estas regulaciones</p>
                            </div>
                        </div>
                        <!--card-->
                    </div>
...
<br>e) Los procesos para llevar a cabo la comunicación
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Con quién necesita comunicarse;</p>
                                <p>• Quién es responsable de la comunicación;</p>
                                <p>• Cuál es el proceso o los procesos de comunicación.</p>
                            </div>
                        </div>
                        <!--card-->
                    </div>
...
<br>La información documentada de origen externo, que la empresa ha determinado que es necesario para la planificación y la operación del Sistema de Gestión de Seguridad de la Información, se debe identificar y controlar.
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Apoyarlo para cumplir con los requisitos legales, gestionar los riesgos y lograr los objetivos.</p>
                                <p>Para que la información del documento siempre cumpla con estos requisitos, necesitará algunos procesos para garantizar que:</p>
                                <p>• A solicitud del personal apropiado, la información documentada se revisará antes de ser divulgada al público.</p>
                                <p>• El acceso a la información del documento está controlado, por lo que las personas no pueden modificarlo, destruirlo, eliminarlo o acceder a él sin permiso.</p>
                                <p>• La información se elimina de forma segura o se devuelve al propietario cuando es necesario.</p>
                                <p>• Puede realizar un seguimiento de los cambios en la información para asegurarse de que el proceso esté bajo control.</p>
                                <p>La fuente de información de archivo puede ser interna o externa, por lo que el proceso de control administrará la información de archivo de ambas fuentes al mismo tiempo.</p>
                            </div>
                        </div>
                        <!--card-->
                    </div>
...
<br>La empresa debe conservar información documentada de los resultados de las valoraciones de riesgos en cuanto a la seguridad de la información.
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Se finalice un tratamiento de riesgos</p>
                                <p>• Se produzcan cambios en los activos, información o los procesos de la organización;</p>
                                <p>• Se identifiquen nuevos riesgos;</p>
                                <p>• La información indique que la probabilidad y consecuencia del riesgo identificado ha sido cambiado.</p>
                            </div>
...
<br>e) Conservar información documentada como evidencia de la implantación del programa de auditoría y de los resultados de ésta
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• El éxito de los procesos, procedimientos y controles para conseguir las metas esperadas;</p>
                                <p>• Si el SGSI cumple con la norma ISO 27001 y los requisitos de las partes interesadas.</p>
                            </div>
                        </div>
                        <!--card-->
                    </div>
...
<br>b) Los resultados de cualquier acción correctiva
                            ...
                            <div class="card-body text_grande">
                                ...
                                <p>• Que pasó.</p>
                                <p>• Si el evento tiene consecuencias adversas, qué medidas se tomarán para controlarlo y mitigarlo.</p>
                                <p>• La causa raíz del incidente (si se determina).</p>
                                <p>• Medidas tomadas para eliminar la causa raíz (si es necesario).</p>
                                <p>• Evaluación de la eficacia de las medidas adoptadas.</p>
                            </div>
