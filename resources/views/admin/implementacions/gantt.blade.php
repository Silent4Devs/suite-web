...
{{-- gantt online --}}
  ...
  <link rel=stylesheet href="{{asset('../jquery_gantt/platform.css')}}" type="text/css">
  <link rel=stylesheet href="{{asset('../jquery_gantt/libs/jquery/dateField/jquery.dateField.css')}}" type="text/css">

  <link rel=stylesheet href="{{asset('../jquery_gantt/gantt.css')}}" type="text/css">
  <link rel=stylesheet href="{{asset('../jquery_gantt/ganttPrint.css')}}" type="text/css" media="print">
  <link rel=stylesheet href="{{asset('../jquery_gantt/libs/jquery/valueSlider/mb.slider.css')}}" type="text/css" media="print">
...
<div class="__template__" type="TASKROW"><!--
  <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    <th class="gdfCell" align="right" style="cursor:pointer;"><a href="http://tabantaj.test/admin/partes-interesadas/(#=obj.id_fase#)"><span class="taskRowIndex">(#=obj.getRow()+1#)</span> <span class="teamworkIcon" style="font-size:12px;" >e</span></a></th>
