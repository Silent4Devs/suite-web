<div class="col-12" style="margin-left:-15px;">
    <div class="nav nav-tabs" id="tabsEmpleado" role="tablist">
        <a class="nav-link {{ request()->is('admin/procesos-octave') || request()->is('admin/procesos-octave/*') ? 'active' : '' }}" href="{{route('admin.procesos-octave.index')}}">
        <i class="fas fa-project-diagram mr-2" style="font-size:20px;"></i>Procesos
        </a>
        <a class="nav-link {{ request()->is('admin/activosInformacion') || request()->is('admin/activosInformacion/*') ? 'active' : '' }}"  href="{{route('admin.activosInformacion.index')}}" >
        ...
        <a class="nav-link {{ request()->is('admin/contenedores') || request()->is('admin/contenedores/*') ? 'active' : '' }}"  href="{{route('admin.contenedores.index')}}" >
        ...
        <a class="nav-link {{ request()->is('admin/octave-graficas') || request()->is('admin/octave-graficas/*') ? 'active' : '' }}"  href="{{route('admin.octave-graficas')}}" >
