            ...
            <form method="POST" action="{{ route('admin.matriz-riesgos.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="id_sede"><i class="fas fa-city iconos-crear"></i>VP</label><br>
                    ...
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="id_sede"><i class="fas fa-street-view iconos-crear"></i>Área</label><br>
                        <select class="sedeSelect form-control" name="id_sede" id="id_sede">
                            <option value="">Seleccione una opción</option>
                            @foreach ($areas as $area)
                                <option {{old('id_sede') == $area->id ? ' selected="selected"' : ''}} value="{{ $area->id }}">{{ $area->area }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="form-group col-md-8 col-sm-12">
                        <label for="id_sede"><i class="fas fa-file-alt iconos-crear"></i>Nombre del AI</label><br>
                        <input class="form-control {{ $errors->has('nombre_herramienta') ? 'is-invalid' : '' }}" type="text" name="nombre_herramienta"
                        id="nombre_herramienta_puesto" value="{{ old('indicador', '') }}">
                    ...
                    <div class="form-group col-sm-12 col-md-4 col-lg-4" style="margin-top:-7px;">
                        <label for="legal"><i class="fab fa-cloudscale iconos-crear"></i>Valor de la criticidad del activo</label>
                        <select  class="form-control select2 {{ $errors->has('legal') ? 'is-invalid' : '' }}" name="legal">
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-sm-12">
                        <label for="id_responsable"><i class="fas fa-user-tie iconos-crear"></i>Dueño del Activo</label><br>
                ...
                <div class="row">
                    <div class="form-group col-md-4 col-sm-12">
                        ...
                        @if ($errors->has('id_custodio'))
                            <div class="invalid-feedback">
                                {{ $errors->first('id_custodio') }}
                            </div>
                        @endif
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <div class="row">
                            <label for="controles_id" style="margin-left: 15px; margin-bottom:5px; margin-right: 0px;"><i class="fas fa-lock iconos-crear"></i>Seleccione los control(es)
                                a
                                aplicar</label>
