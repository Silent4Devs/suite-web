...
@section('scripts')
    <script>
        $(".btn_grupos").click(function() {
            $(".contenedor-jerarquia").toggleClass("grupos_funciones");
        });
    </script>
    ...
    <script type="module">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $("#reloadOrg").click(function(e) {
                ...
                document.querySelector("#zoomer").value = 50;
                document.querySelector("#output").innerHTML = 50;
                renderOrganigrama(OrgChart, 'l2r');
            });

            function renderOrganigrama(OrgChart, orientacion, id = null, area_filter = false, area_id = null) {
                let existeArbol = @json($existeArbol);
                ...
                let url_organigrama = "{{ route('admin.octave.arbol-riesgos.obtener') }}";
