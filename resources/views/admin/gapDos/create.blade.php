    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.gap-dos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('anexo_indice') ? 'is-invalid' : '' }}" type="text" name="anexo_indice" id="anexo_indice" value="{{ old('anexo_indice', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('control') ? 'is-invalid' : '' }}" type="text" name="control" id="control" value="{{ old('control', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descripcion_control') ? 'is-invalid' : '' }}" type="text" name="descripcion_control" id="descripcion_control" value="{{ old('descripcion_control', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('valoracion') ? 'is-invalid' : '' }}" name="valoracion" id="valoracion">
                    ...
                    @foreach(App\Models\GapDo::VALORACION_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('valoracion', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('evidencia') ? 'is-invalid' : '' }}" type="text" name="evidencia" id="evidencia" value="{{ old('evidencia', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recomendacion') ? 'is-invalid' : '' }}" type="text" name="recomendacion" id="recomendacion" value="{{ old('recomendacion', '') }}">
