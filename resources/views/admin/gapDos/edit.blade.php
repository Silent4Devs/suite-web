            ...
            <form method="POST" action="{{ route('admin.gap-dos.update', [$gapDo->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('anexo_indice') ? 'is-invalid' : '' }}" type="text"
                        name="anexo_indice" id="anexo_indice" value="{{ old('anexo_indice', $gapDo->anexo_indice) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('control') ? 'is-invalid' : '' }}" type="text"
                        name="control" id="control" value="{{ old('control', $gapDo->control) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('descripcion_control') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('descripcion_control', $gapDo->descripcion_control) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('valoracion') ? 'is-invalid' : '' }}" name="valoracion"
                        ...
                        @foreach (App\Models\GapDo::VALORACION_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('valoracion', $gapDo->valoracion) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('evidencia') ? 'is-invalid' : '' }}" type="text"
                        name="evidencia" id="evidencia" value="{{ old('evidencia', $gapDo->evidencia) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('recomendacion') ? 'is-invalid' : '' }}" type="text"
                        name="recomendacion" id="recomendacion" value="{{ old('recomendacion', $gapDo->recomendacion) }}">
