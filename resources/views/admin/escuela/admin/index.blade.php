    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="font-weight-bold mb-4" style="padding-bottom: 10px; border-color: #3086AF !important; font-size: 15px; border-bottom-style:solid;border-width: 1px;">Niveles</div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <div class="font-weight-bold mb-4" style="padding-bottom: 10px; border-color: #3086AF !important; font-size: 15px; border-bottom-style:solid;border-width: 1px;">Estatus de los cursos</div>
            ...
            <div class="col-sm-12 mt-4">
                <div class="card">
                    <div class="card-body font-weight-bold mb-4" style="padding-bottom: 10px; border-color: #3086AF !important; font-size: 15px; border-bottom-style:solid;border-width: 1px;">Categorías populares</div>
...
@section('js')
    ...
    <script>
        ...
        let cantidadCategoriasArrayPorcentaje = cantidadCategoriasArray.map(val => ((val / totalCategorias) * 100).toFixed(2));
