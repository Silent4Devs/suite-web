                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                                ...
                                                <ul style="font-size:11pt; color:#153643;">
                                                    @foreach ($controles_name  as $control)
                                                    <li style="font-size:11pt;"><strong style="font-size:10pt;">{{$control->control_iso}}</strong> {{$control->anexo_politica}}
                                                    </li>
                                                    @endforeach
                                                </ul>
                                                ...
                                                <div style="text-align:center; margin-top:20px">
                                                  <span style="text-decoration:none;padding-top:15px; border-radius:4px; display:inline-block; min-width:300px; height:35px ;color:#fff; font-size:11pt; background-color:#345183">
                                                    <a href="{{ route('admin.declaracion-aplicabilidad-2022.index') }}" style="color:#fff"> Gestionar controles</a></span>
                                                </div>
