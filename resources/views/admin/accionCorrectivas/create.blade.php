    ...
    <div class="card-body">
        <ul class="nav nav-pills nav-fill" id="myTabJust" role="tablist">
            <li class="nav-item border">
                <a class="nav-link active" id="plan-tab-just" data-toggle="tab" href="#plan-just" role="tab"
                   aria-controls="plan-just"
                   aria-selected="true"><font class="letra_blanca">Accion Correctiva</font></a>
            </li>
            <li class="nav-item border">
        ...
        <div class="tab-content card pt-5" id="myTabContentJust" style="border: none;">
            
      
            <div class="tab-pane fade show active" id="plan-just" role="tabpanel" aria-labelledby="plan-tab-just">
