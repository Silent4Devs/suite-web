            ...
            <div class="card col-sm-12 col-md-10">
                <div class="card-body">
                    ...
                    @forelse ($accionCorrectiva->analisis as $analisis)
                        <strong style="color:#18183c">{{ $analisis->metodo }}</strong>
                    @empty
                        ...
                        <div id="digrama" class="caja_oculta_dinamica">
                            <div class="mt-5 col-md-12">
                                <div style="width: 100%;">
                                    ...
                                    <div class="p-2"
                                        style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; top:45px; left:5px; position: absolute; height:80px !important; width:190px;">
                                        <span  style="font-size:5pt;">{!!$analisis->control_a  ? $analisis->control_a : 'Sin registro' !!}</span>
                                    </div>
                                    <div class="p-2"
                                    style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; top:45px; left:210px; position: absolute; height:80px !important; width:190px;">
                                    <span style="font-size:5pt;">{!! $analisis->proceso_a  ? $analisis->proceso_a : 'Sin registro' !!}</span>
                                    </div>
                                    <div class="p-2"
                                    style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; top:45px; left:410px; position: absolute; height:80px !important; width:190px;">
                                    <span style="font-size:5pt;">{!! $analisis->personas_a ? $analisis->personas_a : 'Sin registro' !!}</span>
                                    </div>
                                    <div class="p-2" style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; bottom:15px; right:530px; position: absolute; height:80px !important; width:185px;">
                                        <span style="font-size:5pt;">{!! $analisis->tecnologia_a ? $analisis->tecnologia_a : 'Sin registro' !!}</span>
                                    </div>
                                    <div class="p-2" style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; bottom:15px; right:335px; position: absolute; height:80px !important; width:185px;">
                                        <span style="font-size:5pt;">{!! $analisis->metodos_a ? $analisis->metodos_a : 'Sin registro' !!}</span>
                                    </div>
                                    <div class="p-2" style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; bottom:15px; right:145px; position: absolute; height:80px !important; width:185px;">
                                        <span style="font-size:5pt;">{!! $analisis->ambiente_a ? $analisis->ambiente_a : 'Sin registro' !!}</span>
                                    </div>

                                    <div class="p-2" style="border: 1px solid rgb(48, 247, 230); border-radius: 5px; background-color:white;color:#18183c; bottom:15px; right:-10px; position: absolute; height:80px !important; width:150px;">
