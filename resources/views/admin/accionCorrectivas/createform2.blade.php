<div class="form-group col-12">
                                ...
                                <select class="form-control {{ $errors->has('metodo_causa') ? 'is-invalid' : '' }}" name="metodo_causa" id="metodo_causa" required>
                                    <option></option>
                            ...
                            <div class="form-group col-md-6">
                                <label for="solucion"><i class="far fa-file-alt iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.solucion') }}
                                </label>
                                <textarea class="form-control {{ $errors->has('solucion') ? 'is-invalid' : '' }}" name="solucion" id="solucion" required>{{ old('solucion') }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                <label for="cierre_accion"><i class="far fa-file-alt iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.cierre_accion') }}
                                </label>
                                <textarea class="form-control {{ $errors->has('cierre_accion') ? 'is-invalid' : '' }}" name="cierre_accion" id="cierre_accion" required>{{ old('cierre_accion') }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                <label for="fecha_compromiso"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.fecha_compromiso') }}
                                </label>
                                <input class="form-control date {{ $errors->has('fecha_compromiso') ? 'is-invalid' : '' }}" type="text" name="fecha_compromiso" id="fecha_compromiso" value="{{ old('fecha_compromiso') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="fecha_verificacion"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.fecha_verificacion') }}
                                </label>
                                <input class="form-control date {{ $errors->has('fecha_verificacion') ? 'is-invalid' : '' }}" type="text" name="fecha_verificacion" id="fecha_verificacion" value="{{ old('fecha_verificacion') }}" required>
                            ...
                            <div class="form-group col-md-6">
                                <label for="responsable_accion_id"><i class="fas fa-user-tag iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.responsable_accion') }}
                                </label>
                                <select class="form-control select2 {{ $errors->has('responsable_accion') ? 'is-invalid' : '' }}" name="responsable_accion_id" id="responsable_accion_id" required>
                                    <option></option>
                            ...
                            <div class="form-group col-md-6">
                                <label for="nombre_autoriza_id"><i class="fas fa-user-tag iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.nombre_autoriza') }}
                                </label>
                                <select class="form-control select2 {{ $errors->has('nombre_autoriza') ? 'is-invalid' : '' }}" name="nombre_autoriza_id" id="nombre_autoriza_id" required>
                                    <option></option>
                            ...
                            <div class="form-group col-12">
                                <label for="documentometodo"><i class="far fa-file iconos-crear"></i>{{ trans('cruds.accionCorrectiva.fields.documentometodo') }}
                                </label>
