...
@section('content')
    ...
    @can('roles_responsabilidade_create')
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered datatable-RolesResponsabilidade" style="width: 100%">
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let dtButtons = [{
                    extend: 'csvHtml5',
                    title: `Roles y Responsabilidades ${new Date().toLocaleDateString().trim()}`,
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'comiteseguridad',
                        name: 'comiteseguridad'
                    },
                    {
                        data: 'responsablesgsi',
                        name: 'responsablesgsi'
                    },
                    {
                        data: 'coordinadorsgsi',
                        name: 'coordinadorsgsi'
                    },
                    {
                        data: 'rol',
                        name: 'rol'
