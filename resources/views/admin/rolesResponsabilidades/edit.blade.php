    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form method="POST" class="row"
                action="{{ route('admin.roles-responsabilidades.update', [$rolesResponsabilidade->id]) }}"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('responsabilidad') ? 'is-invalid' : '' }}" type="text"
                        ...
                        value="{{ old('responsabilidad', $rolesResponsabilidade->responsabilidad) }}" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('direccionsgsi') ? 'is-invalid' : '' }}" type="text"
                        name="direccionsgsi" id="direccionsgsi"
                        value="{{ old('direccionsgsi', $rolesResponsabilidade->direccionsgsi) }}" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('comiteseguridad') ? 'is-invalid' : '' }}" type="text"
                        name="comiteseguridad" id="comiteseguridad"
                        value="{{ old('comiteseguridad', $rolesResponsabilidade->comiteseguridad) }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('responsablesgsi') ? 'is-invalid' : '' }}" type="text"
                        name="responsablesgsi" id="responsablesgsi"
                        value="{{ old('responsablesgsi', $rolesResponsabilidade->responsablesgsi) }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('coordinadorsgsi') ? 'is-invalid' : '' }}" type="text"
                        name="coordinadorsgsi" id="coordinadorsgsi"
                        value="{{ old('coordinadorsgsi', $rolesResponsabilidade->coordinadorsgsi) }}">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control {{ $errors->has('rol') ? 'is-invalid' : '' }}" type="text" name="rol"
                        id="rol" value="{{ old('rol', $rolesResponsabilidade->rol) }}">
                    @if ($errors->has('rol'))
                        <div class="invalid-feedback">
                            {{ $errors->first('rol') }}
                        </div>
