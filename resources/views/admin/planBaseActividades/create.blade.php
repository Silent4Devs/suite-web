    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plan-base-actividades.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="actividad"><i class="fas fa-file-alt iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.actividad') }}</label>
            ...
            <div class="form-group">
                <label for="actividad_padre_id"><i class="fas fa-clipboard-check iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.actividad_padre') }}</label>
                <select class="form-control select2 {{ $errors->has('actividad_padre') ? 'is-invalid' : '' }}" name="actividad_padre_id" id="actividad_padre_id">
                    @foreach($actividad_padres as $id => $actividad_padre)
                        <option value="{{ $id }}" {{ old('actividad_padre_id') == $id ? 'selected' : '' }}>{{ $actividad_padre }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="ejecutar_id"><i class="fas fa-cogs iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.ejecutar') }}</label>
                <select class="form-control select2 {{ $errors->has('ejecutar') ? 'is-invalid' : '' }}" name="ejecutar_id" id="ejecutar_id">
                    @foreach($ejecutars as $id => $ejecutar)
                        <option value="{{ $id }}" {{ old('ejecutar_id') == $id ? 'selected' : '' }}>{{ $ejecutar }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="guia"><i class="fas fa-file-invoice iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.guia') }}</label>
            ...
            <div class="form-group">
                <label for="estatus_id"><i class="fas fa-clipboard-list iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.estatus') }}</label>
                <select class="form-control select2 {{ $errors->has('estatus') ? 'is-invalid' : '' }}" name="estatus_id" id="estatus_id">
                    @foreach($estatuses as $id => $estatus)
                        <option value="{{ $id }}" {{ old('estatus_id') == $id ? 'selected' : '' }}>{{ $estatus }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="responsable_id"><i class="fas fa-user iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.responsable') }}</label>
            ...
            <div class="form-group">
                <label for="colaborador_id"><i class="fas fa-user iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.colaborador') }}</label>
                <select class="form-control select2 {{ $errors->has('colaborador') ? 'is-invalid' : '' }}" name="colaborador_id" id="colaborador_id">
                    @foreach($colaboradors as $id => $colaborador)
                        <option value="{{ $id }}" {{ old('colaborador_id') == $id ? 'selected' : '' }}>{{ $colaborador }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <label for="fecha_inicio"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.fecha_inicio') }}</label>
        ...
        <span class="glyphicon glyphicon-th"></span>
            ...
            <div class="form-group">
                <label for="fecha_fin"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.fecha_fin') }}</label>
            ...
            <div class="form-group">
                <label for="compromiso"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.compromiso') }}</label>
                <input class="form-control date {{ $errors->has('compromiso') ? 'is-invalid' : '' }}" type="text" name="compromiso" id="compromiso" value="{{ old('compromiso') }}">
            ...
            <div class="form-group">
                <label for="real"> <i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.planBaseActividade.fields.real') }}</label>
                <input class="form-control date {{ $errors->has('real') ? 'is-invalid' : '' }}" type="text" name="real" id="real" value="{{ old('real') }}">
                @if($errors->has('real'))
                    <div class="invalid-feedback">
                        {{ $errors->first('real') }}
                    </div>
