...
<div class="mt-4 card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.tipo-acceso.update', [$tiposAcceso->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre"
                    id="nombre" value="{{ old('nombre', $tiposAcceso->nombre) }}" required>
            ...
            <div class="form-group col-sm-12 col-md-12 col-lg-12">
                ...
                <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" type="text" name="descripcion"
                    id="descripcion" required>{{ old('descripcion', $tiposAcceso->descripcion) }}</textarea>
