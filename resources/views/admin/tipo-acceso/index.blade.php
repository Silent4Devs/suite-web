...
<style>
    ...
    {{-- {{ Breadcrumbs::render('perfil-puesto') }} --}}
        ...
        <h5 class="col-12 titulo_general_funcion">Tipo de acceso </h5>
        <div class="mt-5 card">
    ...
    <script>
        $(function() {
            let dtButtons = [{
                ...
                url: "{{ route('admin.tipo-acceso.create') }}",
            ...
            @can('puesto_delete')
                ...
                url: "{{ route('admin.tipo-acceso.destroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.tipo-acceso.index') }}",
                columns: [{
                        data: 'nombre',
                        name: 'nombre'
                    },
