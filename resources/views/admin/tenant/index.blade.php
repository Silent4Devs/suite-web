...
@section('content')
{{-- {{ Breadcrumbs::render('admin.tenant.index') }} --}}


<div class="mt-5 card">

        <div class="py-3 col-md-10 col-sm-9 card card-body bg-primary align-self-center " style="margin-top:-40px; ">
            <h3 class="mb-2 text-center text-white"><strong>Tenant</strong></h3>
        </div>
    ...
    <script>
        $(function() {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.tenant.massDestroy') }}",
            ...
            let table = $('#tblTenant').DataTable(dtOverrideGlobals);
        });
    </script>
