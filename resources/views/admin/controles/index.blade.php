    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.controles.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.controle.title_singular') }}
            </a>
...
<div class="card">
    <div class="card-header">
        {{ trans('cruds.controle.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Controle">
            <thead>
                <tr>
                    <th width="10">
