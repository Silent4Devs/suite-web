<div class="row">
    ...
    <div class="form-group col-sm-6">
        ...
        <input type="text" name="categoria" id="categoria" class="form-control" maxlength="255" value="{{ old('categoria') }}">
    </div>

    <!-- Descripcion Field -->
    <div class="form-group col-sm-12">
        <label for="descripcion"><i class="fas fa-file-alt iconos-crear"></i> Descripción:</label>
