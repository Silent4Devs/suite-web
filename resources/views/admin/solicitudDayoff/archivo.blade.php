...
@section('content')
    <div class="mt-3">
        {{ Breadcrumbs::render('Archivo-Dayoff') }}
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered w-100 datatable datatable-archivo-dayoff tblCSV"
                id="datatable-archivo-dayoff">
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.solicitud-dayoff.archivo') }}",
                columns: [{
                        data: 'empleado',
                        name: 'empleado',
            ...
            let table = $('.datatable-archivo-dayoff').DataTable(dtOverrideGlobals);
            ...
            `;
                imprimirTabla('datatable-archivo-dayoff', titulo_tabla);
            });
