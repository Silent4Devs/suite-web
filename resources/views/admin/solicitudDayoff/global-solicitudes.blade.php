...
@section('content')
    <div class="mt-3">
        {{ Breadcrumbs::render('Aprobacion-Dayoff') }}
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="datatable-rds">
                <table class="table w-100 datatable datatable-aprobacion-dayoff tblCSV" id="datatable-aprobacion-dayoff">
                        ...
                        @foreach ($query as $keySol => $sol)
                            <tr>
                                ...
                                <td style="min-width: 75px;">
                                    {{ \Carbon\Carbon::parse($sol->fecha_inicio)->format('d-m-Y') }}
                                </td>
                                <td style="min-width: 75px;">
                                ...
                                <td style="min-width: 70px;">
                                    <div style="text-aling:center">
                                        <a href="{{ $sol->id }}/respuesta" title="Aprobar/ Rechazar solicitud"><i
                                                class="fa-solid fa-file-pen fa-1x text-info text-aling:center"></i>
                                        </a>
                                    </div>
                                </td>
                        @endforeach
    ...
    <script>
        $(function() {
            ...
            let btnAgregar = {
                ...
                titleAttr: 'Archivo',
                url: "{{ route('admin.solicitud-dayoff.archivo') }}",
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                // ajax: "{{ route('admin.solicitud-dayoff.aprobacion') }}",
                // columns: [{
                //         data: 'empleado',
                //         name: 'empleado',
            ...
            let table = $('.datatable-aprobacion-dayoff').DataTable(dtOverrideGlobals);
            $('.btn.buttons-print.btn-sm.rounded.pr-2').unbind().click(function() {
                let titulo_tabla = `
                <h5>
                    <strong>
                        Aprobación de Day Off
                    </strong>
                </h5>
            `;
                imprimirTabla('datatable-aprobacion-dayoff', titulo_tabla);
            });
