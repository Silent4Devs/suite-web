        ...
        (function(H) {
            H.addEvent(H.Chart, 'load', function(e) {
                ...
                H.addEvent(chart.container, 'click', function(e) {
                    ...
                    ganttHeight = (visibleRowsCount > 0) ? ((visibleRowsCount * 20) + 120) :
                    ganttHeight;
                ...
                series: {
                    animation: {
                        complete: function() {
                            ...
                            console.log("Elementi lvl2: " + document.getElementsByClassName(
                                "highcharts-treegrid-node-level-2").length);

                            var visibleRowsCount = 0;
                            var ganttHeight = this.plotHeight;
                            visibleRowsCount = document.getElementsByClassName(
                                "highcharts-treegrid-node-level-2").length + 6; //phases always out
                            gchart.reflow();
                            ganttHeight = (visibleRowsCount > 0) ? ((visibleRowsCount * 20) + 120) :
                            ganttHeight;
            ...
            series: [{
                ...
                data: [{
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 5, 28),
                        end: Date.UTC(2020, 5, 28),
                        parent: 'Phase1',
                        y: 19
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 12, 3),
                        end: Date.UTC(2020, 12, 3),
                        parent: 'Phase2',
                        y: 20
                    },
                    {
                        ...
                        name: 'Manual del SGI',
                        milestone: true,
                        start: Date.UTC(2020, 10, 22),
                        end: Date.UTC(2020, 10, 22),
                        parent: 'Phase2',
                        y: 23
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 11, 17),
                        end: Date.UTC(2020, 11, 17),
                        parent: 'Phase2',
                        y: 29
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 2, 22),
                        end: Date.UTC(2020, 2, 22),
                        parent: 'Phase2',
                        y: 25
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 9, 26),
                        end: Date.UTC(2020, 9, 26),
                        parent: 'Phase3',
                        y: 13
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 9, 28),
                        end: Date.UTC(2020, 9, 28),
                        parent: 'Phase3',
                        y: 15
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 3, 16),
                        end: Date.UTC(2020, 3, 16),
                        parent: 'Phase4',
                        y: 9
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2020, 12, 4),
                        end: Date.UTC(2020, 12, 4),
                        parent: 'Phase4',
                        y: 12
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2022, 1, 23),
                        end: Date.UTC(2022, 1, 23),
                        parent: 'Phase4',
                        y: 4
                    },
                    {
                    ...
                    },
                    {
                        ...
                        milestone: true,
                        start: Date.UTC(2022, 2, 25),
                        end: Date.UTC(2022, 2, 25),
                        parent: 'Phase4',
                        y: 31
                    },
                    {
