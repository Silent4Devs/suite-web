...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <div class="card-body">
                <form method="POST" action="{{ route('admin.servicios.update', [$servicios->id]) }}"
                    enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label class="required" for="servicio"><i class="fas fa-briefcase iconos-crear"></i>Nombre del
                            servicio</label>
                        <input class="form-control {{ $errors->has('servicio') ? 'is-invalid' : '' }}" type="text"
                            name="servicio" id="servicio" value="{{ old('servicio', $servicios->servicio) }}" required>
                    ...
                    <div class="form-group col-sm-6 col-md-6 col-lg-6">
                        <label for="descripcion"><i class="fas fa-briefcase iconos-crear"></i>Descripcion</label>
