...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <form method="POST" class="row" action="{{ route('admin.plan-auditoria.update', [$planAuditorium->id]) }}"
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control {{ $errors->has('id_auditoria') ? 'is-invalid' : '' }}" type="text"
                        name="id_auditoria" id="id_auditoria"
                        value="{{ old('id_auditoria', $planAuditorium->id_auditoria) }}" maxlength="255">
                ...
                <div class="form-group col-sm-12 col-md-8 col-lg-8">
                    ...
                    <input class="form-control {{ $errors->has('nombre_auditoria') ? 'is-invalid' : '' }}" type="text"
                        maxlength="255" name="nombre_auditoria" id="nombre_auditoria"
                        value="{{ old('nombre_auditoria', $planAuditorium->nombre_auditoria) }}" required>
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    <label for="fecha_inicio_auditoria" class="required"><i class="far fa-calendar-alt iconos-crear"></i>
                        Fecha de inicio</label>
                    <input class="mt-2 form-control {{ $errors->has('fecha_inicio_auditoria') ? 'is-invalid' : '' }}"
                        type="date" required name="fecha_inicio_auditoria" id="fecha_inicio_auditoria" min="1945-01-01"
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    <label for="fecha_fin_auditoria" class="required"><i class="far fa-calendar-alt iconos-crear"></i> Fecha
                        fin</label>
                    <input required
                        class=" mt-2 form-control  {{ $errors->has('fecha_fin_auditoria') ? 'is-invalid' : '' }}"
                        type="date" name="fecha_fin_auditoria" id="fecha_fin_auditoria" min="1945-01-01"
                    ...
                    <select multiple class="form-control select2 {{ $errors->has('equipoauditoria') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($equipoauditorias as $equipoauditoria)
                            <option value="{{ $equipoauditoria->id }}"
                                {{ in_array(old('equipo', $equipoauditoria->id), $equipo_seleccionado) ? 'selected' : '' }}>
                ...
                <div class="form-group col-sm-12 col-md-12 col-lg-12">
                    <label for="objetivo" class="required"><i class="fas fa-bullseye iconos-crear"></i>Objetivo de la
                        auditoría</label>
                    <textarea class="form-control {{ $errors->has('objetivo') ? 'is-invalid' : '' }}" name="objetivo" id="objetivo"
                        required>{{ old('objetivo', $planAuditorium->objetivo) }}</textarea>
                ...
                <div class="form-group col-sm-12 col-md-12 col-lg-12">
                    ...
                    <textarea class="form-control {{ $errors->has('alcance') ? 'is-invalid' : '' }}" name="alcance" id="alcance"
                        required>{{ old('alcance', $planAuditorium->alcance) }}</textarea>
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                    ...
                    <textarea class="form-control {{ $errors->has('criterios') ? 'is-invalid' : '' }}" name="criterios" id="criterios"
                        required>{{ old('criterios', $planAuditorium->criterios) }}</textarea>
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                    ...
                    <textarea class="form-control {{ $errors->has('documentoauditar') ? 'is-invalid' : '' }}" name="documentoauditar"
                ...
                <div class="text-right form-group col-12">
                    <a href="{{ route('admin.plan-auditoria.index') }}" class="btn btn-outline-primary">Cancelar</a>
