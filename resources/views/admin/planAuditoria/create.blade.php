            ...
            <form method="POST" action="{{ route('admin.plan-auditoria.store') }}" enctype="multipart/form-data"
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class="form-control {{ $errors->has('id_auditoria') ? 'is-invalid' : '' }}" type="text"
                        name="id_auditoria" id="id_auditoria" value="{{ old('id_auditoria', '') }}" maxlength="255">
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    ...
                    <input class=" mt-2 form-control  {{ $errors->has('fecha_inicio_auditoria') ? 'is-invalid' : '' }}"
                        name="fecha_inicio_auditoria" type="date" id="fecha_inicio_auditoria" min="1945-01-01"
                        value="{{ old('fecha_inicio_auditoria') }}" required>
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    <label for="fecha_fin_auditoria" class="required"> <i class="far fa-calendar-alt iconos-crear"></i>
                        Fecha fin</label>
                    <input class=" mt-2 form-control  {{ $errors->has('fecha_fin_auditoria') ? 'is-invalid' : '' }}"
                        type="date" name="fecha_fin_auditoria" id="fecha_fin_auditoria" min="1945-01-01"
                        value="{{ old('fecha_fin_auditoria') }}" required>
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                    ...
                    <textarea class="form-control {{ $errors->has('criterios') ? 'is-invalid' : '' }}" name="criterios" id="criterios"
                        required>{{ old('criterios') }}</textarea>
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                    ...
                    <textarea class="form-control {{ $errors->has('documentoauditar') ? 'is-invalid' : '' }}" name="documentoauditar"
                        id="documentoauditar">{{ old('documentoauditar') }}</textarea>
