            ...
            <form method="POST" action="{{ route('admin.concientizacion-sgis.store') }}" enctype="multipart/form-data"
                ...
                <div class="form-group col-12">
                    ...
                    <input class="form-control {{ $errors->has('objetivocomunicado') ? 'is-invalid' : '' }}" type="text"
                        name="objetivocomunicado" id="objetivocomunicado" value="{{ old('objetivocomunicado', '') }}"
                        required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control {{ $errors->has('medio_envio') ? 'is-invalid' : '' }}" name="medio_envio"
                        ...
                        @foreach (App\Models\ConcientizacionSgi::MEDIO_ENVIO_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('medio_envio', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control date {{ $errors->has('fecha_publicacion') ? 'is-invalid' : '' }}"
                        type="date" min="1945-01-01" name="fecha_publicacion" id="fecha_publicacion"
