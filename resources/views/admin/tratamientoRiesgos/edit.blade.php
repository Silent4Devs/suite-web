...
<div class="mt-4 card">
    <div class="card-body">
        <form method="POST" class="row" action="{{ route("admin.tratamiento-riesgos.update", [$tratamientos->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
           {{-- <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-4 mb-4">
                    ...
                    <input readonly disabled type="number" name="identificador" value="{{ old('identificador', $tratamientos->identificador) }}" class="form-control" name="identificador" id="identificador" required>
            ...
            <div class="form-group col-12">
                ...
                <textarea class="form-control {{ $errors->has('descripcionriesgo') ? 'is-invalid' : '' }}" name="descripcionriesgo" id="descripcionriesgo">{{ old('descripcionriesgo', $tratamientos->descripcionriesgo) }}</textarea>
            ...
            <div class="form-group col-md-4 mb-4">
                ...
                <input readonly disabled type="number" name="riesgototal" value="{{ old('riesgototal', $tratamientos->riesgototal) }}" class="form-control">
               
            </div>

            <div class="form-group col-md-4 mb-4">
                <label><i class="fas fa-exclamation-circle iconos-crear"></i>Riesgo Residual</label>
                <input readonly disabled type="number" name="riesgo_total_residual" value="{{ old('riesgo_total_residual', $tratamientos->riesgo_total_residual) }}" class="form-control">
            </div>
            ...
            <div class="form-group col-md-4 col-sm-4">
                <label for="inversion_requerida"><i class="fas fa-chart-line iconos-crear"></i>Inversión requerida</label>
