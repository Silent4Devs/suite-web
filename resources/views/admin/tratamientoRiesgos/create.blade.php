...
@section('content')
    ...
    <div class="card mt-4">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.tratamiento-riesgos.store') }}" enctype="multipart/form-data"
                class="row">
                @csrf
                ...
                <div class="col-md-12">
                    <label for="acciones_tratamiento"><i class="fas fa-chart-bar iconos-crear"></i>Acciones de
                        Tratamiento</label>
                ...
                <div class="form-group col-md-6">
                    <label for="control_id"><i
                            class="fas fa-chart-area iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.control') }}</label>
                    <select class="form-control select2 {{ $errors->has('control') ? 'is-invalid' : '' }}" name="control_id"
                        id="control_id">
                        @foreach ($controls as $id => $control)
                            <option value="{{ $control->id }}" {{ old('control_id') == $id ? 'selected' : '' }}>
                ...
                <div class="form-group col-12">
                    <label for="acciones"><i
                            class="fas fa-clipboard-list iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.acciones') }}</label>
                ...
                <div class="form-group col-md-6">
                    <label for="fechacompromiso"><i
                            class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.fechacompromiso') }}</label>
                    <input class="form-control {{ $errors->has('fechacompromiso') ? 'is-invalid' : '' }}" type="date"
                ...
                <div class="form-group col-md-6">
                    <label><i
                            class="fas fa-bullseye iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.prioridad') }}</label>
                ...
                <div class="form-group col-md-6">
                    <label for="estatus"><i
                            class="fas fa-signal iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.estatus') }}</label>
                    <input class="form-control {{ $errors->has('estatus') ? 'is-invalid' : '' }}" type="text"
                        name="estatus" id="estatus" value="{{ old('estatus', '') }}">
                ...
                <div class="form-group col-md-6">
                    <label for="probabilidad"><i
                            class="fas fa-percentage iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.probabilidad') }}</label>
                    <input class="form-control {{ $errors->has('probabilidad') ? 'is-invalid' : '' }}" type="text"
                        name="probabilidad" id="probabilidad" value="{{ old('probabilidad', '') }}">
                ...
                <div class="form-group col-md-6">
                    <label for="impacto"><i
                            class="fas fa-chart-line iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.impacto') }}</label>
                ...
                <div class="form-group col-md-6">
                    <label for="nivelriesgoresidual"><i
                            class="fas fa-chart-bar iconos-crear"></i>{{ trans('cruds.tratamientoRiesgo.fields.nivelriesgoresidual') }}</label>
                    <input class="form-control {{ $errors->has('nivelriesgoresidual') ? 'is-invalid' : '' }}"
                        type="text" name="nivelriesgoresidual" id="nivelriesgoresidual"
                        value="{{ old('nivelriesgoresidual', '') }}">
                    ...
                    @endif
                    <span
                        class="help-block">{{ trans('cruds.tratamientoRiesgo.fields.nivelriesgoresidual_helper') }}</span>
                </div>
