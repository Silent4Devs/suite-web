...
<div class="card mt-5">
    ...
    <div style="margin-bottom: 10px;  margin-left:10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.tratamiento-riesgos.create') }}">
...
@endcan
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-TratamientoRiesgo">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'nivelriesgoresidual', name: 'nivelriesgoresidual' },
