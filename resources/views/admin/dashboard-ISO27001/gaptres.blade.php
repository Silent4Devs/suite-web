                ...
                <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table" style="font-size: 12px;">
                            ...
                            <tbody>
                            @foreach($gaptresver as $verificar)
                            <tr>
                                <th scope="row">
                                    {{$verificar->gap_tres_catalogo->id}}
                                </th>
                                <td>
                                    {{$verificar->gap_tres_catalogo->pregunta}}
                                </td>
                                <td>
                                    <a href="#"
                                       data-type="select"
                                       data-pk="{{$verificar->id}}"
                                       data-url="{{route("admin.gap-tres-2022.update",  $verificar->id)}}"
                    ...
                    <div class="table-responsive">
                        <table class="table" style="font-size: 12px;">
                            ...
                            @foreach($gaptresact as $actuar)
                                <tr>
                                    <th scope="row">
                                        {{$actuar->gap_tres_catalogo->id}}
                                    </th>
                                    <td>
                                        {{$actuar->gap_tres_catalogo->pregunta}}
                                    </td>
                                    <td>
                                        <a href="#"
                                           data-type="select"
                                           data-pk="{{$actuar->id}}"
                                           data-url="{{route("admin.gap-tres-2022.update",  $actuar->id)}}"
                                           data-title="Seleccionar valoracion"
