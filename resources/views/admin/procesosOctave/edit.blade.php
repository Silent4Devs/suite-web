...
@section('content')
    ...
    <div class="mt-5 card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.procesos-octave.update', [$procesosOctave->id]) }}"
                ...
                <div class="col-12 row">
                    ...
                    <div class="form-group col-sm-12 col-md-4 col-lg-4">
                        <label for="fecha_registro"><i class="fas fa-calendar-alt iconos-crear"></i>Fecha de
                            registro</label>
                ...
                <div class="col-12 row">
                    <div class="form-group col-md-6 col-sm-12">
                        ...
                        <select class="procesoSelect mt-2 form-control" name="id_proceso" id="proceso_activo"
                            value="{{ $procesosOctave->id_proceso }}">
                ...
                <div class="col-12 row">
                    <div class="form-group col-md-6 col-sm-12">
                        ...
                        <select class="sedeSelect form-control" name="id_direccion" id="id_direccion"
                            value="{{ $procesosOctave->id_direccion }}">
                            <option value="" selected disabled>Seleccione una opción</option>
