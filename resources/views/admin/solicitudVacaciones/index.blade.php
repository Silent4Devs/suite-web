    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.solicitud-vacaciones.index') }}",
                columns: [{
            ...
            let table = $('.datatable-solicitud-vacaciones').DataTable(dtOverrideGlobals);
            ...
            `;
                imprimirTabla('datatable-solicitud-vacaciones', titulo_tabla);
            });
