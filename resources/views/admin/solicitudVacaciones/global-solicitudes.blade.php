...
@section('content')
    <div class="mt-3">
        {{ Breadcrumbs::render('Aprobacion-Vacaciones') }}
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered w-100 datatable datatable-aprobacion-vacaciones tblCSV"
                id="datatable-aprobacion-vacaciones">
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                // ajax: "{{ route('admin.solicitud-vacaciones.aprobacion') }}",
                // columns: [{
                //         data: 'empleado',
                //         name: 'empleado',
            ...
            let table = $('.datatable-aprobacion-vacaciones').DataTable(dtOverrideGlobals);
            ...
            `;
                imprimirTabla('datatable-aprobacion-vacaciones', titulo_tabla);
            });
