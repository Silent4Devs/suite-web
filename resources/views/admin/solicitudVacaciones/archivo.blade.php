...
@section('content')
    <div class="mt-3">
        {{ Breadcrumbs::render('Archivo-Vacaciones') }}
    </div>
    ...
    <h5 class="col-12 titulo_general_funcion">Archivo aprobación de Vacaciones</h5>
    ...
    <div class="card">
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered w-100 datatable datatable-archivo-vacaciones tblCSV"
                id="datatable-archivo-vacaciones">
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.solicitud-vacaciones.archivo') }}",
                columns: [{
                        data: 'empleado',
                        name: 'empleado',
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `  
                                ...
                                <a href="${row.id}/archivoShow"  title="Ver detalles"><i class="fa-solid fa-eye fa-1x text-info text-aling:center"></i></a>
                                </div
                               `;
                        }
                    }
            ...
            let table = $('.datatable-archivo-vacaciones').DataTable(dtOverrideGlobals);
            ...
            `;
                imprimirTabla('datatable-archivo-vacaciones', titulo_tabla);
            });
