...
@section('content')
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{!! route('admin.vista-global-vacaciones') !!}">Vista global Vacaciones</a>
        </li>
        <li class="breadcrumb-item active">Ver</li>
    </ol>
    <h5 class="col-12 titulo_general_funcion">Ver: Solicitud de Vacaciones</h5>
    <div class="mt-4 card">
        <div class="card-body">
                ...
                <div class="col-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12">
                            ...
                            <textarea class="form-control" name="comentarios_aprobador" id="comentarios_aprobador" rows="2" disabled>{{ old('comentarios_aprobador', $vacacion->comentarios_aprobador) }}</textarea>
                        </div>
                    </div>
