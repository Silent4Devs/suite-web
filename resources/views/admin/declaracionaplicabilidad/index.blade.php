...
@section('content')
    <div class="mt-5 card" id="d-aplicabilidad">
        ...
        <div class="p-0 m-0 ml-4 card-body">
            <h4 class="p-0 m-0">Instrucciones:
                <span class="text-muted" style="font-size: 16px">Por favor seleccione de los siguientes controles cuales
                    serán aplicables a su organización y justifique su selección</span>
            </h4>
        </div>
        <div class="row">
            <div class="col">
