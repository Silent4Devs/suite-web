            ...
            <form method="POST" action="{{ route('admin.gap-unos.update', [$gapUno->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pregunta') ? 'is-invalid' : '' }}" type="text"
                        name="pregunta" id="pregunta" value="{{ old('pregunta', $gapUno->pregunta) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('valoracion') ? 'is-invalid' : '' }}" name="valoracion"
                        ...
                        @foreach (App\Models\GapUno::VALORACION_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('valoracion', $gapUno->valoracion) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('evidencia') ? 'is-invalid' : '' }}" type="text"
                        name="evidencia" id="evidencia" value="{{ old('evidencia', $gapUno->evidencia) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('recomendacion') ? 'is-invalid' : '' }}" type="text"
                        name="recomendacion" id="recomendacion" value="{{ old('recomendacion', $gapUno->recomendacion) }}">
