...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <form method="POST" class="row" action="{{ route('admin.auditoria-anuals.update', [$auditoriaAnual->id]) }}"
                ...
                <div class="form-group col-sm-12 col-md-6 col-lg-6">
                    ...
                    <input
                        class="form-control {{ $errors->has('fechafin', $auditoriaAnual->fechafin) ? 'is-invalid' : '' }}"
                        type="date" name="fechafin" id="fechafin" min="1945-01-01"
                ...
                <div class="form-group col-md-12 col-sm-12  mt-3">
                    ...
                    <textarea class="form-control {{ $errors->has('objetivo') ? 'is-invalid' : '' }}" name="objetivo" id="objetivo"
                        required>{{ old('objetivo', $auditoriaAnual->objetivo) }}</textarea>
                ...
                <div class="form-group col-md-12 col-sm-12  mt-3">
                    ...
                    <textarea class="form-control {{ $errors->has('alcance') ? 'is-invalid' : '' }}" name="alcance" id="alcance"
                        required>{{ old('alcance', $auditoriaAnual->alcance) }}</textarea>
                ...
                <div class="text-right form-group col-12">
                    <a href="{{ route('admin.auditoria-anuals.index') }}" class="btn btn-outline-primary">Cancelar</a>
