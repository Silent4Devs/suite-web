...
@section('scripts')
<script>
    const canAgregar = @can('planes_de_accion_agregar') true @else false @endcan;
    const canEditar = @can('planes_de_accion_editar') true @else false @endcan;
    const canVisualizar = @can('planes_de_accion_visualizar_diagrama') true @else false @endcan;
    const canEliminar = @can('planes_de_accion_eliminar') true @else false @endcan;
</script>
<script>
