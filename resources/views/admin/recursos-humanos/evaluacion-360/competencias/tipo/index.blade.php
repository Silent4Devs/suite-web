...
@section('content')
    ...
    <h5 class="col-12 titulo_general_funcion">Tipo - Competencia</h5>
    <div class="mt-5 card">
        <div class="card-body datatable-fix">
            <table id="dom" class="table table-bordered w-100 datatable-tipos" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('admin.Tipo.destroy', $tipo->id) }}" method="POST">
                                <a href="{{ route('admin.tipo.edit',$tipo->id )}}"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('admin.Tipo.show',$tipo->id )}}"><i class="fas fa-eye"></i></a>
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.ev360-competencias.create') }}">
