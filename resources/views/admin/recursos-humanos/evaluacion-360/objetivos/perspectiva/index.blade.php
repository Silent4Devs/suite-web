...
@section('content')
    ...
    <h5 class="col-12 titulo_general_funcion">Objetivos - Perspectivas</h5>
    <div class="mt-5 card">
        <div class="card-body datatable-fix">
            <table id="dom" class="table table-bordered w-100 datatable-perspectiva" style="width: 100%">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th style="min-width:150px;">Perspectiva</th>
                        <th style="min-width:100px;">Imagén</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$perspectiva->id}}</td>
                        <td>{{$perspectiva->nombre}}</td>
                        <td>{{$perspectiva->imagen}}</td>
                        <td>
                            <form action="{{ route('admin.Perspectiva.destroy', $perspectiva->id) }}" method="POST">
                                <a href="{{ route('admin.perspectivas.edit',$perspectiva->id )}}"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('admin.Perspectiva.show',$perspectiva->id )}}"><i class="fas fa-eye"></i></a>
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('admin.ev360-objetivos.index') }}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            let btnAgregar = {
                ...
                url: "{{ route('admin.Perspectiva.create') }}",
