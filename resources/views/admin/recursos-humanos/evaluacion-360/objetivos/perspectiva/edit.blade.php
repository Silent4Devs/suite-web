            ...
            <form method="POST" action="{{ route('admin.Perspectiva.update', $perspectiva) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text"
                        name="nombre" id="nombre" value="{{ old('nombre', $perspectiva->nombre) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('imagen') ? 'is-invalid' : '' }}" type="text"
                        name="imagen" id="imagen" value="{{ old('imagen', $perspectiva->imagen) }}" required>
