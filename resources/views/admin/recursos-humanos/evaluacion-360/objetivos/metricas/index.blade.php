...
@section('content')
    ...
    <h5 class="col-12 titulo_general_funcion">Objetivos - Métricas</h5>
    <div class="mt-5 card">
        <div class="card-body datatable-fix">
            <table id="dom" class="table table-bordered w-100 datatable-metricas" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$metrica->id}}</td>
                        <td>{{$metrica->definicion}}</td>
                        <td>
                            <form action="{{ route('admin.Metrica.destroy', $metrica->id) }}" method="POST">
                                <a href="{{ route('admin.metrica.edit',$metrica->id )}}"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('admin.Metrica.show',$metrica->id )}}"><i class="fas fa-eye"></i></a>
                                    @csrf
                                    @method('DELETE')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            let btnAgregar = {
                ...
                url: "{{ route('admin.Metrica.create') }}",
