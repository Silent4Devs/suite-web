    ...
    <div>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <div class="tab-objetivos tab-option" id="objetive-tab" data-toggle="tab" data-target="#objetive" type="button" role="tab" aria-controls="objetive" aria-selected="true">
                    <div class="d-flex align-items-center" style="height: 200px; color: #f8f9fa;">
                        <i class="icon-tab fa-solid fa-bullseye" style="font-size: 28px; margin-right:5px;"></i>
                        <h5 class="m-0">EVALUA TUS OBJETIVOS</h5>
                    </div>
                </div>
            </li>
            <li class="nav-item" role="presentation">
                <div class="tab-competencia tab-option" id="competencies-tab" data-toggle="tab" data-target="#competencies" type="button" role="tab" aria-controls="competencies" aria-selected="false">
                    <div class="d-flex align-items-center" style="height: 200px; color: #f8f9fa;">
                        <i class="icon-tab material-symbols-outlined" style="font-size: 32px;">
                            star
                        </i>
          ...
          <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="objetive" role="tabpanel" aria-labelledby="objetive-tab">
                <div class="card">
                    <div class="card-body">
