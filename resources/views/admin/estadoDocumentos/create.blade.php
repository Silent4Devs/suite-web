    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.estado-documentos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="estado"><i class="fas fa-file-alt iconos-crear"></i>{{ trans('cruds.estadoDocumento.fields.estado') }}</label>
            ...
            <div class="form-group">
                <label for="descripcion"><i class="fas fa-file-signature iconos-crear"></i>{{ trans('cruds.estadoDocumento.fields.descripcion') }}</label>
