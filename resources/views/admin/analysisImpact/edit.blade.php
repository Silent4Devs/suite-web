...
@section('content')
    ...
    <div class="mt-4 card">
        <div class="card-body">
            <form action="{{ route('admin.analisis-impacto.update', $cuestionario->id) }}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mt-3">
                        <label for="titular_puesto" class="required">Puesto</label>
                        @error('titular_puesto')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="titular_puesto" id="titular_puesto" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('titular_puesto', $cuestionario->titular_puesto) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="titular_correo" class="required">Correo electrónico:</label>
                        @error('titular_correo')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="titular_correo" id="titular_correo" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('titular_correo', $cuestionario->titular_correo) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="titular_extencion">Extensión</label>
                        @error('titular_extencion')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="titular_extencion" id="titular_extencion" class="form-control extencion"
                            maxlength="4" min="0" max="9999" placeholder="0"
                            value="{{ old('titular_extencion', $cuestionario->titular_extencion) }}">
                    </div>
                    ...
                    <div class="input-group col-12">
                        ...
                        <input type="text" name="suplente_nombre" class="form-control" placeholder="Nombre(s)" required
                            value="{{ old('suplente_nombre', $cuestionario->suplente_nombre) }}">
                        <input type="text" name="suplente_a_paterno" class="form-control" placeholder="A. Paterno"
                            required value="{{ old('suplente_a_paterno', $cuestionario->suplente_a_paterno) }}">
                        <input type="text" name="suplente_a_materno" class="form-control" placeholder="A. Materno"
                            required value="{{ old('suplente_a_materno', $cuestionario->suplente_a_materno) }}">
                    ...
                    <div class="form-group col-sm-12 mt-3">
                        <label for="suplente_puesto" class="required">Puesto</label>
                        @error('suplente_puesto')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="suplente_puesto" id="suplente_puesto" class="form-control"
                            maxlength="255" placeholder="0" required
                            value="{{ old('suplente_puesto', $cuestionario->suplente_puesto) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="suplente_correo" class="required">Correo electrónico:</label>
                        @error('suplente_correo')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="suplente_correo" id="suplente_correo" class="form-control"
                            maxlength="255" placeholder="0" required
                            value="{{ old('suplente_correo', $cuestionario->suplente_correo) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="suplente_extencion">Extensión</label>
                        <input type="number" name="suplente_extencion" id="suplente_extencion"
                            class="form-control extencion1" maxlength="4" min="0" max="9999"
                            placeholder="0" value="{{ old('suplente_extencion', $cuestionario->suplente_extencion) }}">
                    </div>
                    ...
                    <div class="input-group col-12">
                        ...
                        <input type="text" name="supervisor_nombre" class="form-control" placeholder="Nombre(s)"
                            required value="{{ old('supervisor_nombre', $cuestionario->supervisor_nombre) }}">
                        <input type="text" name="supervisor_a_paterno" class="form-control" placeholder="A. Paterno"
                            required value="{{ old('supervisor_a_paterno', $cuestionario->supervisor_a_paterno) }}">
                        <input type="text" name="supervisor_a_materno" class="form-control" placeholder="A. Materno"
                            required value="{{ old('supervisor_a_materno', $cuestionario->supervisor_a_materno) }}">
                    ...
                    <div class="form-group col-sm-12 mt-3">
                        <label for="supervisor_puesto" class="required">Puesto</label>
                        @error('supervisor_puesto')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="supervisor_puesto" id="supervisor_puesto" class="form-control"
                            maxlength="255" placeholder="0" required
                            value="{{ old('supervisor_puesto', $cuestionario->supervisor_puesto) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="supervisor_correo" class="required">Correo electrónico:</label>
                        @error('supervisor_correo')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="supervisor_correo" id="supervisor_correo" class="form-control"
                            maxlength="255" placeholder="0" required
                            value="{{ old('supervisor_correo', $cuestionario->supervisor_correo) }}">
                    </div>

                    <div class="form-group col-sm-6">
                        <label for="supervisor_extencion">Extensión</label>
                        <input type="number" name="supervisor_extencion" id="supervisor_extencion"
                            class="form-control extencion2" maxlength="4" placeholder="0" min="0"
                            max="9999"
                            value="{{ old('supervisor_extencion', $cuestionario->supervisor_extencion) }}">
                    </div>
                ...
                <div class="row" x-data="{ periodicidad_flujo: false }">
                    <div class="form-group col-sm-12">
                        <label for="flujo_q_1" class="required">1. ¿Qué información se requiere para iniciar el proceso?
                            (Documentos, Correo electrónico, Oficios, Reportes, etc.)</label>
                        @error('flujo_q_1')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_1" id="flujo_q_1" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_1', $cuestionario->flujo_q_1) }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="flujo_q_2" class="required">2. ¿De dónde proviene la información? (Nombre de la
                            Empresa / Nombre del Área / Nombre del Proceso / Nombre del Sistema)</label>
                        @error('flujo_q_2')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_2" id="flujo_q_2" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_2', $cuestionario->flujo_q_2) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="flujo_q_4" class="required">4. ¿De qué manera recibe usted la información? (Entrega
                            Física / Correo Electrónico / Consulta en Aplicativo o Base de Datos / Consulta en Portal
                            Web)</label>
                        @error('flujo_q_4')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_4" id="flujo_q_4" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_4', $cuestionario->flujo_q_4) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="flujo_q_6" class="required">6. ¿Qué información obtiene al finalizar el proceso?
                            (Documentos, Correo electrónico, Oficios, Reportes, etc.)</label>
                        @error('flujo_q_6')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_6" id="flujo_q_6" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_6', $cuestionario->flujo_q_6) }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="flujo_q_7" class="required">7. ¿Este es un proceso final o genera información para
                            iniciar otro proceso?</label>
                        @error('flujo_q_7')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_7" id="flujo_q_7" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_7', $cuestionario->flujo_q_7) }}">
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="flujo_q_8" class="required">8. ¿A dónde envía la información generada en el proceso?
                            (Nombre de la Empresa / Nombre del Área / Nombre del Proceso / Nombre del Sistema)</label>
                        @error('flujo_q_8')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_8" id="flujo_q_8" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_8', $cuestionario->flujo_q_8) }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="flujo_q_10" class="required">10. ¿Cómo valida que el proceso se realizó correctamente?
                            (Carta o firma de aceptación, Acuse de Recibido, Notificación, etc.)</label>
                        @error('flujo_q_10')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="flujo_q_10" id="flujo_q_10" class="form-control" maxlength="255"
                            placeholder="0" required value="{{ old('flujo_q_10', $cuestionario->flujo_q_10) }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="tipo_conteo" class="required">11. ¿Cuánto tiempo requiere para realizar el proceso de
                            inicio a fin?</label>
                    </div>

                    @foreach (['años' => 50, 'meses' => 12, 'semanas' => 52, 'días' => 365] as $unit => $max)
                        <div class="form-group col-sm-2">
                            <label for="flujo_{{ $unit }}">{{ ucfirst($unit) }}(s)</label>
                            @error("flujo_{$unit}")
                                <small style="color: red">{{ $message }}</small>
                            @enderror
                            <input type="number" name="flujo_{{ $unit }}" id="flujo_{{ $unit }}"
                                class="form-control" placeholder="0" min="0" max="{{ $max }}" required
                                value="{{ old("flujo_{$unit}", $cuestionario->{"flujo_{$unit}"}) }}">
                        </div>
                    @endforeach

                    <div class="form-group col-sm-4">
                        <label for="flujo_otro_txt">Otro</label>
                        <input type="text" name="flujo_otro_txt" id="flujo_otro_txt" class="form-control"
                            placeholder="Defina.." value="{{ old('flujo_otro_txt', $cuestionario->flujo_otro_txt) }}">
                    </div>
                            ...
                            <TR style="color: rgb(0, 0, 0); text-align:center; height:65px; font-size:15px;"
                                ...
                                <TH>
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input check_calendario" type="checkbox"
                                            id="primer_semestre" name="primer_semestre" value="2"
                                ...
                                <TH>
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="segundo_semestre" name="segundo_semestre"
                                            value="2"
                            ...
                            <TR class="mt-5" style="color: rgb(0, 0, 0); text-align:center; height:65px;">
                                <TH style="position: relative;">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="ene" id="eneCheckbox"
                                            {{ old('ene', $cuestionario->ene) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="feb" id="febCheckbox"
                                            {{ old('feb', $cuestionario->feb) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="mar" id="marCheckbox"
                                            {{ old('mar', $cuestionario->mar) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="abr" id="abrCheckbox"
                                            {{ old('abr', $cuestionario->abr) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="may" id="mayCheckbox"
                                            {{ old('may', $cuestionario->may) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                ...
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="jul" id="julCheckbox"
                                            {{ old('jul', $cuestionario->jul) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="ago" id="agoCheckbox"
                                            {{ old('ago', $cuestionario->ago) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="sep" id="sepCheckbox"
                                            {{ old('sep', $cuestionario->sep) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="oct" id="octCheckbox"
                                            {{ old('oct', $cuestionario->oct) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="nov" id="novCheckbox"
                                            {{ old('nov', $cuestionario->nov) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                                <TH>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="dic" id="dicCheckbox"
                                            {{ old('dic', $cuestionario->dic) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TH>
                            </TR>
                        </table>
                            ...
                            <TR style="color: rgb(0, 0, 0); text-align:center; height:65px;">
                                <TD>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="s1" id="s1Checkbox"
                                            {{ old('s1', $cuestionario->s1) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TD>
                                <TD>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="s2" id="s2Checkbox"
                                            {{ old('s2', $cuestionario->s2) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TD>
                                <TD>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="s3" id="s3Checkbox"
                                            {{ old('s3', $cuestionario->s3) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TD>
                                <TD>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input d-none" type="checkbox" value="2"
                                            name="s4" id="s4Checkbox"
                                            {{ old('s4', $cuestionario->s4) == 2 ? 'checked' : '' }}>
                                    </div>
                                </TD>
                            </TR>
                        </table>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        <label for="respaldo_q_20" class="required">
                            19. Tiempos de Respaldo (RPO), Recuperación (RTO), Trabajo en Contingencia (WRT) y Máximo Tiempo
                            de Interrupción del Proceso (MTPD)
                        </label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <label for="rpo_mes">Mes(es)</label>
                        @error('rpo_mes')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rpo_mes" id="rpo_mes" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('rpo_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rpo_semana">Semana(s)</label>
                        @error('rpo_semana')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rpo_semana" id="rpo_semana" class="form-control form-control-sm"
                            placeholder="0" min="0" max="52" value="{{ old('rpo_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rpo_dia">Día(s)</label>
                        @error('rpo_dia')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rpo_dia" id="rpo_dia" class="form-control form-control-sm"
                            placeholder="0" min="0" max="365" value="{{ old('rpo_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rpo_hora">Horas(s)</label>
                        @error('rpo_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rpo_hora" id="rpo_hora" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('rpo_hora') }}">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <label for="rto_mes">Mes(es)</label>
                        @error('rto_mes')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rto_mes" id="rto_mes" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('rto_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rto_semana">Semana(s)</label>
                        @error('rto_semana')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rto_semana" id="rto_semana" class="form-control form-control-sm"
                            placeholder="0" min="0" max="52" value="{{ old('rto_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rto_dia">Día(s)</label>
                        @error('rto_dia')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rto_dia" id="rto_dia" class="form-control form-control-sm"
                            placeholder="0" min="0" max="365" value="{{ old('rto_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="rto_hora">Horas(s)</label>
                        @error('rto_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="rto_hora" id="rto_hora" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('rto_hora') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <label for="wrt_mes">Mes(es)</label>
                        @error('wrt_mes')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="wrt_mes" id="wrt_mes" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('wrt_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="wrt_semana">Semana(s)</label>
                        @error('wrt_semana')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="wrt_semana" id="wrt_semana" class="form-control form-control-sm"
                            placeholder="0" min="0" max="52" value="{{ old('wrt_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="wrt_dia">Día(s)</label>
                        @error('wrt_dia')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="wrt_dia" id="wrt_dia" class="form-control form-control-sm"
                            placeholder="0" min="0" max="365" value="{{ old('wrt_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="wrt_hora">Horas(s)</label>
                        @error('wrt_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="wrt_hora" id="wrt_hora" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('wrt_hora') }}">
                    </div>
                </div>
                <hr>
                {{-- WRT: --}}
                <div class="row">
                    ...
                    <div class="form-group col-sm-2">
                        <label for="mtpd_mes">Mes(es)</label>
                        @error('mtpd_mes')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="mtpd_mes" id="mtpd_mes" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('mtpd_mes') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="mtpd_semana">Semana(s)</label>
                        @error('mtpd_semana')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="mtpd_semana" id="mtpd_semana"
                            class="form-control form-control-sm" placeholder="0" min="0" max="52"
                            value="{{ old('mtpd_semana') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="mtpd_dia">Día(s)</label>
                        @error('mtpd_dia')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="mtpd_dia" id="mtpd_dia" class="form-control form-control-sm"
                            placeholder="0" min="0" max="365" value="{{ old('mtpd_dia') }}">
                    </div>
                    <div class="form-group col-sm-2">
                        <label for="mtpd_hora">Horas(s)</label>
                        @error('mtpd_hora')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="number" name="mtpd_hora" id="mtpd_hora" class="form-control form-control-sm"
                            placeholder="0" min="0" max="120" value="{{ old('mtpd_hora') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_20" class="required">20. ¿Cuáles son los archivos o registros vitales
                            para el proceso? (Formatos, Registros, Directorios, Reportes, etc.)</label>
                        @error('respaldo_q_20')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_20" id="respaldo_q_20" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('respaldo_q_20') }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_21" class="required">21. ¿Tiene un respaldo fuera de su equipo de los
                            archivos necesarios para ejecutar este proceso? (Registros vitales)</label>
                        @error('respaldo_q_21')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_21" id="respaldo_q_21" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('respaldo_q_21') }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_22" class="required">22. ¿Alguien más tiene acceso a este
                            respaldo?</label>
                        @error('respaldo_q_22')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_22" id="respaldo_q_22" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('respaldo_q_22') }}">
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="respaldo_q_23" class="required">23. ¿De qué manera tiene resguardados los usuarios y
                            contraseñas que utiliza para el acceso a los sistemas necesarios en este proceso?</label>
                        @error('respaldo_q_23')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="respaldo_q_23" id="respaldo_q_23" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('respaldo_q_23') }}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <a id="btnAgregarTipo" onclick="event.preventDefault();"
                            ...
                            data-target="#probabilidad_incidentes_disruptivos" data-whatever="@mdo"
                            data-whatever="@mdo" title="Dar click"><i class="fas fa-info-circle"></i></a>
                        </a>
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        <label class="required">25. Por favor, indique el nivel de impacto en los que el proceso se ha
                            visto
                            involucrado.</label>
                    </div>
                    ...
                    <label class="col-sm-6 col-form-label">
                        <a id="btnAgregarTipo" onclick="event.preventDefault();"
                            style="font-size:12pt; float: right;"data-toggle="modal"
                            data-target="#afectacion_operacional" data-whatever="@mdo" data-whatever="@mdo"
                    ...
                    <label class="col-sm-6 col-form-label">
                        <a id="btnAgregarTipo" onclick="event.preventDefault();"
                            style="font-size:12pt; float: right;"data-toggle="modal"
                            data-target="#afectacion_reputacion" data-whatever="@mdo" data-whatever="@mdo"
                            title="Dar click"><i class="fas fa-info-circle"></i></a>
                    ...
                    <div class="form-group col-sm-12">
                        <label for="incidentes_q_26" class="required">26. En caso de que el proceso se interrumpiera,
                            indique cuáles serían las acciones que tomaría.</label>
                        @error('incidentes_q_26')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="incidentes_q_26" id="incidentes_q_26" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('incidentes_q_26') }}" required>
                    </div>

                    <div class="form-group col-sm-12">
                        <label for="incidentes_q_27" class="required">27. ¿Se han realizado ejercicios o pruebas
                            relacionadas a un Plan de Continuidad de las Operaciones (BCP)?</label>
                        @error('incidentes_q_27')
                            <small style="color: red">{{ $message }}</small>
                        @enderror
                        <input type="text" name="incidentes_q_27" id="incidentes_q_27" class="form-control"
                            maxlength="255" placeholder="0" value="{{ old('incidentes_q_27') }}" required>
                    </div>
                ...
                <div class="row">
                    ...
                    <table class="table table-border" style="font-size: 12px">
                        <tr>
                            <th class="col-sm-4" style="background-color:var(--color-tbj); color: white;">Clasificación
                            </th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row" style="height:30px; border-bottom: 1px solid #ccc;">
                                    ...
                                    <div class="col-9">
                                        <span style="justify-content;">Falta a los procedimientos operativos
                                            internos</span>
                                    </div>
                                </div>
                                <div class="row" style="height:30px; border-bottom: 1px solid #ccc;">
                                    ...
                                    <div class="col-9">
                                        <span style="justify-content;">Sin afectación regulatoria o normativa.</span>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="afectacion_reputacion" tabindex="afectacion_reputacion"
                    aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row" style="height:30px; border-bottom: 1px solid #ccc;">
                                    ...
                                    <div class="col-9">
                                        <span style="justify-content;">Cobertura mediática local o del sector,
                                            reclamaciones
                                ...
                                <div class="row" style="height:30px; border-bottom: 1px solid #ccc;">
                                    ...
                                    <div class="col-9">
                                        <span style="justify-content;">Sin cobertura mediática o efecto externo.</span>
                                    </div>
                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row" style="height:30px; border-bottom: 1px solid #ccc;">
                                    ...
                                    <div class="col-9">
                                        <span style="justify-content;">Sin afectación a la población/clientes.</span>
                                    </div>
                                </div>
