    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.recursos.update", [$recurso->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cursoscapacitaciones') ? 'is-invalid' : '' }}" name="cursoscapacitaciones" id="cursoscapacitaciones">{{ old('cursoscapacitaciones', $recurso->cursoscapacitaciones) }}</textarea>
