    ...
    <div class="card-body">
        <form method="POST" class="row" action="{{ route("admin.matriz-requisito-legales.update", [$matrizRequisitoLegale->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-sm-4">
                ...
                <input class="form-control date {{ $errors->has('fechaexpedicion') ? 'is-invalid' : '' }}" type="date" name="fechaexpedicion" id="fechaexpedicion" value="{{ old('fechaexpedicion', $matrizRequisitoLegale->fechaexpedicion) }}">
            ...
            <div class="form-group col-sm-4">
                ...
                <input class="form-control date {{ $errors->has('fechavigor') ? 'is-invalid' : '' }}" type="date" name="fechavigor" id="fechavigor" value="{{ old('fechavigor', $matrizRequisitoLegale->fechavigor) }}">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control date {{ $errors->has('fechaverificacion') ? 'is-invalid' : '' }}" type="date" name="fechaverificacion" id="fechaverificacion" value="{{ old('fechaverificacion', $matrizRequisitoLegale->fechaverificacion) }}">
            ...
            <div class="form-group col-md-4">
                ...
                <select class="form-control {{ $errors->has('id_reviso') ? 'is-invalid' : '' }}" name="id_reviso" id="id_reviso">
