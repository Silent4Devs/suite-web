<div>
    <form method="POST" action="{{ route('admin.empleados.storeResumen', [$empleado->id]) }}" id="formResumen">
        <div class="row">
        ...
        <div class="row" x-show="open">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('estatus') ? 'is-invalid' : '' }}" type="text"
                    name="estatus" id="vencio_alta" value="{{ old('estatus', '') }}" readonly>
    ...
    <form method="POST" action="{{ route('admin.empleados.storeCursos', [$empleado->id]) }}" id="formCursos">
    ...
    <form method="POST" action="{{ route('admin.empleados.storeExperiencia', [$empleado->id]) }}"
    ...
    <form method="POST" action="{{ route('admin.empleados.storeEducacion', [$empleado->id]) }}" id="formEducacion"
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('institucion') ? 'is-invalid' : '' }}" type="text"
                    name="institucion" id="institucion" value="{{ old('institucion', '') }}">
        ...
        <div class="row">
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('año_inicio') ? 'is-invalid' : '' }}" type="date"
                    name="año_inicio" id="año_inicio" value="{{ old('año_inicio', '') }}">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('año_fin') ? 'is-invalid' : '' }}" type="date"
                    name="año_fin" id="año_fin" value="{{ old('año_fin', '') }}">
