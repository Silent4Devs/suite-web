<section id="contenido2" class="mt-4">
    <div>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('estatus') ? 'is-invalid' : '' }}" type="text"
                    name="vencio_alta" id="vencio_alta" value="{{ old('estatus', '') }}" readonly>
        ...
        <div class="mb-5 col-12">
            <button id="btn-suscribir-certificado" type="submit" class="mr-3 btn btn-sm btn-outline-success"
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <input class="form-control {{ $errors->has('curso_diplomado') ? 'is-invalid' : '' }}" type="text"
                    name="curso_diplomado" id="curso_diplomado" value="{{ old('curso_diplomado', '') }}">
            ...
            <div class="form-group col-sm-6">
                ...
                <select class="form-control {{ $errors->has('tipo') ? 'is-invalid' : '' }}" name="tipo"
                    ...
                    @foreach (App\Models\CursosDiplomasEmpleados::TipoSelect as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo', '') === (string) $key ? 'selected' : '' }}>
                            {{ $label }}
                        </option>
                    @endforeach
                </select>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                <input class="form-control {{ $errors->has('puesto') ? 'is-invalid' : '' }}" type="text"
                    name="puesto_trabajo" id="puesto_trabajo" value="{{ old('puesto', '') }}">
