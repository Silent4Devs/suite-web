...
@section('content')
    ...
    @can('riesgosoportunidade_create')
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered datatable-Riesgosoportunidade" style="width: 100%">
...
@section('scripts')
    ...
    <script>
        $(function() {
            let dtButtons = [{
                    extend: 'csvHtml5',
                    title: `Riesgos y Oportunidades ${new Date().toLocaleDateString().trim()}`,
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'aplicaorganizacion',
                        name: 'aplicaorganizacion'
                    },
                    {
                        data: 'justificacion',
                        name: 'justificacion'
