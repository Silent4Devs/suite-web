...
@section('content')
    ...
    <div class="card card-body mx-5 px-5">
        <h2 class="title-normas-iso">Normas</h2>
        <div class="d-flex flex-wrap justify-content-between mt-5" style="gap: 30px;">
            <div class="card card-norma" style="background-color: #FFF0C5;">
                ...
                <div class="card-body">
                    ...
                    <p>
                        La norma ISO 22301 define los requisitos que deben cumplir los sistemas de gestión de la continuidad
                        del negocio (SGCN) para asegurar que una organización pueda continuar operando durante y después de
            ...
            <div class="card card-norma" style="background-color: #FFD4DB;">
                ...
                <div class="card-body">
                    ...
                    <p>
                        La norma puede ayudar a las organizaciones a mejorar su eficiencia, reducir los costos y aumentar la
            ...
            <div class="card card-norma" style="background-color: #E1E7FF;">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Es un estándar internacional que establece los requisitos para un sistema de gestión de la seguridad
                        de la información (SGSI).
                    </p>
                    <p>
                        La ISO 27001 se basa en el enfoque de gestión de riesgos para la seguridad
                        de la información. Este enfoque implica la identificación, evaluación y mitigación de los riesgos de
            ...
            <div class="card card-norma" style="background-color: #BED6F9;">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Es un estándar internacional que establece los requisitos para un sistema de gestión de servicios de
                        TI. La ISO 20000 se basa en el enfoque de procesos para la gestión de servicios de TI.
                    </p>
                    <p>
                        Este enfoque implica la identificación, documentación, implementación y mejora de los procesos de
