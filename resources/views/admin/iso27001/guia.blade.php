    ...
    <div class="content-guia-iso">
        <div class="pl-3 py-2 row" style="background-color: #EFF1F5;">
            ...
            {{-- <div class="col-6" style="text-align: right;">
                <a href="{{ route('admin.dashboard_auditorias') }}" class="btn btn-primary">
                    ...
                    <div class="caja-cards-iso-guia mt-5">
                        ...
                        @if ($version_iso === true)
                            ...
                            @can('declaracion_de_aplicabilidad_acceder')
                                <div class="card-iso-guia">
                                    <div class="img-card-iso">
                                        <img src="{{ asset('img/iso/iso11.webp') }}" alt="">
                                    </div>
                                    <div class="info-iso">
...
@section('scripts')
    ...
    <script>
        document.addEventListener('change', function() {
            ...
            const valor = version.checked; // Obtén el valor booleano directamente
            ...
            $.ajax({
                ...
                dataType: "json", // Usa "json" en minúscula
