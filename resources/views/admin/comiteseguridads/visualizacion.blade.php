                ...
                <tbody>
                    @forelse($comiteseguridads as $comiteseguridad)
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('storage/empleados/imagenes/')}}/{{ $comiteseguridad->avatar}}"
                                    class="img_empleado"> {{ $comiteseguridad->asignacion ? $comiteseguridad->asignacion->name:'Sin registro' }}
                            </td>
