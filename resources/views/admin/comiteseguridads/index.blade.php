...
<div class="card mt-5">
    ...
    <div style="margin-bottom: 10px; margin-left:10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.comiteseguridads.create') }}">
...
@endcan
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Comiteseguridad">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'personaasignada_name', name: 'personaasignada.name' },
{ data: 'fechavigor', name: 'fechavigor' },
{ data: 'responsabilidades', name: 'responsabilidades' },
