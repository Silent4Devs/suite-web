...
<div class="mt-5 card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.procesos-octave.update', [$procesosOctave->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="col-12 row">
                ...
                <div class="form-group col-sm-12 col-md-4 col-lg-4">
                    <label for="fecha_registro"><i
                            class="fas fa-calendar-alt iconos-crear"></i>Fecha de registro</label>
                    <input class="form-control date" type="date" name="fecha_registro" id="fecha_registro"
                        value="{{ old('fecha_registro', \Carbon\Carbon::parse($procesosOctave->fecha_registro)->format('Y-m-d')) }}">
            ...
            <div class="col-12 row">
                <div class="form-group col-md-6 col-sm-12">
                    ...
                    <select class="procesoSelect mt-2 form-control" name="id_proceso" id="proceso_activo" value="{{ $procesosOctave->id_proceso }}">
                        <option value="" selected disabled>Seleccione una opción</option>
                        @foreach ($procesos as $proceso)
                            <option {{ $procesosOctave->id_proceso == $proceso->id ? 'selected' : '' }}
                ...
                <div class="form-group col-sm-4 col-md-3 col-lg-3">
                    ...
                    <div class="mt-2 form-control" id="valorCriticidadTxt" readonly></div>
                </div>
            </div>
            ...
            <div class="col-12 row">
                <div class="form-group col-md-6 col-sm-12">
                    ...
                    <select class="sedeSelect form-control" name="id_direccion" id="id_direccion" value="{{ $procesosOctave->id_direccion}}">
                        <option value="" selected disabled>Seleccione una opción</option>
                        @foreach ($areas as $area)
                            <option  {{ $procesosOctave->id_direccion == $area->id ? 'selected' : '' }}
            ...
            <div class="text-center form-group col-12" style="background-color:#345183; border-radius: 100px; color: white;">
                ...
                @livewire('octave.select-impactos',["operacionalId"=>$operacionalSeleccionado,"cumplimientoId"=>$cumplimientoSeleccionado,"legalId"=>$legalSeleccionado ,"reputacionalId"=>$reputacionalSeleccionado ,"tecnologicoId"=>$tecnologicoSeleccionado])
            ...
            <div class="col-12 row">
                ...
                <div  class="form-group col-sm-4 col-md-3 col-lg-3">
                    <label ><i class="fas fa-bullseye iconos-crear"></i>Valor de Activos</label>
        ...
        <div class="modal fade" id="legalec" tabindex="-1" aria-labelledby="legalecLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        ...
                        <div class="col-8">
                            <span style="justify-content;">Contratos de clientes y operación de licencias otorgados por entidades legales</span>
                        </div>
                    </div>
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        <div class="col-4" style="background-color:#ccc;">
        ...
        <div class="modal fade" id="reputacionallec" tabindex="-1" aria-labelledby="reputacionallecLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        ...
                        <div class="col-8">
                            <span style="justify-content;">Confianza del clientes, inversionistas y dueños de la organización</span>
                        </div>
                    </div>
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        <div class="col-4" style="background-color:#ccc;">
        ...
        <div class="modal fade" id="tecnologialec" tabindex="-1" aria-labelledby="tecnologialecLabel" aria-hidden="true">
            <div class="modal-dialog  modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        ...
                        <div class="col-8">
                            <span style="justify-content;">Fallas en la operación de los servicios tecnológicos y seguridad</span>
                        </div>
                    </div>
                    <div class="row" style="height:40px; border-bottom: 1px solid #ccc;">
                        <div class="col-4" style="background-color:#ccc;">
...
<script>
    ...
    let activosProceso= @json($activosProceso);
    console.log(activosProceso);
        calcularRiesgo(activosProceso)
    proceso.addEventListener('change', function(e){
        ...
        $.ajax({
            ...
            calcularRiesgo(response)
            }
        });
    })


    function calcularRiesgo(response){
