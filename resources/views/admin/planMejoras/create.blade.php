    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.plan-mejoras.store") }}" enctype="multipart/form-data" class="row">
            ...
            <div class="form-group col-12">
                <label for="mejora_id"><i class="fas fa-thumbs-up iconos-crear"></i>{{ trans('cruds.planMejora.fields.mejora') }}</label>
            ...
            <div class="form-group col-12">
                <label for="descripcion"><i class="far fa-file-alt iconos-crear"></i>{{ trans('cruds.planMejora.fields.descripcion') }}</label>
            ...
            <div class="form-group col-12">
                <label for="responsable_id"><i class="fas fa-user-tag iconos-crear"></i>{{ trans('cruds.planMejora.fields.responsable') }}</label>
            ...
            <div class="form-group col-md-6">
                <label for="fecha_compromiso"><i class="far fa-calendar-alt iconos-crear"></i>{{ trans('cruds.planMejora.fields.fecha_compromiso') }}</label>
