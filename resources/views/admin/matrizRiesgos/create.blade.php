        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.matriz-riesgos.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group" style="margin-top:15px; width:1000px; height:25px; background-color:#1BB0B0">
                    <p class"text-center text-light" style="font-size:11pt; margin-left:370px; color:#ffffff;">DATOS
                        GENERALES</p>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <input class="form-control {{ $errors->has('proceso') ? 'is-invalid' : '' }}" type="text"
                            name="proceso" id="proceso" value="{{ old('proceso', '') }}">
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        ...
                        <select class="form-control select2 {{ $errors->has('tipoactivo') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($tipoactivos as $tipos)
                                <option value="{{ $tipos->id }}"
                                    {{ old('tipoactivo_id') == $tipos->id ? 'selected' : '' }}>{{ $tipos->tipo }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    <label for="responsableproceso"><i
                            class="fas fa-user-alt iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.responsableproceso') }}</label>
                    <input class="form-control {{ $errors->has('responsableproceso') ? 'is-invalid' : '' }}" type="text"
                        name="responsableproceso" id="responsableproceso" value="{{ old('responsableproceso', '') }}">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="amenaza"><i
                                class="fas fa-radiation iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.amenaza') }}</label>
                    ...
                    <div class="form-group col-sm-6">
                        <label for="vulnerabilidad"><i
                                class="fas fa-shield-alt iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.vulnerabilidad') }}</label>
                        <input class="form-control {{ $errors->has('vulnerabilidad') ? 'is-invalid' : '' }}" type="text"
                            name="vulnerabilidad" id="vulnerabilidad" value="{{ old('vulnerabilidad', '') }}">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="descripcionriesgo"><i
                                class="fas fa-clipboard-list iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.descripcionriesgo') }}</label>
                        <input class="form-control {{ $errors->has('descripcionriesgo') ? 'is-invalid' : '' }}"
                            type="text" name="descripcionriesgo" id="descripcionriesgo"
                            value="{{ old('descripcionriesgo', '') }}">
                    ...
                    <div class="form-group col-sm-6">
                        <label><i
                                class="fas fa-exclamation-triangle iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.tipo_riesgo') }}</label>
                        <select class="form-control {{ $errors->has('tipo_riesgo') ? 'is-invalid' : '' }}"
                            ...
                            @foreach (App\Models\MatrizRiesgo::TIPO_RIESGO_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('tipo_riesgo', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group" style="margin-top:15px; width:1000px; height:25px; background-color:#1BB0B0">
                    <p class"text-center text-light" style="font-size:11pt; margin-left:370px; color:#ffffff;">IMPACTO EN LA
                        TRIADA CID</p>
                </div>

                <div class="form-group">
                    <p class="font-weight-bold" style="font-size:11pt;">Indique en que aspecto de la triada de seguridad
                        impacta el riesgo:</p>
                </div>

                <div class="row">
                    <div class="form-group col-sm-4 ">
                        <label for="confidencialidad"><i
                                class="fas fa-lock iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.confidencialidad') }}</label>
                    ...
                    <div class="form-group col-sm-4">
                        <label for="integridad"><i
                                class="fas fa-puzzle-piece iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.integridad') }}</label>
                    ...
                    <div class="form-group col-sm-4">
                        <label for="disponibilidad"><i
                                class="fas fa-eye iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.disponibilidad') }}</label>
                        <select class="form-control" class="validate" required="" aria-required="true"
                            name="disponibilidad">
                            <option value="" disabled selected>Escoga una opción</option>
                            <option value="Si">Si</option>
                ...
                <div class="form-group" style="margin-top:15px; width:1000px; height:25px; background-color:#1BB0B0">
                    <p class"text-center text-light" style="font-size:11pt; margin-left:370px; color:#ffffff;">EVALUACIÓN DE
                        RIESGO INICIAL</p>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label><i
                                class="fas fa-dice iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.probabilidad') }}</label>
                    ...
                    <div class="form-group col-sm-6">
                        <label><i
                                class="fas fa-bullseye iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.impacto') }}</label>
                        <select class="form-control {{ $errors->has('impacto') ? 'is-invalid' : '' }}" name="impacto"
                            ...
                            @foreach (App\Models\MatrizRiesgo::IMPACTO_SELECT as $key => $label)
                                <option value="{{ $key }}"
                                    {{ old('impacto', '') === (string) $key ? 'selected' : '' }}>{{ $label }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="nivelriesgo"><i
                                class="fas fa-chart-bar iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.nivelriesgo') }}</label>
                        <input class="form-control {{ $errors->has('nivelriesgo') ? 'is-invalid' : '' }}" type="number"
                            name="nivelriesgo" id="nivelriesgo" value="{{ old('nivelriesgo', '') }}" step="0.01">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="riesgototal"><i
                                class="fas fa-times-circle iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.riesgototal') }}</label>
                        <input class="form-control {{ $errors->has('riesgototal') ? 'is-invalid' : '' }}" type="number"
                            name="riesgototal" id="riesgototal" value="{{ old('riesgototal', '') }}" step="0.01">
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        <label for="riesgoresidual"><i
                                class="fas fa-tachometer-alt iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.riesgoresidual') }}</label>
                        <input class="form-control {{ $errors->has('riesgoresidual') ? 'is-invalid' : '' }}"
                            type="number" name="riesgoresidual" id="riesgoresidual"
                            value="{{ old('riesgoresidual', '') }}" step="0.01">
                    ...
                    <div class="form-group col-sm-6">
                        <label for="controles_id"><i
                                class="fas fa-broadcast-tower iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.controles') }}</label>
                        <select class="form-control select2 {{ $errors->has('controles') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($controles as $id => $controles)
                                <option value="{{ $id }}" {{ old('controles_id') == $id ? 'selected' : '' }}>
                                    {{ $controles }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    <label for="justificacion"> <i
                            class="fas fa-file-alt iconos-crear"></i>{{ trans('cruds.matrizRiesgo.fields.justificacion') }}</label>
