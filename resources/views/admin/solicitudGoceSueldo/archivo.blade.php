...
@section('content')
    <div class="mt-3">
        {{ Breadcrumbs::render('Archivo-Permisos-Goce') }}
    </div>
    ...
    <h5 class="col-12 titulo_general_funcion">Archivo aprobación de Permisos con Goce de Sueldo</h5>
    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.solicitud-permiso-goce-sueldo.archivo') }}",
                columns: [{
                        data: 'empleado',
                        name: 'empleado',
            ...
            let table = $('.datatable-archivo-permisos').DataTable(dtOverrideGlobals);
            ...
            `;
                imprimirTabla('datatable-archivo-permisos', titulo_tabla);
            });
