            ...
            <form method="POST" action="{{ route('admin.subtipoactivos.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 col-md-6 col-lg-6">
                        ...
                        <select class="form-control  {{ $errors->has('tipo') ? 'is-invalid' : '' }}" name="categoria_id"
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <label class="required" for="tipo"><i
                                class="fas fa-layer-group iconos-crear"></i>Subcategoría</label>
                        <input class="form-control {{ $errors->has('subcategoria') ? 'is-invalid' : '' }}" type="text"
                            name="subcategoria" id="subcategoria" value="{{ old('subcategoria', '') }}" required>
