...
@section('content')
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        @can('revision_por_direccion_ver')
                                            <li><a href="#" class="btn btn-sm" title="Visualizar" data-toggle="modal"
                                                    data-target="#exampleModal">
                                                    <i class="fa fa-eye"></i></a>&nbsp;Ver
                                            </li>
                                        @endcan
    ...
    <div class="row d-flex align-items-center justify-content-center">
        <!-- Modal -->
        <div class="modal modal2 fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
        ...
        @foreach ($query as $q)
            <div class="modal fade" id="participantsModal{{ $q->id }}" tabindex="-1"
                ...
                <button type="button" style="position: relative; top: 7rem; right: 15rem;" class="close"
