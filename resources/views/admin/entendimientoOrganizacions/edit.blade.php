...
@section('content')
    ...
    {{-- <h5 class="col-12 titulo_general_funcion">Editar: FODA</h5> --}}
    {{-- <div class="mt-4 card">
        <div class="card-body"> --}}
    <h5 class="titulo_general_funcion">Análisis FODA</h5>
    <div class="card" style="background:#5397D5; border-radius: 8px; opacity: 1;">
        <div class="card-body row" style="padding-bottom:11px; padding-top:18px;">
            ...
            <div class="col-xs-12 col-sm-8 col-md-10 col-lg-10 text-light mb-0">
                ...
                <p>El análisis FODA es una herramienta simple y, a la vez, potente que te ayuda a identificar las
                    oportunidades
                    competitivas de mejora. Te permite trabajar para mejorar el negocio y el equipo mientras te mantienes a
                    la cabeza de
                    las tendencias del mercado.</p>
            </div>
        </div>
    </div>
    <form method="POST" action="{{ route('admin.entendimiento-organizacions.update', $entendimientoOrganizacion) }}">
        @csrf
        @method('PATCH')
