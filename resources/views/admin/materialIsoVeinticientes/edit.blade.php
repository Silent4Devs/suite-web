    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <form method="POST" class="row"
                action="{{ route('admin.material-iso-veinticientes.update', [$materialIsoVeinticiente->id]) }}"
                ...
                <div class="form-group col-12">
                    ...
                    <input class="form-control {{ $errors->has('objetivo') ? 'is-invalid' : '' }}" type="text"
                        name="objetivo" id="objetivo" value="{{ old('objetivo', $materialIsoVeinticiente->objetivo) }}"
                        required>
                ...
                <div class="form-group col-12">
                    ...
                    <select class="form-control select2 {{ $errors->has('arearesponsable') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($arearesponsables as $id => $arearesponsable)
                            <option value="{{ $id }}"
                                {{ (old('arearesponsable_id') ? old('arearesponsable_id') : $materialIsoVeinticiente->arearesponsable->id ?? '') == $id ? 'selected' : '' }}>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control {{ $errors->has('tipoimparticion') ? 'is-invalid' : '' }}"
                        ...
                        @foreach (App\Models\MaterialIsoVeinticiente::TIPOIMPARTICION_SELECT as $key => $label)
                            <option value="{{ $key }}"
                                {{ old('tipoimparticion', $materialIsoVeinticiente->tipoimparticion) === (string) $key ? 'selected' : '' }}>
                                {{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input class="form-control date {{ $errors->has('fechacreacion_actualizacion') ? 'is-invalid' : '' }}"
                        ...
                        value="{{ old('fechacreacion_actualizacion', $materialIsoVeinticiente->fechacreacion_actualizacion) }}">
