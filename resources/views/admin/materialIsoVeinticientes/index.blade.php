...
@section('content')
    ...
    @can('material_iso_veinticiente_create')
        ...
        <div class="card-body datatable-fix">
            <table class="table table-bordered w-100 datatable-MaterialIsoVeinticiente">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th>
                            Personal&nbsp;Objetivo&nbsp;(Lista&nbsp;de&nbsp;asistencia)
                        </th>
                        <th>
                            Área&nbsp;Responsable
                        </th>
...
@section('scripts')
    ...
    <script>
        $(function() {
            let dtButtons = [{
                    extend: 'csvHtml5',
                    title: `Material ISO 27001:2013 ${new Date().toLocaleDateString().trim()}`,
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'materialarchivo',
                        name: 'materialarchivo',
                        sortable: false,
                        searchable: false
                    },
                    {
