...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Carpetum">
            <thead>
                <tr>
                    <th width="10">
...
@can('carpetum_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.carpeta.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.carpeta.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Carpetum').DataTable(dtOverrideGlobals);
