    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                retrieve: true,
                aaSorting: [],
                ajax: "{{ route('admin.vista-global-permisos-goce-sueldo') }}",
                columns: [{
                        data: 'empleado',
                        name: 'empleado',
            ...
            let table = $('.datatable-vista-global-permisos').DataTable(dtOverrideGlobals);
            $('.btn.buttons-print.btn-sm.rounded.pr-2').unbind().click(function() {
                let titulo_tabla = `
                <h5>
                    <strong>
                       Vista Global de Permisos con Goce de Sueldo
                    </strong>
                </h5>
            `;
                imprimirTabla('datatable-vista-global-permisos', titulo_tabla);
            });
