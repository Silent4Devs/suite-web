...
@section('content')
        ...
        @can('reglas_goce_sueldo_vista_global')
            <div class="col-12 text-left">
                <a type="button" class="btn" style="background-color:#b9eeb9; border: #fff; width:100px;"
                    href="{{ route('admin.descarga-permiso-goce-sueldo') }}">
    ...
    <div class="datatable-fix datatable-rds">
        ...
        <table class="datatable datatable-vista-global-goce-sueldo tblCSV" id="vista-global-permisos-goce-sueldo">
            <thead>
                <tr>
...
@section('scripts')
    ...
    <script>
        ...
        //             `);
            ...
            let table = $('.datatable-vista-global-goce-sueldo').DataTable(dtOverrideGlobals);
        ...
        //     </h5>
        // `;
            //     imprimirTabla('vista-global-permisos-goce-sueldo', titulo_tabla);
            // });
