...
@section('content')
	...
	<style type="text/css">
        ...
        #desk .caja_botones a.btn_activo, #desk .caja_botones a.btn_activo:hover{
	...
	<div class="card" id="desk">
		...
		<div class="caja_botones">
				<a href="#" data-tabs="registro" class="btn_activo"><i class="fas fa-exclamation-triangle mr-4"></i>Registro de Incidentes</a>
							...
							<div class="row">
								...
								<div class="col-md-8">
									<select id="select_metodos" class="form-control">
										...
										<option class="op_ideas" data-metodo="ideas">Lluvia de ideas (Brainstorming)</option>
										<option class="op_porque" data-metodo="porque">5 Porqués (5 Why)</option>
										<option class="op_digrama" data-metodo="digrama">Diagrama causa efecto (Ishikawa)</option>
									</select>
								</div>
									...
									<div id="digrama" class="caja_oculta_dinamica">
										<div class="col-12 mt-5" style="overflow: auto;">
											<div style="width: 100%; min-width:540px; position: relative;">
												...
												<textarea name="" class="politicas_txtarea txt_obj_secundarios_a"></textarea>
	 											...
	 											<textarea name="" class="tecnologia_txtarea txt_obj_secundarios_b"></textarea>
