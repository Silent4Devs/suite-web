<h5 class="col-12 titulo_general_funcion">Centro de Atención: <span style="font-weight: lighter;">Mejoras</span></h5>
<div class="cards-status-centro-atencion">
    <div class="card-status-centro" style="background-color: #4A98FF !important;">
        <i class="material-symbols-outlined">warning</i>
        <div class="info">
            <span>Quejas</span><br>
            <strong>{{ $total_mejoras }}</strong>
        </div>
    </div>
    ...
    <div class="card-status-centro" style="background-color: #78BB50 !important;">
        ...
        <div class="info">
            ...
            <strong>{{ $en_curso_mejoras }}</strong>
        </div>
    </div>
    <div class="card-status-centro" style="background-color: #BE74FF !important;">
        ...
        <div class="info">
            ...
            <strong>{{ $en_espera_mejoras }}</strong>
        </div>
    </div>
    <div class="card-status-centro" style="background-color: #7A7A7A !important;">
        ...
        <div class="info">
            ...
            <strong>{{ $cerrados_mejoras }}</strong>
        </div>
    </div>
    <div class="card-status-centro" style="background-color: #FE5661 !important;">
        ...
        <div class="info">
            ...
            <strong>{{ $cancelados_mejoras }}</strong>
        </div>
    </div>
</div>
...
{{-- <div class="card card-body box-sentimientos mt-4">
    <div class="card-sentimiento">
        <div>
            ...
            <strong>{{ $mejoras_sentiment_1 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Bajo</span><br>
            <strong>{{ $mejoras_sentiment_2 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Medio</span><br>
            <strong>{{ $mejoras_sentiment_3 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Alto</span><br>
            <strong>{{ $mejoras_sentiment_4 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            ...
            <strong>{{ $mejoras_sentiment_5 }}</strong>
        </div>
...
@foreach ($mejoras as $item)
    ...
    @endphp
    <div class="modal fade" id="sentimiento-modal-mejoras-{{ $item->id }}" tabindex="-1"
                    ...
                    columns: [
                        ...
                        },
                        {
                			...
                			<div class="botones_tabla">
                                ...
                                <button type="button" class="btn d-none" data-bs-toggle="modal" data-bs-target="#sentimiento-modal-mejoras-${data}">
