<h5 class="col-12 titulo_general_funcion">Centro de Atención: <span style="font-weight: lighter;">Sugerencias</span></h5>
...
{{-- <div class="card card-body box-sentimientos mt-4">
    <div class="card-sentimiento">
        <div>
            ...
            <strong>{{ $sugerencias_sentiment_1 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Bajo</span><br>
            <strong>{{ $sugerencias_sentiment_2 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Medio</span><br>
            <strong>{{ $sugerencias_sentiment_3 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            <span>Alto</span><br>
            <strong>{{ $sugerencias_sentiment_4 }}</strong>
        </div>
    ...
    <div class="card-sentimiento">
        <div>
            ...
            <strong>{{ $sugerencias_sentiment_5 }}</strong>
        </div>
                    ...
                    window.tabla_sugerencias_desk = $(".tabla_sugerencias").DataTable({
                        ...
                        columns: [{
                            ...
                            <div class="botones_tabla">
                                ...
                                <button type="button" class="btn d-none" data-bs-toggle="modal" data-bs-target="#sentimiento-modal-sugerencias-${data}">
