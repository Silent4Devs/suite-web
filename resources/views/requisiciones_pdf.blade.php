        ...
        <table class="encabezado">
            <tr>
                <td class="td-img-doc">
                    @if ($requisiciones->sucursal->mylogo)
                        <img style="width:100%; max-width:150px;"
                            src="{{ public_path('razon_social/' . $requisiciones->sucursal->mylogo) }}">
                    @else
                ...
                <td class="td-blue-header">
                    <h5 style="color:var(--color-tbj);">REQUISICIÓN DE ADQUISICIONES</h5>
        ...
        <tr>
            ...
            <td align="center">
                @if ($requisiciones->firma_jefe)
                    ...
                    <small> @isset($supervisor)
                            {{ $supervisor }}
                        @endisset | {{ $requisiciones->fecha_firma_jefe_requi }}</small>
                @else
                    <div style="height: 185px;"></div>
                @endif
                <hr>
        ...
        <tr>
            <td align="center">
                @if ($requisiciones->firma_finanzas)
                    ...
                    <small> {{ $firma_finanzas_name ?? '' }} | {{ $requisiciones->fecha_firma_finanzas_requi }}
                    </small>
                @else
                    <div style="height: 185px;"></div>
                @endif
            ...
            <td align="center">
                @if ($requisiciones->firma_compras)
                    ...
                    <small> {{ $requisiciones->comprador->user->name }} |
                        {{ $requisiciones->fecha_firma_comprador_requi }} </small>
                @else
                    <div style="height: 185px;"></div>
                @endif
                <hr>
