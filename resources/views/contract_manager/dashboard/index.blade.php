            ...
            <div class="card card_dp">
                <div class="card-body datos-primeros dp1">
                    <div class="row">
                        ...
                        <div>
                            <h4 style="font-size: 15px !important; text-align: center !important;">
                                &nbsp;&nbsp;&nbsp;Total &nbsp;de&nbsp;&nbsp;&nbsp; contratos</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card_dp">
                <div class="card-body datos-primeros dp3">
                    <div class="row">
                        ...
                        <div>
                            <h4 style="font-size: 15px !important; text-align: center !important;">&nbsp;&nbsp;Contratos
                                &nbsp;&nbsp;&nbsp;cerrados</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card_dp">
                <div class="card-body datos-primeros dp4">
                    <div class="row">
                        ...
                        <div>
                            <h4 style="font-size: 15px !important; text-align: center !important;margin-top:5px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Renovaciones</h4>
                            <h4 style="font-size: 5px !important; text-align: center !important;margin-top:5px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h4>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card_dp">
                <div class="card-body datos-primeros dp6">
                    <div class="row">
                        ...
                        <div>
                            <h4 style="font-size: 5px !important; text-align: center !important;margin-top:8px;">&nbsp;
                            </h4>
                            <h4 style="font-size: 15px !important; text-align: center !important;margin-top:10px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No Cumplen</h4>
                            <h4 style="font-size: 5px !important; text-align: center !important;margin-top:5px;">&nbsp;
                            </h4>
                        </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title graficas_titulos graficas_titulo3">Top 10 proveedores/clientes con
                                más
                                contratos</h4>
                        </div>
                        <div class="col-12">
