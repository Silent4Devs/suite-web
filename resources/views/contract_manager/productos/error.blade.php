...
<body>
    <div class="card card-content caja-blue">
        ...
        <div>
            <h3 style="font-size: 22px; font-weight: bolder;">Las causas por las que no puedes agregar el siguiente
                registro es la siguiente</h3>
            <ul>
                <li>La clave de registro ya esta siendo utilizada regresa y asignale otra</li>
            </ul>
            <a href="{{ redirect()->getUrlGenerator()->previous() }}" style="color: whitesmoke"
