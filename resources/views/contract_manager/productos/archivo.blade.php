    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('contract_manager.productos.getArchivadosIndex') }}",
                    type: 'POST',
                    data: {
                        _token: _token
                    }
            ...
            window.Archivar = function(url, clave) {
                Swal.fire({
                    ...
                    confirmButtonText: '¡Sí, desarchivado!',
                        ...
                        $.ajax({
                            ...
                            beforeSend: function() {
                                Swal.fire(
                                    ...
                                    `El producto: ${clave} está siendo desarchivado`,
                                    'info'
                                )
                            },
                            success: function(response) {
                                Swal.fire(
                                    'Desarchivado!',
                                    `El producto: ${clave} ha sido desarchivado`,
                                    'success'
                                ).then(() => {
                                    window.location.href = '/contract_manager/productos'; // Replace '/index' with your actual index page URL
                                });
                                table.ajax.reload();
                            },
