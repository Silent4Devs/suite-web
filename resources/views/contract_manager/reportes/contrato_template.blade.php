<link rel="stylesheet" type="text/css" href="{{ asset('css/reports/reports_contratos.css') }}{{ config('app.cssVersion') }}" />
    ...
    <div class="card-content">
        ...
        <div class="apartado-tablas">
            ...
            <table class="tabla mt-3">
                ...
                @empty
                    <tr>
                        <td colspan="7" style="text-align: center;">No hay niveles de servicio de este contrato</td>
                    </tr>
                @endforelse
            </table>
