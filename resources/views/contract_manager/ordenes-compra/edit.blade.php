    ...
    <div class="card card-content" style="width: 280px;">
        <div class="row">
            <div class="col s12 l12 ">
                ...
                <div class="caja-input-dinero">
                    <input type="text" id="sub_total_calculado" readonly name="sub_total" class="browser-default" required
        ...
        <div class="row">
            <div class="col s12 l12 ">
                ...
                <div class="caja-input-dinero">
                    <input type="text" id="iva_calculado" readonly name="iva" class="browser-default" required
        ...
        <div class="row">
            <div class="col s12 l12 ">
                ...
                <div class="caja-input-dinero">
                    <input type="text" id="iva_retenido_calculado" readonly name="iva_retenido" class="browser-default"
        ...
        <div class="row">
            <div class="col s12 l12 ">
                ...
                <div class="caja-input-dinero">
                    <input type="text" id="isr_retenido_calculado" readonly name="isr_retenido" class="browser-default"
        ...
        <div class="row">
            <div class="col s12 l12 ">
                ...
                <div class="caja-input-dinero">
                    <input type="text" id="total_calculado" name="total" readonly class="browser-default" required
