...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="p-4 card">
                <div class="row">
                    <div class="text-center col-sm-12 col-lg-6 col-6 justify-content-center">
                ...
                <div class="p-2 mt-4 text-center bg-light">
                    <h5 class="p-0 m-0"><i class="mr-1 fas fa-user-cog"></i>Ajustes</h5>
                </div>
                <div class="mt-3 row">
