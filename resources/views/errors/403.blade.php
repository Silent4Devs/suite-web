...
<head>
    ...
    <style>
        body {
            ...
            background: url("{{ asset('img/errors/403.svg') }}") no-repeat center center fixed;
        ...
        .btn {
            border: 1px solid var(--color-tbj) display: inline-block;
            padding: 15px 15px;
            border-radius: 5px;
            color: var(--color-tbj) margin-bottom: 60px;
