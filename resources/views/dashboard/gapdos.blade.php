<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h6 align="center">GAP 02: IMPLEMENTACIÓN DEL PLAN DE SEGURIDAD Y PRIVACIDAD DE LA INFORMACIÓN ({{number_format($porcentajeGap2['Porcentaje'], 2, '.', '')}}%)
                </h6>
                <div class="progress">
                    <div
                        ...
                        style="width: {{number_format($porcentajeGap2['Porcentaje'], 2, '.', '')}}%">{{number_format($porcentajeGap2['Porcentaje'], 2, '.', '')}}%
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
