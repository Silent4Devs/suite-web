                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        <h1
                                            ...
                                            </svg> Invitación para la capacitación
                                        ...
                                        <ul>
                                            <li>Nombre: <strong>{{ $recurso->cursoscapacitaciones }}</strong></li>
                                            <li>Fecha de inicio: <strong>{{ $recurso->fecha_inicio_name }}</strong>
                                            </li>
                                            <li>Fecha de Fin: <strong>{{ $recurso->fecha_fin_name }}</strong></li>
                                        </ul>
                                        </p>
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            ...
                                            <p>Tienes cómo Fecha Limite el
                                                <strong>{{ $recurso->fecha_limite_name }}</strong> para aceptar la
                                                invitación
                                            </p>
                                        </div>
                                    </td>
