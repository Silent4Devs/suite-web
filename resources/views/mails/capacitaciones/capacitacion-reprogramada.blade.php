                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ $recurso->cursoscapacitaciones }} ha sido reprogramada, con las
                                            siguientes fechas:</p>
                                        <h2
                                            ...
                                            <table
                                                ...
                                                <tbody
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 18px; padding: 10px 0;">
                                                            {{ $recurso->fecha_fin_name }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 18px; padding: 10px 0;">
                                                            Fecha Limite de Confirmación</td>
                                                        <td
                                                            style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; line-height: 18px; padding: 10px 0;">
                                                            {{ $recurso->fecha_limite_name }}</td>
                                                    </tr>
