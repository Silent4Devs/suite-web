                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                Le informamos que <strong>{{ $solicitante->name }}</strong> ha realizado
                                                una solicitud de Vacaciones la cual requiere de su aprobación.
                                            </p>
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p
                                        ...
                                        <div style="text-align:center; margin-top:20px">
                                            <a href="{{ route('admin.solicitud-vacaciones.respuesta', $solicitud->id) }}"
