                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                Le informamos que su solicitud de vacaciones ha sido atendida:
                                            </p>                                                
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                        ...
                                        <div style="text-align:center; margin-top:20px">
                                            <a  href="{{ route("admin.solicitud-vacaciones.show",$solicitud->id) }}" style="text-decoration:none;padding-top:15px; border-radius:4px; display:inline-block; min-width:300px; height:35px ;color:#fff; font-size:11pt; background-color:#345183">
                                                Ver Solicitud
                                            </a>
                                        </div>
                                    </td>
