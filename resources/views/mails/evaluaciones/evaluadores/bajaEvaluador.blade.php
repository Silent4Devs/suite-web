                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <strong>
                                            ...
                                            <br>
                                            <h3 style="text-align: center;"> Evaluador dado de Baja.</h3>
                                        </strong>
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            ...
                                            <div>
                                                Se le informa que el siguiente colaborador: <span style="color: red">
                                                    {{ $evaluador }}</span> ha sido
                                                dado de baja del sistema, y por lo tanto
                                                no podra cumplir con sus responsabilidades como evaluador en la
                                                evaluacion: <span
