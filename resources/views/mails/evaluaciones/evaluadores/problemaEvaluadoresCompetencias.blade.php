                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <strong>
                                            ...
                                            <br>
                                            <h3 style="text-align: center;"> Problema Evaluadores: Competencias</h3>
                                        </strong>
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            ...
                                            <div>
                                                ...
                                                los evaluadores asignados a las Competencias en la evaluación <span
                                                    style="color: rgb(0, 94, 255)">{{ $nombre_evaluacion }}</span>,
                                                esto puede ser debido a que algun evaluador fue dado de baja y/o el
                                                porcentaje de evaluación de Competencias no equivale al 100%.
                                            </div>
