                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="margin-top:50px;">
                                            <strong
                                                ...
                                                Estimado(a) {{ $aprobador_firma_contrato->aprobador->name }},
                                            </strong>
                                        </div>

                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                <strong>{{ $aprobador_firma_contrato->solicitante->name }} </strong> ha
                                                enviado una solicitud para aprobar el contrato <span
                                                    style="text-transform: lowercase !important;">{{ $aprobador_firma_contrato->contrato->no_contrato }}
                                                    - {{ $aprobador_firma_contrato->contrato->nombre_servicio }}</span>
                                            </p>
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p
                                                style="font-size:11pt; fontcolor:#153643; font-weight: normal !important;">
                                                Para aprobar la solicitud dar clic en el siguiente botón.
                                            </p>
                                        </div>
