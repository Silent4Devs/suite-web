                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%;">
                                            ...
                                            <p
                                                ...
                                                La Politica: {{ $nombre_politica }} ha sido rechazada<br>
                                                Puedes ver los comentarios y editarla en la siguiente liga.
                                            </p>
                                            <br>
                                            <div style="text-align:center;">
                                                Da click en la siguiente liga para revisarla y aprobarla
                                                <a href="{{ route('admin.politica-sgsis.edit', $id_politica) }}"
