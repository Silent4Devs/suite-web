                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="margin-top:50px;">
                                            <strong
                                                ...
                                                Estimado(a) {{ $aprobador_firma_puesto->aprobador->name }},
                                            </strong>
                                        </div>

                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                <strong>{{ $aprobador_firma_puesto->solicitante->name }} </strong> ha
                                                enviado una solicitud para aprobar el registro <span
                                                    style="text-transform: lowercase !important;">{{ $aprobador_firma_puesto->puesto->puesto }}
                                            </p>
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p
