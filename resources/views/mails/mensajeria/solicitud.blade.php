                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                ...
                                                realizado una solicitud de mensajería la cual requiere
                                                de su atención .
                                            </p>
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            ...
                                            <ul class="list_times_faltantes scroll_estilo mt-3">
                                                ...
                                                <li>
                                                    Lugar:
                                                    <strong>{{ $solicitud->lugar ?: 'No definido' }}</strong>
                                                </li>
                                                <li>
                                                    Dirección:
                                                    <strong>{{ $solicitud->descripcion ?: 'No definido' }}</strong>
                                                </li>
                                            </ul>
                                            </p>
                                        </div>
                                        <div style="text-align:center; margin-top:20px">
                                            <a href="{{ route('admin.envio-documentos.atencion', $solicitud->id) }}"
