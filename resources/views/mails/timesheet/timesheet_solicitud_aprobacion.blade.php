                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                <strong>{{ $solicitante->name }} </strong> ha enviado el reporte de
                                                horas de la semana <span
                                                    style="text-transform: lowercase !important;">{!! $timesheet_nuevo->semana !!}.</span>
                                            </p>
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p
                                        ...
                                        <div style="text-align:center; margin-top:20px">
                                            <a href="{{ asset('admin/timesheet/aprobaciones') }}"
