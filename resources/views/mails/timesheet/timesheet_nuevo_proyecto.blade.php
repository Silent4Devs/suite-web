                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                Se le comunica que el colaborador: <strong>{{ $empleado }} </strong>
                                                ha creado el proyecto <strong>{{ $proyecto }}</strong>
                                                con el identificador: <strong>{{ $identificador }}</strong>, para el
                                                cliente: <strong>{{ $cliente }}</strong>
                                            </p>
                                        </div>
                                        <div style="text-align:center; margin-top:20px">
                                            <a href="{{ asset('admin/timesheet/proyectos/edit/' . $id) }}"
