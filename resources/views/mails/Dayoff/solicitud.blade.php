                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="margin-top:50px;">
                                            <strong
                                                ...
                                                Estimado(a) {{$supervisor->name}},
                                            </strong>
                                        </div>

                                        <div style="width: 100%; margin-top: 10px;">
                                            <p style="font-size:11pt; fontcolor:#153643;">
                                                Le informamos que <strong>{{$solicitante->name}}</strong> ha presentado una solicitud de Day Off la cual requiere de su aprobación o rechazo.
                                            </p>                                                
                                        </div>
                                        <div style="width: 100%; margin-top: 10px;">
                                        ...
                                        <div style="text-align:center; margin-top:20px">
                                            <a  href="{{ route("admin.solicitud-dayoff.respuesta",$solicitud->id) }}" style="text-decoration:none;padding-top:15px; border-radius:4px; display:inline-block; min-width:300px; height:35px ;color:#fff; font-size:11pt; background-color:#345183">
                                                Aprobar / Rechazar
                                            </a>
                                        </div>
                                    </td>
