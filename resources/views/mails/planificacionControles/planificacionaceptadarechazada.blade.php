                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                            @if ($planificacionControles->es_aprobado == 'aprobado')
                                                <p style="font-size:11pt; color:#153643;">
                                                    Le informamos que derivado de su solicitud de Planificación y
                                                    Control
                                                    <strong style="font-size:10pt;">ID
                                                        {{ $planificacionControles->folio_cambio }}</strong>,
                                                    {{ $planificacionControles->responsableAprobar->name }} ha aprobado
                                                    su solicitud.
                                                </p>
                                                <strong
                                                    ...
                                                    Comentarios:</strong>
                                                <p style="font-size:11pt; color:#153643;">
                                                    {{ $planificacionControles->comentarios != null ? $planificacionControles->comentarios : 'Sin comentario' }}
                                                </p>
                                            @else
                                                <p style="font-size:11pt; color:#153643;">
                                                    Le informamos que derivado de su solicitud de Planificación y
                                                    ...
                                                    <strong style="font-size:10pt;">ID
                                                        {{ $planificacionControles->folio_cambio }}</strong>,
                                                    {{ $planificacionControles->responsableAprobar->name }}, ha
                                                    rechazado
                                                    su solicitud.
                                                </p>
                                                ...
                                                <p style="font-size:11pt; color:#153643; mt-3">
                                                    Para ingresar a revisar la planificación aprobada dé clic en el
                                                    siguiente botón:
                                                </p>
                                                ...
                                                <div style="text-align:center; margin-top:20px">
                                                    <a href="{{ route('admin.planificacion-controls.show', $planificacionControles) }}"
                                                        ...
                                                        Revisar Planificación y Control
                                                    </a>
                                                </div>
                                            @endif
                                        </div>
