                                    ...
                                    <td style="padding:0 0 36px 0;">
                                        ...
                                        <div style="width: 100%; margin-top: 10px;">
                                                ...
                                                <p style="font-size:11pt; color:#153643;">
                                                    Le informamos que se ha recibido una queja que requiere de su
                                                    atención.
                                                </p>
                                                ...
                                                <ul style="font-size:11pt; color:#153643;">
                                                    <li style="font-size:11pt;">Ticket ID: <strong
                                                    ...
                                                    <li style="font-size:11pt;">Prioridad:<strong
                                                            style="font-size:10pt;">
                                                            {{ $quejas->prioridad ? $quejas->prioridad : 'Sin definir' }}</strong>
                                                    </li>
                                                    <li style="font-size:11pt;">Categoría: <strong
                                                            style="font-size:10pt;">
                                                ...
                                                <ul style="font-size:11pt; color:#153643;">
                                                    ...
                                                    <li style="font-size:11pt;">Teléfono:<strong
                                                            style="font-size:10pt;"> {{ $quejas->telefono }}
                                                        </strong>
                                                    </li>
                                                ...
                                                <ul style="font-size:11pt; color:#153643;">
                                                    ...
                                                    <li style="font-size:11pt;">Proceso(s): <strong
                                                            style="font-size:10pt;">
                                                ...
                                                <ul style="font-size:11pt; color:#153643;">
                                                    ...
                                                    <li style="font-size:11pt;">Canal de recepción:<strong
                                                            style="font-size:10pt;"> {{ $quejas->canal }} </strong>
                                                    </li>
                                                    <li style="font-size:11pt;">Descripción:<strong
                                                            style="font-size:10pt;"> {{ $quejas->descripcion }}
                                                        </strong></li>
