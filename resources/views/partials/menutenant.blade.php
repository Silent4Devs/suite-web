...
<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show c-sidebar-light" style=" border: none;">
    ...
    <ul class="c-sidebar-nav dark_mode1" style="margin-top: -10px;">
        ...
        <li class="c-sidebar-nav-dropdown">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <ul class="c-sidebar-nav-dropdown-items">
                        ...
                        <li class="c-sidebar-nav-item">
                            ...
                            <a href="{{ asset('categoria-capacitacion') }}"          
                                ...
                                <i
                                    class="ml-2 fas fa-layer-group iconos_menu letra_blanca"                          
                                    style="font-size:12pt;"></i>

                                <font class="letra_blanca"> Crear categorías
                                </font>
                        ...
                        <li class="c-sidebar-nav-item">
                            ...
                            <a href="{{ asset('recursos') }}"                        
                                ...
                                <i
                                    class="ml-2 fas fa-graduation-cap iconos_menu letra_blanca"                        
                                    style="font-size:12pt;"></i>

                                <font class="letra_blanca"> Crear capacitaciones
                                </font>
                ...
                <li class="c-sidebar-nav-item">
                    ...
                    <a
                        class="c-sidebar-nav-link {{ request()->is('recursos-humanos/*') ? 'active' : '' }}"        
        ...
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link " href="{{ route('iso27001.index') }}#contexto">
        ...
        {{-- @can('faq_management_access')
            <li class="c-sidebar-nav-dropdown">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    ...
                    <span class="letra_blanca">Manual de Usuario </span>
                </a>
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('faq_category_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('faq-categories.index') }}"
                                ...
                                <span class="letra_blanca"> Documento</span>
                            </a>
                        </li>
                    @endcan
                    @can('faq_question_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route('faq-questions.index') }}"
                                ...
                                <span class="letra_blanca"> Manual </span>
                            </a>
                        </li>
                    @endcan
                </ul>
