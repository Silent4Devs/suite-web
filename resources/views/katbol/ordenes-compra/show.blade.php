...
<div class="create-requisicion">
    <div class="card card-content caja-blue">
        ...
        <div>
            ...
            <form method="POST" action="{{ route('orden-compra.pdf', ['id' => $requisicion->id]) }}">
            @csrf
            ...
            <div class="card card-item doc-requisicion">
                ...
                <div class="flex print-none" >
                    <div class="flex-item">
                        ...
                        <button class="btn btn info"  style="position: relative;   left:40%;"><a  href="{{route('orden-compra')}}" style="color: #EEEEEE">Regresar</a></button>
                    </div>
                </div>
            </div>
    </div>
