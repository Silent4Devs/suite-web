    ...
    <script>
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('katbol.orden-compra.getRequisicionIndex') }}",
                    type: 'POST',
                    data: {
                        _token: _token
                    }
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let urlButtonArchivar = `/katbol/orden-compra/archivar/${data}`;
                            let urlButtonEdit = `/katbol/orden-compra/${data}/edit`;
                            let htmlBotones =
                                `
                                <div class="btn-group">
