...
@section('titulo', 'Firmar Orden de Compra')
    ...
    <div id="paso-firma" class="tab-content">
        ...
        <div class="card card-content">
            <form method="POST" id="myForm" action="{{ route('katbol.orden-compra.firmar-update', ['tipo_firma' => $tipo_firma,'id' => $requisicion->id]) }}">
                @csrf
                <div class="">
            ...
            <form method="POST" action="{{ route('katbol.orden-compra.rechazada', ['id' => $requisicion->id]) }}">
                @csrf
