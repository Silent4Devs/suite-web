        ...
        $(function() {
            let dtButtons = [{
                ...
                let btnAgregar = {
                    ...
                    url: "{{ route('katbol.sucursales.create') }}",
                ...
                let deleteButton = {
                    ...
                    url: "{{ route('katbol.sucursales.massDestroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                aaSorting: [],
                ajax: {
                    url: "{{ route('katbol.sucursales.getSucursalesIndex') }}",
                    type: 'POST',
                    data: {
                        _token: _token
                    }
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            let urlButtonDelete = `/katbol/sucursales/${data}`;
