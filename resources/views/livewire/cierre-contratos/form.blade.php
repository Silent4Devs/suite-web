    ...
    <div>
        ...
        <div class="row" style="margin-left: 10px;margin-right: 10px;">
            <div class="distancia form-group col-md-8">
                ...
                <input type="text" maxlength="250" wire:model.live.debounce.800ms="aspectos" class="form-control"
                    required>
                @error('aspectos')
            ...
            <div class="distancia form-group col-md-4">
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" wire:model.blur="cumple" class="custom-control-input" id="cumple"
                        name="cumple">
