<div>
    <div class="mb-3 row">
        <div class="col-8">
            <input class="form-control" type="text" wire:model="search" placeholder="Buscar competencia...">
        </div>
        <div class="col-4">
        ...
        <table class="table">
            ...
            <tbody>
                @foreach ($competencias as $competencia)
                    <tr>
                        <th scope="row"><input wire:model="selected" value="{{ $competencia->id }}" type="checkbox">
                        </th>
