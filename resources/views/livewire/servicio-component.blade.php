    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tipoCompetenciaModalLabel"><i
                        class="fas fa-handshake iconos-crear"></i>Agregar Servicio</h5>
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control {{ $errors->has('servicio') ? 'is-invalid' : '' }}" id="servicio"
                                aria-describedby="servicio" wire:model="servicio" value="{{ old('servicio') }}"
                                autocomplete="off">
