<div>
            ...
            <div class="col-md-3">
                <ul class="nav nav-tabs d-flex inline">
                    ...
                    <a class="botones" href="#mi-plan-iso" data-toggle="tab" data-target="#mi-plan-iso"
                        wire:click='updateData(1)'> <!-- Agrega data-target -->
    ...
    @section('scripts')
        ...
        <script>
            document.addEventListener('cambioPestaña', function(event) {
        ...
        <script>
            document.addEventListener('cambioPestaña3', function(event) {
                    ...
                    fetch(`/obtener-clausula-id/${selectedValue}`)
                        ...
                        .then(data => {
                            ...
                            switch (data.clausula_id) {
                                ...
                                default:
                                    newData.y = [0, 0, 0, 0, 0, 0,
                                        0
                                    ]; // Valores predeterminados si no hay coincidencia
                            }
        ...
        <script>
            document.addEventListener('cambioPestaña4', function(event) {
                let data = [{
                    x: ['En curso', 'En espera', 'Cerrados', 'Sin atender'],
                    y: [{{ $encursoCount }}, {{ $enesperaCount }}, {{ $cerradoCount }},
                        {{ $sinatenderCount }}
                    ],
                    type: 'bar',
                    marker: {
        ...
        <script>
            document.addEventListener('cambioPestaña4', function(event) {
                let datass = [{
                    values: [{{ $encursoCount }}, {{ $enesperaCount }}, {{ $cerradoCount }},
                        {{ $sinatenderCount }}
                    ],
        ...
        <script>
            document.addEventListener('cambioPestaña4', function(event) {
                let datasss = [{
                    x: ['En curso', 'En espera', 'Cerrados', 'Sin atender'],
                    y: [{{ $encursoCountAC }}, {{ $enesperaCountAC }}, {{ $cerradoCountAC }},
                        {{ $sinatenderCountAC }}
                    ],
                    type: 'bar',
                    marker: {
