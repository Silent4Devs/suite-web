                ...
                <div class="card" style="background-color:#EDEEF0" style="position-relative; height:auto">
                    ...
                    <div class="row">
                        <div class="mt-4 ml-4 col-md-7">
                            ...
                            <p style="text-transform:capitalize; text-align:justify">{{ $empleadoget->resumen }}</p>
                            ...
                            @foreach ($empleadoget->empleado_experiencia as $experiencia)
                                ...
                                <br>
                                <span style="text-transform:capitalize">{{ $experiencia->puesto }} </span>
                                <br>
                                <span>{{ $experiencia->inicio_mes }} - {{ $experiencia->fin_mes }}</span>
                                <span style="text-transform:capitalize; text-align:justify">
                                <br>
                                <span class="text-align:justify">{{ $experiencia->descripcion }}</span>
                            @endforeach
                            {{-- </ul> --}}
                            ...
                            @foreach ($empleadoget->empleado_educacion as $educacion)
                                ...
                                <br>
                                <span style="text-transform:capitalize">{{ $educacion->carrera }}</span>
                                <br>
                            ...
                            <div
                                ...
                                {{-- <div class="height: 40px; clip-path: circle(20px at 50% 50%);">
                                    ...
                                    {{-- <span><img class="rounded-circle"
                                        ...
                                        <div class="text-center w-100"><img class="mt-3" style="height: 100px; clip-path: circle(50px at 50% 50%); margin:auto"

                                            src="{{ asset('storage/empleados/imagenes/') . '/' . $empleadoget->Avatar }}" alt=""></div>
                                ...
                                <br>
                                <strong><i class="ml-2 mr-2 text-white fas fa-phone-alt"></i>Número de Teléfono</strong>
                                <br>
