    ...
    {{-- <form wire:submit="updateContrato"> --}}
        ...
        <div class="card card-body">
            ...
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
                <div class="distancia form-group col-md-12">
                    ...
                    <div class="form-floating">
                        <textarea id="textarea1" maxlength="550" class="form-control"
                            wire:model="nombre_servicio" {{ $show_contrato ? 'readonly' : '' }} @if ($show_contrato) disabled @endif
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                ...
                @else
                    <div class="distancia form-group col-md-4">
                        ...
                        <input type="text" maxlength="250" wire:model="no_proyecto" id="no_proyecto" class="form-control"
                            @if ($show_contrato) disabled @endif>
                    </div>
                @endif
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                <div class="form-group col-md-6">
                    ...
                    <select wire:model="fase" id="fase" class="form-control" {{ $show_contrato ? 'disabled' : '' }}>
                        <option value="">Seleccione...</option>
                ...
                <div class="distancia form-group col-md-6">
                    ...
                    <select wire:model="estatus" id="estatus" class="form-control" {{ $show_contrato ? 'disabled' : '' }}>
                        <option value="">Seleccione...</option>
                        @foreach ([
            'vigentes' => 'Vigente',
            'Cerrado' => 'Cerrado',
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                <div class="form-group col-md-12">
                    ...
                    <textarea style="text-align:justify" maxlength="500" id="textarea1" class="form-control"
                        wire:model="objetivo" @if ($show_contrato) disabled @endif required>{{ $contrato->objetivo }}</textarea>
                ...
                <div class="distancia form-group col-md-6">
                    @if (!$show_contrato)
                        ...
                        @if (!is_null($organizacion))
                            <input class="form-control input_file_validar" type="file" wire:model="file_contrato"
                                accept=".docx,.pdf,.doc,.xlsx,.pptx,.txt" {{ $show_contrato ? 'disabled' : '' }} readonly>

                                <div wire:loading wire:target="file_contrato">CARGANDO ARCHIVO... </div>
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input type="number" wire:model="no_pagos" id="no_pagos"
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                <div class="distancia form-group col-md-4">
                    ...
                    <input type="date" wire:model="fecha_inicio" id="fecha_inicio" class="form-control"
                        required
                        @if ($show_contrato) disabled @endif>
                ...
                <div style="padding-left: 25px; padding-right: 25px;">
                    ...
                    <div class="row" style="padding-left: 0%;">
                        <div class="form-group col-md-4">
                            ...
                            <select wire:model="tipo_cambio" wire:change="changeTipoCambio($event.target.value)" id="tipo_cambio"
                                class="form-control" required>
                        ...
                        @if ($moneda_extranjera)
                            <div class="form-group col-md-4">
                                ...
                                <input min="0" required class="form-control" type="number" step=".01" wire:model="valor_dolar"
                                    id="valor_dolar"
                            ...
                            <div class="form-group col-md-4 d-flex align-items-center">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" wire:model="edit_moneda" id="edit_moneda"
                    ...
                    @if ($moneda_extranjera)
                        ...
                        <div class="row" style="padding-left: 0%;">
                            <div class="form-group col-md-4">
                                ...
                                <input min="0" required type="number" wire:model="monto_dolares" {{-- wire:model="monto_dolares" --}}
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" {{-- wire:model="maximo_dolares" --}} value="{{ old('maximo_dolares', $maximo_dolares) }}"
                                    wire:model="maximo_dolares" wire:change="convertirME($event.target.value,'maximo')" id="dolar_maximo"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" {{-- wire:model="minimo_dolares" --}} value="{{ old('minimo_dolares', $minimo_dolares) }}"
                                    wire:model="minimo_dolares" wire:change="convertirME($event.target.value,'minimo')" id="dolar_minimo"
                                    class="form-control" step=".01">
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="row" style="padding-left: 0%;">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" wire:model="monto_pago" id="monto_pago" class="form-control" step=".01"
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" wire:model="maximo" id="maximo" class="form-control" step=".01"
                                value="{{ old('maximo', $maximo) }}" @if ($moneda_extranjera) readonly @endif>
                        </div>

                        <div class="form-group col-md-4">
                            <label for="minimo" class="txt-tamaño">Monto mínimo M.X.N.</label>
                            <input type="number" wire:model="minimo" id="minimo" class="form-control" step=".01"
                ...
                <div class="col s12 m12">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="td_fianza">
                                    <input type="text" wire:model="folio" id="folio"
                                        class="form-control"
                            ...
                            <td>
                                <div class="td_fianza">
                                    <input class="form-control" type="file" wire:model="documento" accept=".pdf" readonly>
                                </div>
        ...
        <div class="row" style="margin-left: 10px; margin-right: 10px;">
            <div class="distancia form-group col-md-4">
                ...
                <div>
                    <input type="text" wire:model="pmp_asignado" id="pmp_asignado"
            ...
            <div class="distancia form-group col-md-4">
                ...
                <div>
                    <input type="text" wire:model="puesto" id="puesto"
        ...
        <div class="row" style="margin-left: 10px; margin-right: 10px;">
            ...
            <div class="distancia form-group col-md-4">
                <label class="txt-tamaño">Puesto</label>
                <input type="text" wire:model="cargo_administrador" id="cargo_administrador"
                    maxlength="250"
                    class="form-control" {{ $show_contrato ? 'readonly' : '' }}>
            ...
            <div class="distancia form-group col-md-4">
                <label class="txt-tamaño">Área</label>
                <input type="text" wire:model="area_administrador" id="area_administrador"
                    maxlength="250"
                    class="form-control" {{ $show_contrato ? 'readonly' : '' }}>
        ...
        <div class="form-group col-12 text-right mt-4" style="margin-left: 10px; margin-right: 10px;">
            <div class="col s12 right-align btn-grd distancia">
                @if (!$show_contrato)
                    ...
                    <button type="button" wire:click.prevent="updateContrato" class="btn btn-primary">Guardar</button>
                @endif
            </div>
        </div>
