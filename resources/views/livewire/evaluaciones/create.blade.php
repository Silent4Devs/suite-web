<div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-1 " style="align-self: end;">
            <button type="submit" class="btn btn-info" wire:loading.attr="disabled" wire:target="store"
                wire:click.prevent="store()">
                <i class="fas fa-spinner fa-pulse" wire:loading wire:target="store"></i>
                <span wire:loading.remove wire:target="store"><i class="fas fa-save"></i></span>
