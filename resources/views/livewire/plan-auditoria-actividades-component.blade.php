        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <input id="plan_auditoria_id" name="plan_auditoria_id" type="hidden"
                        value=" {{ $plan_auditoria_id }}" wire:model="plan_auditoria_id">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            <label for="fecha_auditoria"> <i class="far fa-calendar-alt iconos-crear"></i> Fecha de
                                auditoría
                                en vigor<span class="text-danger">*</span></label>
                            <input class="form-control date {{ $errors->has('fecha_auditoria') ? 'is-invalid' : '' }}"
                                type="date" name="fecha_auditoria" id="fecha_auditoria"
                                value="{{ $fecha_auditoria }}" wire:model="fecha_auditoria">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-lg-6 mt-4">
                            <label for="horario_inicio"><i class="fas fa-clock iconos-crear"></i>Horario de
                                inicio</label>
                            <input class="form-control date" type="time" name="horario_inicio"
                                id="horario_inicio_actividad" value="{{ old('horario_inicio') }}"
                                wire:model="horario_inicio">
                            <small class="text-danger errores horario_inicio_error"></small>
                        </div>

                        <div class="form-group col-sm-12 col-md-6 col-lg-6 mt-4">
                            <label for="horario_termino"><i class="fas fa-clock iconos-crear"></i>Horario de
                                término</label>
                            <input class="form-control date" type="time" name="horario_termino"
                                id="horario_termino_actividad" value="{{ old('horario_termino') }}"
                                wire:model="horario_termino">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            <label for="id_auditado"><i class="fas fa-user-tie iconos-crear"></i>Auditado(a)<span
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            <label class="required" for="nombre_auditor"><i
                                    class="fas fa-user-tie iconos-crear"></i>Nombre del
                                auditor asignado</label>
                            <input class="form-control {{ $errors->has('nombre_auditor') ? 'is-invalid' : '' }}"
                                type="text" name="nombre_auditor" id="nombre_auditor"
                                value="{{ old('nombre_auditor', '') }}" wire:model="nombre_auditor">
