        ...
        @forelse ($section->lessons as $item)
            <div class="card shadow-none">
                <div class="card-header" style="color:blue; border: 1px solid #D8D8D8;">
                    <i style="font-size:10pt; cursor: pointer;" class="d-inline text-black-500 fas fa-play-circle abirCollapse"
                    data-toggle="collapse" data-target="#miCollapse{{$item->id}}"  aria-expanded="false"></i>
                    <h5 class="d-inline">
                        {{ $item->name }}
                    </h5>
                    <div class="d-inline">
                        <a wire:click="edit({{ $item }})" style="cursor: pointer">
                            <i style="font-size:10pt" class="ml-1 text-blue-500 cursor-pointer fas fa-edit"
                                title="Editar" id="abir{{$item->id}}"></i>
                        </a>
                ...
                <div class="card-body collapse hide" style="border: 1px solid #D8D8D8;" id="miCollapse{{$item->id}}">
                    ...
                    <form wire:submit.prevent="update" class="px-3 py-2">
                            ...
                            <div class="grid items-center mb-2 grid-col-1 md:grid-cols-6 md:gap-3">
                                ...
                                <div class="md:col-span-5">
                                    <select wire:model="lesson.platform_id" id="edit-lesson-platform-{{ $section->id }}"
                                        type="text" class="w-full form-control @if ($errors->has('lesson.platform')) invalid @endif">
                            ...
                            <div class="d-flex justify-content-end mt-4">
                                ...
                                <button type="submit" class="btn btn-outline-primary" style="min-width:140px;">Actualizar</button>
                            </div>
                    </form>
                </div>
            </div>
