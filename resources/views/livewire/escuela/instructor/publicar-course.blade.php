<div>
    <select wire:ignore value="{{ old('status_id') }}" wire:model="status_id" class="mt-2 mb-2 form-control d-inline"
        ...
        <option value="3" {{ $course->status == 4 ? 'selected' : '' }}>Publicado</option>
    </select>
    <p class="d-inline">
        @if ($course->status == 1)
