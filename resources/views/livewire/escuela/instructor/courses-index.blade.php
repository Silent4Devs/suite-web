        ...
        <div class="d-flex justify-content-between" style="justify-content: flex-end !important;">
            ...
            <div class="p-2 m-4">
                <a href="{{ route('admin.courses.create') }}"
                    class="ml-4 btn text-white uppercase transition bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 cursor-pointer">Crear
                    Curso Nuevo</a>
            </div>
                        ...
                        @foreach ($courses as $course)
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="d-flex inline">
                                        <div class="circulo-kaans">
                                            @isset($course->image)
                                                <img src="{{ asset($course->image->url) }}" alt="{{ $course->title }}">
                                            @else
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <ul class="d-flex px-2" style="list-style: none;">
                                                <li class="mr-1">
                                                    <i class="fas fa-star"
                                                        style="color: {{ $course->rating >= 1 ? '#E3A008' : 'gray' }}; font-size: 18px;">
                                                    </i>
                                                </li>
                                                <li class="mr-1">
                                                    <i class="fas fa-star"
                                                        style="color: {{ $course->rating >= 2 ? '#E3A008' : 'gray' }}; font-size: 18px;"></i>
                                                </li>
                                                <li class="mr-1">
                                                    <i class="fas fa-star"
                                                        style="color: {{ $course->rating >= 3 ? '#E3A008' : 'gray' }}; font-size: 18px;"></i>
                                                </li>
                                                <li class="mr-1">
                                                    <i class="fas fa-star"
                                                        style="color: {{ $course->rating >= 4 ? '#E3A008' : 'gray' }}; font-size: 18px;"></i>
                                                </li>
                                                <li class="mr-1">
                                                    <i class="fas fa-star"
                                                        style="color: {{ $course->rating >= 5 ? '#E3A008' : 'gray' }}; font-size: 18px;"></i>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    ...
                                    <a href="{{ route('admin.courses-quizdetails', $course) }}"
                                        class="mr-2 fas fa-file-alt" title="Consultar Evaluaciones"
