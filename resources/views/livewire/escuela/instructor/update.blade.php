        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group anima-focus">
                    <input class="form-control" type="text" value="" id="title" placeholder="" wire:model="question">
                ...
                <div class="form-group anima-focus">
                    <input class="form-control" type="text" value="" id="description" placeholder="" wire:model="explanation">
