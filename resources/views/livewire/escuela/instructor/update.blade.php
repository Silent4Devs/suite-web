<div wire:ignore.self class="modal fade" id="updateDataModal{{ $questionModel->id }}" data-backdrop="static" tabindex="-1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group anima-focus">
                    <input class="form-control" type="text" value="" id="description" placeholder=""
            ...
            <div class="modal-footer">
                ...
                <button wire:click.prevent="update({{ $questionModel->id }})" data-dismiss="modal" class="btn tb-btn-primary close-modal"
