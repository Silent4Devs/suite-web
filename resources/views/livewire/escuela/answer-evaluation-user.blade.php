<div>
    ...
    <div class="p-5 mx-2 mt-4 bg-white rounded-lg shadow-lg md:p-20">
        ...
        <div class="text-right pt-8">
            <span class="p-1 font-extrabold text-gray-400">Progreso {{ $count }}/{{ $totalQuizQuestions }}</span>
        </div>
        ...
        <div class="overflow-hidden bg-white border-2 border-gray-300 shadow sm:rounded-lg">
            <div class="container px-5 py-5 mx-auto">
                <div class="justify-center mb-5 text-center">
                    <h1 class="mb-4 text-2xl font-medium text-center text-gray-900 sm:text-3xl title-font">Resultados</h1>
                    <p class="mt-10 text-md">  <span class="mr-2 font-extrabold text-blue-600">
                            ...
                            href="{{route("courses.evaluation.quizdetails",[
                                'course'=>$course,
                ...
                <div class="flex flex-wrap -mx-2 lg:w-4/5 sm:mx-auto sm:mb-2">
                    <div class="w-full p-2 sm:w-1/2">
                        <div class="flex items-center h-full p-4 bg-gray-100 rounded">
                            ...
                            <span class="mr-5 font-medium text-purple-700 title-font">Respuestas correctas</span><span
                                class="font-medium title-font">{{ $correctQuestions }}</span>
                        </div>
                    </div>
                    <div class="w-full p-2 sm:w-1/2">
                        <div class="flex items-center h-full p-4 bg-gray-100 rounded">
                    ...
                    <div class="w-full p-2 sm:w-1/2">
                        <div class="flex items-center h-full p-4 bg-gray-100 rounded">
                            ...
                            <span class="mr-5 font-medium text-purple-700 title-font">Porcentaje 
                                ...
                                class="font-medium title-font">{{ round($percentage) . '%' }}</span>
                        </div>
                    </div>
                    <div class="w-full p-2 sm:w-1/2">
                        <div class="flex items-center h-full p-4 bg-gray-100 rounded">
                            ...
                            <span class="mr-5 font-medium text-purple-700 title-font">Estado de la evaluación</span><span
