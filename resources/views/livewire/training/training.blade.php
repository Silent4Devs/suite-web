<div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 style="color:#3086AF;">Capacitaciones</h4>
            <hr>
            <form wire:submit="{{$status === "create" ? "save":"edit"}}">
                <div class="row" style="padding-left: 14px;">
                    <div class="col-12 col-sm-6 form-group  pl-0 anima-focus">
                        <select id="type" style="max-width:614px; width:100%;" class="form-control" name="type" wire:model.live="form.type_id" wire:change="getCatalogueName" required>
                    ...
                    <div class="col-12 col-sm-6 form-group pl-0 anima-focus">
                        <select id="name" style="max-width:614px; width:auto;" class="form-control" name="name" wire:model.live="form.name_id" required>
                            <option value="" selected>
                                -- Selecciona una opción --
                            </option>
                            @if ($names->isNotEmpty())
                    ...
                    @if ($form->type_id === '1')
                        <div class=" col-12 col-sm-6 form-group pl-0 anima-focus">
                            <input id="credential_id" class="form-control" placeholder="" name="credential_id" type="text"
                                wire:model.live="form.credential_id" required>
                            <label for="credential_id">ID de la credencial*</label>
                        </div>
                        <div class=" col-12 col-sm-6 form-group pl-0 anima-focus">
                            <input id="credential_url" class="form-control" placeholder="" name="credential_url" type="text"
                                wire:model.live="form.credential_url" required>
                        ...
                        <div class="d-flex align-items-center col-12 col-sm-2 " style="margin-bottom: 25px;">
                            <input class="form-control mr-3" style="height: 18px; width:18px;" type="checkbox" value="" id="flexCheckDefault" {{$form->isChecked ? 'checked':null}} wire:change='chanceChecked'>
                            <label class="form-check-label" for="flexCheckDefault">
                                ¿Aplica vigencia?
                            </label>
                        </div>
                        <div class="col-6 col-sm-3 form-group pl-0 anima-focus">
                            <input id="validity" type='date' class="form-control" placeholder="" name="validity" type="text"
                                wire:model.live="form.validity"  {{$form->isChecked ? null:"disabled"}} wire:change='verifyStatus'>
                            <label for="validity">Vigencia</label>
                        </div>
                        <div class="col-6 col-sm-3 form-group pl-0 anima-focus">
                            <input id="validityStatus" type='text' class="form-control" placeholder="" name="validityStatus" type="text"
                                wire:model.live="form.validityStatus" {{$form->isChecked ? null:"disabled"}} style="{{$form->isChecked ? null: 'background-color:white;'}}" readonly>
                    ...
                    >Dar de alta capacitación</button>
                </div>
                <div>
                    ...
                    @foreach ($registers as $register)
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-primary"
                                style="height: 45px; background-color: #E2E2E2 ; border: 1px solid #707070; border-radius: 4px; color:#575757;"
                                type="button" wire:click="downloadEvidencie({{$register->evidence_id}})"> Descargar Archivo</button>
                                @else
                                    Sin evidencia
                                @endif
                            </td>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalTraining" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h5 style="color:#3086AF;">Agregar tipo de Capacitación</h5>
                <hr>
                <form wire:submit="saveModal">
                    ...
                    <div class="form-group pl-0 anima-focus">
                        <select id="typeModal" class="form-control" name="type" wire:model.live="modalForm.type_id" required>
                            <option value="" selected>
                                -- Selecciona una opción --
                            </option>
                            @foreach ($types as $type)
                    ...
                    <div class="form-group pl-0 anima-focus">
                        <input id="issuing_company" class="form-control" placeholder="" name="issuing_company" type="text"
                            wire:model.live="modalForm.issuing_company" required>
                    ...
                    <div class="form-group pl-0 anima-focus">
                        <input id="manufacturer" class="form-control" placeholder="" name="manufacturer" type="text"
                            wire:model.live="modalForm.manufacturer" required>
