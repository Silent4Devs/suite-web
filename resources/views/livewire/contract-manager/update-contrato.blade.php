    ...
    <form wire:submit="updateContrato">
        <div class="card card-body">
            ...
            <div class="row" style="margin-left: 10px;margin-right: 10px;">
                ...
                <div class="distancia form-group col-md-4">
                    <label for="tipo_contrato" class="txt-tamaño">Tipo de contrato<font class="asterisco">*</font>
                        </label>
                    <div>
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                ...
                @else
                    <div class="distancia form-group col-md-4">
                        ...
                        <input type="text" maxlength="250" name="no_proyecto" id="no_proyecto"
                            class="form-control" value="{{ $contrato->no_proyecto }}"
                            @if ($show_contrato) disabled @endif>
                    </div>
                @endif
        ...
        'renovaciones' => 'Renovación',
                        ...
                        <div class="file-field input-field">
                            ...
                            <div class="file-path-wrapper">
                                <input value="{{ $contrato->file_contrato }}" class="file-path validate form-control"
                                    type="text" placeholder="Elegir documento"
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                <div class="distancia form-group col-md-4">
                    <label for="vigencia_contrato" class="txt-tamaño">Vigencia<font class="asterisco">*</font>
                        </label>
                                            ...
                                            @if (isset($contrato->documento) || isset($contratos->folio))
                                                <div class="custom-control custom-switch form">
                                                    <input type="checkbox" class="custom-control-input"
                                                        id="check_fianza" name="aplicaFinaza"
                                                        {{ $show_contrato ? 'disabled' : '' }} checked>
                                                    <label class="custom-control-label"
                                                        for="check_fianza">No/Sí</label>
                                                </div>
                ...
                <div class="distancia form-group col-md-4">
                    ...
                    <div>
                        <input type="text" name="area" id="area"
                            value="{{ old('area', $contratos->area) }}" maxlength="250" class="form-control"
                            {{ $show_contrato ? 'readonly' : '' }}>
                        @if ($errors->has('area'))
                            <div class="invalid-feedback red-text">
                                {{ $errors->first('area') }}
            ...
            <div class="row" style="margin-left: 10px; margin-right: 10px;">
                <div class="distancia form-group col-md-4">
                    ...
                    <input type="text" name="administrador_contrato" id="administrador_contrato"
                        value="{{ old('administrador_contrato', $contratos->administrador_contrato) }}"
