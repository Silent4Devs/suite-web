<div class="form-group col-md-12">
    ...
    <label for="exampleInputEmail1">3.¿Quién le proporciona esta
        información?</label>

    <div class="row">
        @livewire('create-proporciona-informacion-aia', ['cuestionario_id' => $cuestionario_id])
    </div>
            ...
            @foreach ($datas as $data)
                <tr>
                    ...
                    <td style="min-width:40px;">
                        <i class="fas fa-edit"
                            wire:click.prevent="$dispatch('editarFuenteInformacionAia',{{ $data->id }})">
                        </i>
                        {{-- <i class="fas fa-project-diagram"
                            wire:click.prevent="$dispatch('agregarNormas',{{ $data->id }})"> </i> --}}
                        <i class="fas fa-trash-alt text-danger"
                            wire:click.prevent="$dispatch('eliminarFuenteInformacionAia',{{ $data->id }})"> </i>
                    </td>
