<div class="col-12">
    ...
    <div class="modal fade" id="modalDebilidades" tabindex="-1" aria-labelledby="modalDebilidadesLabel" aria-hidden="true"
        wire:ignore.self>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mt-2 form-group anima-focus">
                        <textarea class="form-control {{ $errors->has('debilidad') ? 'is-invalid' : '' }}" wire:model="debilidad"
                            placeholder="">
                            </textarea>
                        @error('debilidad')
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item"
                                                        wire:click="$dispatch('deleteD',{ id: {{ $debilidad->id }} })">
                                                        <div class="d-flex align-items-start">
                                                            <i class="material-icons-outlined"
