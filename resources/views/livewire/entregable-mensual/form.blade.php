        ...
        <div class="mb-4 row">
            ...
            <div class="row">
                ...
                <div class="col s12 m4 distancia">
                    ...
                    <div class="switch">
                        <label class="grey-text letra-ngt">
                            No
                            <input type="checkbox" name="cumplimiento" class="cumplimiento"
                ...
                <div class="col s12 m6 distancia">
                    <label for="" class="txt-tamaño"><i class="fas fa-file iconos-crear"></i>Factura Relacionada<font class="asterisco">*</font></label>
                    <select name="factura_id" id="factura_id" class="" wire:model.defer="factura_id" required>
            ...
            <!--row-->
                ...
                <div wire:ignore class="col s12 m6">
                    ...
                    <div class="file-field input-field">
                        <div class="btn" style="margin-right: 8px">
                            <span>DOCUMENTO</span>
                            <input class="input_file_validar" type="file" wire:model="pdf" accept="{{$organizacion ? $organizacion->formatos : '.docx,.pdf,.doc,.xlsx,.pptx,.txt'}}"
                                id="upload{{ $iteration1 }}" class="input_file_validar">
                        </div>
                        <div class="file-path-wrapper">
                            <input class="file-path validate" wire:model="pdf" placeholder="Elegir factura"
                                readonly>
                        </div>
                    </div>
                    @endif
                ...
                <div class="input-field col l12 m12 s12" x-data="{ show: @entangle('aplica_deductiva') }">
                    <div class="col s12 m4 distancia">
                        <label for="" class="txt-tamaño"><i class="fas fa-clipboard iconos-crear"></i>¿Aplica deductiva/penalización?<font class="asterisco">*</font></label>
                        <div class="switch">
                            <label class="grey-text letra-ngt">
                                No
                                <input type="checkbox" class="aplica_deductiva" wire:model="aplica_deductiva"
                                    @change="show = !show">
                                <span class="lever"></span>
                                Si
                            </label>
                    ...
                    <div class="col s12 m12" x-show="show">
                        <div class="col s12 m12 distancia">
                            <label for="" class="txt-tamaño"><i class="fas fa-calendar-alt iconos-crear"></i>¿Por qué aplica la Deductiva/Penalización?<font class="asterisco">*</font></label>
                            <textarea  wire:model.debounce.800ms="justificacion_deductiva_penalizacion" style="padding:15px;" class="text_area" required></textarea>
                            @error('justificacion_deductiva_penalizacion') <span class="red-text">{{ $message }}</span> @enderror
                        </div>
                        <div class="col s12 m4 distancia">
                            ...
                            @error('deductiva_penalizacion') <span class="red-text">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col s12 m4 distancia">
                            <label for="" class="txt-tamaño"><i class="fas fa-file iconos-crear"></i>Factura Relacionada<font class="asterisco">*</font></label>
                            <select name="deductiva_factura_id" id="deductiva_factura_id" class="" wire:model.defer="deductiva_factura_id">
                                <option value="">Sin factura</option>
                                @foreach($facturas_entregables as $facturas)}
                                    <option value="{{$facturas->id}}">{{$facturas->no_factura}}</option>
                                @endforeach
                            </select>
                            @error('deductiva_factura_id') <span class="red-text">{{ $message }}</span> @enderror
                        </div>
                        <div class="col s12 m4 distancia">
                            <label for="" class="txt-tamaño"><i class="far fa-credit-card iconos-crear"></i>Nota de crédito<font class="asterisco">*</font></label>
                            <input type="text" wire:model.debounce.800ms="nota_credito" class="form-control">
                            @error('nota_credito') <span class="red-text">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
