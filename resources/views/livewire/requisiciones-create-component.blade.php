            ...
            @case(2)
                ...
                <div id="profile" class="tab-content" {{ !$habilitar_proveedores ? ' style=display:none; ' : '' }}>
                    <form id="form-proveedores"
                        wire:submit.prevent="proveedoresStore(Object.fromEntries(new FormData($event.target)))" action="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="card card-body">
                            <h3 class="titulo-form">Solicitud de requisición</h3>
                        ...
                        <div class="caja-card-proveedor caja-cards-inner">
                            @for ($i = 0; $i <= $proveedores_count; $i++)
                                <div id="proveedor-card-{{ $i }}" class="card card-body card-inner card-proveedor"
                                    data-count="{{ $i }}">
                                    <div class="row">
                                        <div class="col s12 ">
                                            <div class="flex" style="justify-content: space-between">
                                                ...
                                                @if ($this->selectOption[$i] === 'sugerido')
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col s12 l3">
                                                            ...
                                                            <input type="email" id="foo" class="browser-default modal-correo"
                                                    ...
                                                    <div class="row">
                                                        <div class="col s12 l12">
                                                            ...
                                                            <input type="file" required class="modal-cotizacion form-control-file"
                                                                name="cotizacion_{{ $i }}"
