                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <select class="form-control {{ $errors->has('escenario') ? 'is-invalid' : '' }}"  wire:model="escenario" >
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input class="form-control {{ $errors->has('empresa') ? 'is-invalid' : '' }}" type="text"
                                value="{{ old('empresa', '') }}" wire:model="empresa" placeholder="...">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input class="form-control {{ $errors->has('rol') ? 'is-invalid' : '' }}" type="text"
                                value="{{ old('rol', '') }}" wire:model="rol" placeholder="...">
                            @if ($errors->has('rol'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rol') }}
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4 col-md-4 col-lg-4">
                            ...
                            <input class="form-control {{ $errors->has('a_paterno') ? 'is-invalid' : '' }}" type="text"
                                value="{{ old('nombe', '') }}" wire:model="a_paterno" placeholder="...">
                        ...
                        <div class="form-group col-sm-4 col-md-4 col-lg-4">
                            ...
                            <input class="form-control {{ $errors->has('a_materno') ? 'is-invalid' : '' }}" type="text"
                                value="{{ old('a_materno', '') }}" wire:model="a_materno" placeholder="...">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6 col-md-6 col-lg-6">
                            ...
                            <input class="form-control {{ $errors->has('tel') ? 'is-invalid' : '' }}" type="number"
                                value="{{ old('tel', '') }}" wire:model="tel" placeholder="...">
                            @if ($errors->has('tel'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('tel') }}
                                </div>
