        ...
        <div class="d-flex justify-content-center w-100">
            <div class="form-group w-100 mr-4 ">
                ...
                @if($origen == 'tareas-proyectos')
                    <div class="form-control" style="background-color: #eee">{{ $proyecto_seleccionado->proyecto }}</div>
                @endif
                @if($origen == 'tareas')
                ...
                @if($origen == 'tareas')
                    @foreach($tareas as $tarea)
                        <tr>
                            ...
                            <td>
                                <i class="fas fa-trash-alt btn" wire:click="destroy({{ $tarea->id }})" style="color: red; font-size: 15pt;" title="Eliminar"></i>
                            </td>
                        </tr>
                    @endforeach
                @endif
