<div class="caja_anima_reporte">
    ...
    @endphp
    <style type="text/css">
        .datatable_timesheet_proyectos tr th:first-child.ver,
        .datatable_timesheet_proyectos tr td:first-child.ver{
            position: sticky;
            left: 0;
            z-index: 6;
        }
    ...
    <div class="w-100">
        <div class="row">
            ...
            <div class="col-md-3 form-group" wire:ignore>
                ...
                <input id="fecha_dia_registros_inicio_proyectos" class="form-control date_librery" type="date" name="fecha_inicio" wire:model="fecha_inicio">
            </div>
            <div class="col-md-3 form-group" wire:ignore>
                <label class="form-label">Fecha de fin</label>
                <input id="fecha_dia_registros_fin_proyectos" class="form-control date_librery" type="date" name="fecha_fin" wire:model="fecha_fin">
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="datatable-fix mt-5">
                    <table id="datatable_timesheet_proyectos" class="datatable_timesheet_proyectos table w-100 tabla-fixed">
                        <thead>
                            <tr>
