<div class="form-group col-md-12">
    ...
    <button type="button" class="btn tb-btn-primary offset-11" style="text-align:center;" wire:click.prevent="createMateriales">
        Agregar
    </button>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-12 col-lg-12">
                            ...
                            <input class="form-control {{ $errors->has('otro_numero') ? 'is-invalid' : '' }}" type="number"
                                value="{{ old('otro_numero', '') }}" wire:model="otro_numero" placeholder="...">
