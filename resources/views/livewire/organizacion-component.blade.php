        ...
        <div class="row">
            <div class="form-group col-sm-3">
                ...
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="logotipo_id" class="c-switch-input">
            ...
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="empresa_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="direccion_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="razon_social_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="rfc_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
            ...
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="pagina_web_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            ...
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="schedule_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="representante_legal_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="fecha_constitucion_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="num_empleados_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="tamano_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="giro_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="servicios_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="mision_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="vision_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="valores_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="antecedentes_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="linkedln_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="facebook_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="youtube_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="twitter_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div>
            {{-- <div class="form-group col-sm-3">
                ...
                <br>
                <label class="c-switch c-switch-lg c-switch-pill c-switch-label c-switch-info" style="margin-left: 30px;">
                    <input type="checkbox" wire:model.live.debounce.800ms="team_id_id" class="c-switch-input">
                    <span class="c-switch-slider" data-checked="On" data-unchecked="Off"></span>
                </label>
            </div> --}}
        </div>
