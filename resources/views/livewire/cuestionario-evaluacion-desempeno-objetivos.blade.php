<div>
    ...
    @if ($validacion_objetivos_evaluador)
        <div class="card border-0">
            <div class="card-title mb-0 d-flex align-items-center justify-content-around" style="border-top-left-radius: 14px; border-top-right-radius:14px;background-color: #8C91D6; color:#FFFFFF; height: 90px;">
                            ...
                            <tr style="text-align: center;">
                                ...
                                @if ($evaluador->id != $id_evaluado->evaluador_desempeno_id)
                                    @if ($objetivos_autoevaluado[$key]->estatus_calificado)
                                        <td style="background-color: {{$autoevaluacion_colors[$objetivos_autoevaluado[$key]->id ."-bg-color"]}}; ">
                                            <div class="">
                                                {{ $objetivos_autoevaluado[$key]->calificacion_objetivo ?? null }}
                                            </div>
                                            {{-- <div class=""> --}}
                                                <p style="color: {{$autoevaluacion_colors[$objetivos_autoevaluado[$key]->id ."-tx-color"]}};">
                                                    <b>
                                ...
                                <td>
                                    ...
                                    <div wire:ignore.self class="modal fade" id="evidenciaObjetivo{{ $obj_evld->id }}"
                                        ...
                                        <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"
                                            style="margin:50px 0px 10px 1030px; background:none; border: none;"><i class="fa-solid fa-x fa-2xl"
                                                    ...
                                                    @if (!empty($obj_evidencias[0]))
                                                        @foreach ($obj_evidencias[$key] as $key_evidencia => $evidencia)
                                                            <div class="row align-items-center">
                                                                ...
                                                                <div class="col-8">
                                                                    <div class="form-group">
                                                                        <textarea class="form-control" style="min-height: 83px;" name="comentario_{{ $key_evidencia }}" id="comentario_{{ $key_evidencia }}" style="min-width: 100%"
                                ...
                                <td>
                                    <div class="p-3">
                                        <div class="form-group">
                                            <input class="form-control" id="pregunta_n{{ $key }}" style="width: 97px;"
