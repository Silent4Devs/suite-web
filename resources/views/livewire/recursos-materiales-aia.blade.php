<div class="form-group col-md-12">
    ...
    <label for="exampleInputEmail1"> <i class="fas fa-id-card iconos-crear"></i>10 y 11. Cuántos recursos materiales necesita para ejecutar el proceso en operación normal?, En caso de contingencia, ¿Cuántos recursos materiales mínimos necesitaría para ejecutar el proceso?.</label>
    <div class="row">
        @livewire('create-recursos-materiales-aia', ['cuestionario_id' => $cuestionario_id])
    </div>
