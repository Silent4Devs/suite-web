        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.minutasaltadireccion.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.minutasaltadireccions.update", [$minutasaltadireccion->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="objetivoreunion">{{ trans('cruds.minutasaltadireccion.fields.objetivoreunion') }}</label>
                            <textarea class="form-control" name="objetivoreunion" id="objetivoreunion">{{ old('objetivoreunion', $minutasaltadireccion->objetivoreunion) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="arearesponsable" id="arearesponsable" value="{{ old('arearesponsable', $minutasaltadireccion->arearesponsable) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechareunion" id="fechareunion" value="{{ old('fechareunion', $minutasaltadireccion->fechareunion) }}">
