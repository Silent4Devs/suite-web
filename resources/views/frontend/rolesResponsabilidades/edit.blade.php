    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.roles-responsabilidades.update", [$rolesResponsabilidade->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="responsabilidad">{{ trans('cruds.rolesResponsabilidade.fields.responsabilidad') }}</label>
                            <input class="form-control" type="text" name="responsabilidad" id="responsabilidad" value="{{ old('responsabilidad', $rolesResponsabilidade->responsabilidad) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="direccionsgsi" id="direccionsgsi" value="{{ old('direccionsgsi', $rolesResponsabilidade->direccionsgsi) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="comiteseguridad" id="comiteseguridad" value="{{ old('comiteseguridad', $rolesResponsabilidade->comiteseguridad) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="responsablesgsi" id="responsablesgsi" value="{{ old('responsablesgsi', $rolesResponsabilidade->responsablesgsi) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="coordinadorsgsi" id="coordinadorsgsi" value="{{ old('coordinadorsgsi', $rolesResponsabilidade->coordinadorsgsi) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="rol" id="rol" value="{{ old('rol', $rolesResponsabilidade->rol) }}">
                            @if($errors->has('rol'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('rol') }}
                                </div>
