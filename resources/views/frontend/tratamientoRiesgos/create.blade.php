...
<div class="card mt-4">
    <div class="col-md-10 col-sm-9 py-3 card-body verde_silent align-self-center" style="margin-top: -40px;">
        <h3 class="mb-1  text-center text-white"><strong> Registrar: </strong> Tratamiento de los Riesgos </h3>
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("tratamiento-riesgos.store") }}" enctype="multipart/form-data" class="row">
            @csrf
