    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tratamiento-riesgos.update", [$tratamientoRiesgo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="nivelriesgo">{{ trans('cruds.tratamientoRiesgo.fields.nivelriesgo') }}</label>
                            <input class="form-control" type="text" name="nivelriesgo" id="nivelriesgo" value="{{ old('nivelriesgo', $tratamientoRiesgo->nivelriesgo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="acciones" id="acciones">{{ old('acciones', $tratamientoRiesgo->acciones) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechacompromiso" id="fechacompromiso" value="{{ old('fechacompromiso', $tratamientoRiesgo->fechacompromiso) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="estatus" id="estatus" value="{{ old('estatus', $tratamientoRiesgo->estatus) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="probabilidad" id="probabilidad" value="{{ old('probabilidad', $tratamientoRiesgo->probabilidad) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="impacto" id="impacto" value="{{ old('impacto', $tratamientoRiesgo->impacto) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nivelriesgoresidual" id="nivelriesgoresidual" value="{{ old('nivelriesgoresidual', $tratamientoRiesgo->nivelriesgoresidual) }}">
