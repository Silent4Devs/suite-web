        ...
        <div class="col-4 justify-content-center" style="border">
            <div class="card justify-content-center">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('documentos.renderViewDocument', $documento_relacionado) }}" target="_blank">
                            ...
                            <div class="row w-100">
                                ...
                                <div class="col-11">
                                    ...
                                    <p class="m-0" style="font-size: 14px; color:#1E3A8A ">Aún no se han agregado Sedes a la
                                        organización
                                        <a href="{{ route('sedes.create') }}" class="item-right col-2 btn text-light" style="background-color:rgb(85, 217, 226); float:right">Agregar</a>
