...
<div class="card mt-4">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.registromejoras.update", [$registromejora->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $registromejora->nombre) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('clasificacion') ? 'is-invalid' : '' }}" type="text" name="clasificacion" id="clasificacion" value="{{ old('clasificacion', $registromejora->clasificacion) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion" id="descripcion">{{ old('descripcion', $registromejora->descripcion) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('participantes') ? 'is-invalid' : '' }}" name="participantes" id="participantes">{{ old('participantes', $registromejora->participantes) }}</textarea>
