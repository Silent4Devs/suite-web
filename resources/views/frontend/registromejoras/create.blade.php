    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.registromejoras.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="participantes" id="participantes">{{ old('participantes') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="recursos" id="recursos">{{ old('recursos') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="beneficios" id="beneficios">{{ old('beneficios') }}</textarea>
