    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tipoactivos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="tipo">{{ trans('cruds.tipoactivo.fields.tipo') }}</label>
                            <input class="form-control" type="text" name="tipo" id="tipo" value="{{ old('tipo', '') }}" required>
                            @if($errors->has('tipo'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="subtipo" id="subtipo" value="{{ old('subtipo', '') }}" required>
