    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.auditoria-anuals.update", [$auditoriaAnual->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechainicio" id="fechainicio" value="{{ old('fechainicio', $auditoriaAnual->fechainicio) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="dias" id="dias" value="{{ old('dias', $auditoriaAnual->dias) }}" step="0.01" min="1" max="100">
                            @if($errors->has('dias'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dias') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="observaciones" id="observaciones">{{ old('observaciones', $auditoriaAnual->observaciones) }}</textarea>
