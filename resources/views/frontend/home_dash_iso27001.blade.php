            ...
            <div class="row">
                <div class="pr-0 col-md-6 card_new">
                    <div class="p-3 mb-2 bg-white rounded row shadow-propia" style="margin-right: 10px;">
                        ...
                        <a id="a_plan" class="btn_ver" href="frontend/planTrabajoBase">
                            Ver Detalle
                        </a>
                    </div>
                </div>
                ...
                <div class="pr-0 col-md-6 card_new">
                  <div class="p-3 mb-2 bg-white rounded row shadow-propia" style="margin-right: 10px;">
                      ...
                      <div style="display: inline-flex; justify-content: center;">
                          <a id="" class="btn_ver" style="margin-left: 0;" href="frontend/carpeta">
                              Carpetas
                          </a>
                          <a id="" class="btn_ver" style="margin-left: 5px;" href="frontend/control-documentos">
                              Lista de documentos
                          </a>
                      </div>
                  </div>
                ...
                <div class="pr-0 col-md-12 card_new">
                    <div class="p-3 mb-2 bg-white rounded row shadow-propia" style="margin-right: 10px;">
                        ...
                        <a id="a_plan" class="btn_ver" href="frontend/indicadores-sgsis">
                            Ver Detalle
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-12 card_new">
                    <div class="p-3 mb-3 bg-white rounded row shadow-propia">
                        ...
                        <div class="w-100" style="min-height: 385px">
                            ...
                            {{-- <a id="a_plan" class="btn_ver" href="frontend/incidentes-de-seguridads">
                                Ver Detalle
                            </a> --}}
                        </div>
    ...
    <div class="row">
        <div class="pr-0 col-md-6 card_new">
            <div class="p-3 mb-3 bg-white rounded row shadow-propia" style="margin-right: 10px;">
                ...
                <a id="a_plan" class="btn_ver" href="frontend/auditoria-anuals">
                    Ver Detalle
                </a>
            </div>
        </div>
        <div class="pr-0 col-md-6 card_new">
            <div class="p-3 mb-3 bg-white rounded row shadow-propia" style="margin-right: 1px;">
                ...
                <div style="display: inline-flex; justify-content: center;">
                    <a id="" class="btn_ver" style="margin-left: 0;" href="frontend/accion-correctivas">
                        Ver Detalle
                    </a>
                    <a id="" class="btn_ver" style="margin-left: 5px;" href="frontend/registromejoras">
                        Ver Detalle
                    </a>
                </div>
            </div>
