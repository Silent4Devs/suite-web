    ...
    <script>
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            let urlAsignar =
                                `/recursos-humanos/evaluacion-360/${data}/objetivos`;
                            let urlShow =
                                `/recursos-humanos/evaluacion-360/${data}/objetivos/lista`;
                            let urlCopiarObjetivos =
                                `/recursos-humanos/evaluacion-360/objetivos/copiar`;
                            let urlVistaCopiarObjetivos =
                                `/recursos-humanos/evaluacion-360/objetivos/${data}/copiar`;
                            let html = `
                            <div class="d-flex">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('btnGuardarCopia').addEventListener('click', function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/recursos-humanos/evaluacion-360/objetivos/copiar",
                    data: formData,
                    dataType: "JSON",
                    processData: false,
                    contentType: false,
