...
<div class="container row">
    ...
    <div class="col-sm-12 col-lg-4 col-md-4 col-12">
        <div class="form-group">
            <label for="meta">
                <i class="fab fa-discourse iconos-crear"></i> Meta a alcanzar <span class="text-danger">*</span>
            </label>
    ...
    <div class="col-sm-12 col-lg-4 col-md-4 col-12">
        <div class="form-group">
            <label for="metrica_id">
                <i class="fab fa-discourse iconos-crear"></i> Métrica <span class="text-danger">*</span>
            </label>
    ...
    <div class="col-sm-12 col-lg-4 col-md-4 col-12">
        <div class="form-group">
            <label for="descripcion_meta">
                <i class="fab fa-discourse iconos-crear"></i>Descripción
            </label>
