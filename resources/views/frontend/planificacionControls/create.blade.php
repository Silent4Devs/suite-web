        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.planificacionControl.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.planificacion-controls.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="activo">{{ trans('cruds.planificacionControl.fields.activo') }}</label>
                            <input class="form-control" type="text" name="activo" id="activo" value="{{ old('activo', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="vulnerabilidad" id="vulnerabilidad" value="{{ old('vulnerabilidad', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="amenaza" id="amenaza" value="{{ old('amenaza', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="confidencialidad" id="confidencialidad" value="{{ old('confidencialidad', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="integridad" id="integridad" value="{{ old('integridad', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="disponibilidad" id="disponibilidad" value="{{ old('disponibilidad', '') }}">
