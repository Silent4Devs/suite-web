        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.objetivosseguridad.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.objetivosseguridads.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="objetivoseguridad">{{ trans('cruds.objetivosseguridad.fields.objetivoseguridad') }}</label>
                            <input class="form-control" type="text" name="objetivoseguridad" id="objetivoseguridad" value="{{ old('objetivoseguridad', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="indicador" id="indicador" value="{{ old('indicador', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="anio" id="anio" value="{{ old('anio') }}">
                            @if($errors->has('anio'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('anio') }}
                                </div>
