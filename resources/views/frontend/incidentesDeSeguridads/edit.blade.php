        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.incidentesDeSeguridad.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.incidentes-de-seguridads.update", [$incidentesDeSeguridad->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="folio">{{ trans('cruds.incidentesDeSeguridad.fields.folio') }}</label>
                            <input class="form-control" type="text" name="folio" id="folio" value="{{ old('folio', $incidentesDeSeguridad->folio) }}" required>
                            @if($errors->has('folio'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="resumen" id="resumen">{{ old('resumen', $incidentesDeSeguridad->resumen) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechaocurrencia" id="fechaocurrencia" value="{{ old('fechaocurrencia', $incidentesDeSeguridad->fechaocurrencia) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="clasificacion" id="clasificacion" value="{{ old('clasificacion', $incidentesDeSeguridad->clasificacion) }}">
