        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.dmaic.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.dmaics.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="definir" id="definir">{{ old('definir') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="medir" id="medir">{{ old('medir') }}</textarea>
                            @if($errors->has('medir'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('medir') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="analizar" id="analizar">{{ old('analizar') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="implementar" id="implementar">{{ old('implementar') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="controlar" id="controlar">{{ old('controlar') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="leccionesaprendidas" id="leccionesaprendidas">{{ old('leccionesaprendidas') }}</textarea>
