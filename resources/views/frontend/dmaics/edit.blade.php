    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.dmaics.update", [$dmaic->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('implementar') ? 'is-invalid' : '' }}" name="implementar" id="implementar">{{ old('implementar', $dmaic->implementar) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('leccionesaprendidas') ? 'is-invalid' : '' }}" name="leccionesaprendidas" id="leccionesaprendidas">{{ old('leccionesaprendidas', $dmaic->leccionesaprendidas) }}</textarea>
