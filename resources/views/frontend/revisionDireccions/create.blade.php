    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.revision-direccions.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="estadorevisionesprevias">{{ trans('cruds.revisionDireccion.fields.estadorevisionesprevias') }}</label>
                            <input class="form-control" type="text" name="estadorevisionesprevias" id="estadorevisionesprevias" value="{{ old('estadorevisionesprevias', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cambiosinternosexternos" id="cambiosinternosexternos" value="{{ old('cambiosinternosexternos', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="retroalimentaciondesempeno" id="retroalimentaciondesempeno" value="{{ old('retroalimentaciondesempeno', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="retroalimentacionpartesinteresadas" id="retroalimentacionpartesinteresadas" value="{{ old('retroalimentacionpartesinteresadas', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="resultadosriesgos" id="resultadosriesgos" value="{{ old('resultadosriesgos', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="oportunidadesmejoracontinua" id="oportunidadesmejoracontinua" value="{{ old('oportunidadesmejoracontinua', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="acuerdoscambios" id="acuerdoscambios">{{ old('acuerdoscambios') }}</textarea>
