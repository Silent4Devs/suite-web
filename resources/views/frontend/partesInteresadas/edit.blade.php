    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.partes-interesadas.update", [$partesInteresada->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="parteinteresada">{{ trans('cruds.partesInteresada.fields.parteinteresada') }}</label>
                            <input class="form-control" type="text" name="parteinteresada" id="parteinteresada" value="{{ old('parteinteresada', $partesInteresada->parteinteresada) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="requisitos" id="requisitos" value="{{ old('requisitos', $partesInteresada->requisitos) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="clausala" id="clausala">{{ old('clausala', $partesInteresada->clausala) }}</textarea>
