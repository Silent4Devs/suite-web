...
@section('content')
	<div class="card">
		...
		<div class="card-body">
			...
			<form method="POST" action="{{ route('frontend.reportes-sugerencias-store') }}" class="row">
				@csrf
				...
				<div class="mt-2 form-group col-12">
					<label class="form-label"><i class="fas fa-text-width iconos-crear"></i> Título corto de la sugerencia</label>
