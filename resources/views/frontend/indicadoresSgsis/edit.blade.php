    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.indicadores-sgsis.update", [$indicadoresSgsi->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="control">{{ trans('cruds.indicadoresSgsi.fields.control') }}</label>
                            <input class="form-control" type="text" name="control" id="control" value="{{ old('control', $indicadoresSgsi->control) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="titulo" id="titulo" value="{{ old('titulo', $indicadoresSgsi->titulo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="formula" id="formula">{{ old('formula', $indicadoresSgsi->formula) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meta" id="meta" value="{{ old('meta', $indicadoresSgsi->meta) }}">
                            @if($errors->has('meta'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('meta') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="enero" id="enero" value="{{ old('enero', $indicadoresSgsi->enero) }}" step="0.01" max="100">
                            @if($errors->has('enero'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('enero') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="febrero" id="febrero" value="{{ old('febrero', $indicadoresSgsi->febrero) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="marzo" id="marzo" value="{{ old('marzo', $indicadoresSgsi->marzo) }}" step="0.01" max="100">
                            @if($errors->has('marzo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('marzo') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="abril" id="abril" value="{{ old('abril', $indicadoresSgsi->abril) }}" step="0.01" max="100">
                            @if($errors->has('abril'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('abril') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="mayo" id="mayo" value="{{ old('mayo', $indicadoresSgsi->mayo) }}" step="0.01" max="100">
                            @if($errors->has('mayo'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('mayo') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="junio" id="junio" value="{{ old('junio', $indicadoresSgsi->junio) }}" step="0.01" max="100">
                            @if($errors->has('junio'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('junio') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="julio" id="julio" value="{{ old('julio', $indicadoresSgsi->julio) }}" step="0.01" max="100">
                            @if($errors->has('julio'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('julio') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="agosto" id="agosto" value="{{ old('agosto', $indicadoresSgsi->agosto) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="septiembre" id="septiembre" value="{{ old('septiembre', $indicadoresSgsi->septiembre) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="octubre" id="octubre" value="{{ old('octubre', $indicadoresSgsi->octubre) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="noviembre" id="noviembre" value="{{ old('noviembre', $indicadoresSgsi->noviembre) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="diciembre" id="diciembre" value="{{ old('diciembre', $indicadoresSgsi->diciembre) }}" step="0.01" max="100">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="anio" id="anio" value="{{ old('anio', $indicadoresSgsi->anio) }}">
                            @if($errors->has('anio'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('anio') }}
                                </div>
