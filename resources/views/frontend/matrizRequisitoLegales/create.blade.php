    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.matriz-requisito-legales.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nombrerequisito">{{ trans('cruds.matrizRequisitoLegale.fields.nombrerequisito') }}</label>
                            <input class="form-control" type="text" name="nombrerequisito" id="nombrerequisito" value="{{ old('nombrerequisito', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechaexpedicion" id="fechaexpedicion" value="{{ old('fechaexpedicion') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="requisitoacumplir" id="requisitoacumplir" value="{{ old('requisitoacumplir', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="formacumple" id="formacumple" value="{{ old('formacumple', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="periodicidad_cumplimiento" id="periodicidad_cumplimiento" value="{{ old('periodicidad_cumplimiento', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechaverificacion" id="fechaverificacion" value="{{ old('fechaverificacion') }}">
