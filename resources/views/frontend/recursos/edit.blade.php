                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.recursos.update", [$recurso->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_curso" id="fecha_curso" value="{{ old('fecha_curso', $recurso->fecha_curso) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="instructor" id="instructor" value="{{ old('instructor', $recurso->instructor) }}">
