    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.informacion-documetadas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="titulodocumento">{{ trans('cruds.informacionDocumetada.fields.titulodocumento') }}</label>
                            <input class="form-control" type="text" name="titulodocumento" id="titulodocumento" value="{{ old('titulodocumento', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="identificador" id="identificador" value="{{ old('identificador', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="version" id="version" value="{{ old('version', '') }}" step="0.01" min="1" max="99">
