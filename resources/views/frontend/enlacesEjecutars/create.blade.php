    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.enlaces-ejecutars.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="ejecutar">{{ trans('cruds.enlacesEjecutar.fields.ejecutar') }}</label>
                            <input class="form-control" type="text" name="ejecutar" id="ejecutar" value="{{ old('ejecutar', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="enlace" id="enlace" value="{{ old('enlace', '') }}">
