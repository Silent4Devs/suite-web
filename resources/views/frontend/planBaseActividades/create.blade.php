        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.planBaseActividade.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plan-base-actividades.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="compromiso" id="compromiso" value="{{ old('compromiso') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="real" id="real" value="{{ old('real') }}">
                            @if($errors->has('real'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('real') }}
                                </div>
