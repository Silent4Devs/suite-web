    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plan-base-actividades.update", [$planBaseActividade->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="actividad">{{ trans('cruds.planBaseActividade.fields.actividad') }}</label>
                            <input class="form-control" type="text" name="actividad" id="actividad" value="{{ old('actividad', $planBaseActividade->actividad) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="actividad_padre_id" id="actividad_padre_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="ejecutar_id" id="ejecutar_id">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="guia-dropzone">
                            </div>
                            @if($errors->has('guia'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('guia') }}
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="estatus_id" id="estatus_id">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="colaborador_id" id="colaborador_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio', $planBaseActividade->fecha_inicio) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin', $planBaseActividade->fecha_fin) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="compromiso" id="compromiso" value="{{ old('compromiso', $planBaseActividade->compromiso) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="real" id="real" value="{{ old('real', $planBaseActividade->real) }}">
                            @if($errors->has('real'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('real') }}
                                </div>
