    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plan-auditoria.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alcance" id="alcance">{{ old('alcance') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="criterios" id="criterios">{{ old('criterios') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="documentoauditar" id="documentoauditar">{{ old('documentoauditar') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="equipoauditor" id="equipoauditor" value="{{ old('equipoauditor', '') }}">
