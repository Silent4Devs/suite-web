        ...
        <div class="col-md-12">
            @can('plan_auditorium_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.plan-auditoria.create') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-PlanAuditorium">
                            <thead>
                                <tr>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $planAuditorium->id }}">
                                        ...
                                        <td>
                                            @can('plan_auditorium_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.plan-auditoria.show', $planAuditorium->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('plan_auditorium_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.plan-auditoria.edit', $planAuditorium->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('plan_auditorium_delete')
                                                <form action="{{ route('frontend.plan-auditoria.destroy', $planAuditorium->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('plan_auditorium_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.plan-auditoria.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-PlanAuditorium:not(.ajaxTable)').DataTable({ buttons: dtButtons })
