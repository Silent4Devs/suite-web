        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.edit') }} {{ trans('cruds.planAuditorium.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.plan-auditoria.update", [$planAuditorium->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="fecha_id">{{ trans('cruds.planAuditorium.fields.fecha') }}</label>
                            <select class="form-control select2" name="fecha_id" id="fecha_id">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="objetivo" id="objetivo">{{ old('objetivo', $planAuditorium->objetivo) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="alcance" id="alcance">{{ old('alcance', $planAuditorium->alcance) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="criterios" id="criterios">{{ old('criterios', $planAuditorium->criterios) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="documentoauditar" id="documentoauditar">{{ old('documentoauditar', $planAuditorium->documentoauditar) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="equipoauditor" id="equipoauditor" value="{{ old('equipoauditor', $planAuditorium->equipoauditor) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="auditados[]" id="auditados" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="descripcion" id="descripcion">{{ old('descripcion', $planAuditorium->descripcion) }}</textarea>
