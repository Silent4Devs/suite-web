    ...
    <div class="mt-5 card">
        @can('team_create')
            <div class="py-3 col-md-10 col-sm-9 card card-body bg-primary align-self-center " style="margin-top:-40px; ">
                <h3 class="mb-2 text-center text-white"><strong>Equipos</strong></h3>
            </div>
        @endcan
        <div class="card-body datatable-fix">
            <table class="table table-bordered w-100 datatable-Team">
...
@section('scripts')
    ...
    <script>
        $(function() {
            let dtButtons = [{
                    extend: 'csvHtml5',
                    title: `Equipos ${new Date().toLocaleDateString().trim()}`,
