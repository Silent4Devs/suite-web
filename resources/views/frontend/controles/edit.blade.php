...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("controles.update", [$controle->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="numero">{{ trans('cruds.controle.fields.numero') }}</label>
                <input class="form-control {{ $errors->has('numero') ? 'is-invalid' : '' }}" type="text" name="numero" id="numero" value="{{ old('numero', $controle->numero) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('control') ? 'is-invalid' : '' }}" type="text" name="control" id="control" value="{{ old('control', $controle->control) }}">
