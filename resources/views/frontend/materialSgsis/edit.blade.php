    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.material-sgsis.update", [$materialSgsi->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="objetivo">{{ trans('cruds.materialSgsi.fields.objetivo') }}</label>
                            <input class="form-control" type="text" name="objetivo" id="objetivo" value="{{ old('objetivo', $materialSgsi->objetivo) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechacreacion_actualizacion" id="fechacreacion_actualizacion" value="{{ old('fechacreacion_actualizacion', $materialSgsi->fechacreacion_actualizacion) }}">
