...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("gap-tres.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="pregunta">{{ trans('cruds.gapTre.fields.pregunta') }}</label>
                <input class="form-control {{ $errors->has('pregunta') ? 'is-invalid' : '' }}" type="text" name="pregunta" id="pregunta" value="{{ old('pregunta', '') }}">
