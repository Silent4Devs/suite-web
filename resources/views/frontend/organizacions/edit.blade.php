    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.organizacions.update", [$organizacion->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="empresa">{{ trans('cruds.organizacion.fields.empresa') }}</label>
                            <input class="form-control" type="text" name="empresa" id="empresa" value="{{ old('empresa', $organizacion->empresa) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="direccion" id="direccion" required>{{ old('direccion', $organizacion->direccion) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="telefono" id="telefono" value="{{ old('telefono', $organizacion->telefono) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="correo" id="correo" value="{{ old('correo', $organizacion->correo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pagina_web" id="pagina_web" value="{{ old('pagina_web', $organizacion->pagina_web) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="giro" id="giro" value="{{ old('giro', $organizacion->giro) }}">
                            @if($errors->has('giro'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('giro') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="servicios" id="servicios" value="{{ old('servicios', $organizacion->servicios) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="mision" id="mision">{{ old('mision', $organizacion->mision) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="vision" id="vision">{{ old('vision', $organizacion->vision) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="valores" id="valores">{{ old('valores', $organizacion->valores) }}</textarea>
