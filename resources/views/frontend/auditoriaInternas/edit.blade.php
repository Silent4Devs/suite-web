    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.auditoria-internas.update", [$auditoriaInterna->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="alcance">{{ trans('cruds.auditoriaInterna.fields.alcance') }}</label>
                            <input class="form-control" type="text" name="alcance" id="alcance" value="{{ old('alcance', $auditoriaInterna->alcance) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="clausulas_id" id="clausulas_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechaauditoria" id="fechaauditoria" value="{{ old('fechaauditoria', $auditoriaInterna->fechaauditoria) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="equipoauditoria_id" id="equipoauditoria_id">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="hallazgos" id="hallazgos">{{ old('hallazgos', $auditoriaInterna->hallazgos) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="cheknoconformidadmenor" id="cheknoconformidadmenor" value="1" {{ $auditoriaInterna->cheknoconformidadmenor || old('cheknoconformidadmenor', 0) === 1 ? 'checked' : '' }}>
                                <label for="cheknoconformidadmenor">{{ trans('cruds.auditoriaInterna.fields.cheknoconformidadmenor') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalnoconformidadmenor" id="totalnoconformidadmenor" value="{{ old('totalnoconformidadmenor', $auditoriaInterna->totalnoconformidadmenor) }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checknoconformidadmayor" id="checknoconformidadmayor" value="1" {{ $auditoriaInterna->checknoconformidadmayor || old('checknoconformidadmayor', 0) === 1 ? 'checked' : '' }}>
                                <label for="checknoconformidadmayor">{{ trans('cruds.auditoriaInterna.fields.checknoconformidadmayor') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalnoconformidadmayor" id="totalnoconformidadmayor" value="{{ old('totalnoconformidadmayor', $auditoriaInterna->totalnoconformidadmayor) }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checkobservacion" id="checkobservacion" value="1" {{ $auditoriaInterna->checkobservacion || old('checkobservacion', 0) === 1 ? 'checked' : '' }}>
                                <label for="checkobservacion">{{ trans('cruds.auditoriaInterna.fields.checkobservacion') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalobservacion" id="totalobservacion" value="{{ old('totalobservacion', $auditoriaInterna->totalobservacion) }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checkmejora" id="checkmejora" value="1" {{ $auditoriaInterna->checkmejora || old('checkmejora', 0) === 1 ? 'checked' : '' }}>
                                <label for="checkmejora">{{ trans('cruds.auditoriaInterna.fields.checkmejora') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalmejora" id="totalmejora" value="{{ old('totalmejora', $auditoriaInterna->totalmejora) }}" step="0.01" max="99">
