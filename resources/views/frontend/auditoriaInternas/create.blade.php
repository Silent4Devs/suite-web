        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.auditoriaInterna.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.auditoria-internas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="alcance">{{ trans('cruds.auditoriaInterna.fields.alcance') }}</label>
                            <input class="form-control" type="text" name="alcance" id="alcance" value="{{ old('alcance', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechaauditoria" id="fechaauditoria" value="{{ old('fechaauditoria') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="hallazgos" id="hallazgos">{{ old('hallazgos') }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="cheknoconformidadmenor" id="cheknoconformidadmenor" value="1" {{ old('cheknoconformidadmenor', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalnoconformidadmenor" id="totalnoconformidadmenor" value="{{ old('totalnoconformidadmenor', '') }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checknoconformidadmayor" id="checknoconformidadmayor" value="1" {{ old('checknoconformidadmayor', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalnoconformidadmayor" id="totalnoconformidadmayor" value="{{ old('totalnoconformidadmayor', '') }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checkobservacion" id="checkobservacion" value="1" {{ old('checkobservacion', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalobservacion" id="totalobservacion" value="{{ old('totalobservacion', '') }}" step="0.01" max="99">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="checkmejora" id="checkmejora" value="1" {{ old('checkmejora', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="totalmejora" id="totalmejora" value="{{ old('totalmejora', '') }}" step="0.01" max="99">
