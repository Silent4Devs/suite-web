    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.planaccion-correctivas.update", [$planaccionCorrectiva->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="actividad" id="actividad" value="{{ old('actividad', $planaccionCorrectiva->actividad) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fechacompromiso" id="fechacompromiso" value="{{ old('fechacompromiso', $planaccionCorrectiva->fechacompromiso) }}">
