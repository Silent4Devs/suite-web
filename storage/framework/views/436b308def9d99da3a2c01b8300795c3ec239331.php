...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/yearpicker.css')); ?>">
    <!-- x-editable -->
...
<body class="">
                    ...
                    <li class="c-header-nav-item dropdown show">
                        <a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button"
                            ...
                            <div style="width:100%; display: flex; align-items: center;">
                                <?php if(auth()->user()->empleado): ?>
                                    <div style="width: 40px; overflow:hidden;" class="mr-2">

                                        <img class="img_empleado" style=""
                                            src="<?php echo e(asset('storage/empleados/imagenes/' . '/' . auth()->user()->empleado->avatar)); ?>"
                                            alt="<?php echo e(auth()->user()->empleado->name); ?>">
                                    </div>
                                    <div class="d-mobile-none">
                                        <span class="mr-2" style="font-weight: bold;">
                                            <?php echo e(auth()->user()->empleado ? explode(' ', auth()->user()->empleado->name)[0] : ''); ?>

                                        </span>
                                        <p class="m-0" style="font-size: 8px">
                                            <?php echo e(auth()->user()->empleado ? Str::limit(auth()->user()->empleado->puesto, 30, '...') : ''); ?>
                                        ...
                                        <div class="p-2">
                                            <?php if(auth()->user()->empleado): ?>
                                                <p class="m-0 mt-2 text-muted" style="font-size:14px">Hola,
                                                    <strong><?php echo e(auth()->user()->empleado->name); ?></strong>
                                                </p>
                                            <?php else: ?>
                                        ...
                                        <div class="px-3 mt-1 d-flex justify-content-center">
                                            <?php if(file_exists(app_path('Http/Controllers/Auth/ChangePasswordController.php'))): ?>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('profile_password_edit')): ?>
                                                    <a style="all: unset; color: #747474; cursor: pointer;"
                                                        class=" <?php echo e(request()->is('profile/password') || request()->is('profile/password/*') ? 'active' : ''); ?>"
    ...
    <div id="tabla_imprimir_global" class="d-none">
        <div id="contenido_imprimir">
            <table class="encabezado-print">
                <tr>
                    <td style="width: 25%;">
                        <img src="<?php echo e(asset($logotipo)); ?>" class="img_logo" style="height: 70px;">
                    </td>
                    <td style="width: 50%;">
                        <h4><strong><?php echo e(!is_null($organizacion) ? $organizacion->empresa : 'Tabantaj'); ?></strong></h4>
                        <div id="titulo_tabla"></div>
                    </td>
                    <td style="width: 25%;" class="encabezado_print_td_no_paginas">
                        Fecha: <?php echo e($hoy_format_global); ?> <br>
                    </td>
                </tr>
            </table>
    ...
    <div class="barra-herramientas-bottom-molbile">
        <a href="<?php echo e(route('admin.inicio-Usuario.index')); ?>#datos" class="btn-barra-bottom-mobile" <?php echo e(request()->is('admin/inicioUsuario') || request()->is('admin/inicioUsuario/*') || request()->is('admin/competencias/*/cv') ? 'style=color:#3086AF !important;"' : ''); ?>>
            <i class="bi bi-file-person"></i>
            <p>Perfil</p>
        </a>
        <a href="<?php echo e(route('admin.timesheet-inicio')); ?>" class="btn-barra-bottom-mobile" <?php echo e(request()->is('admin/timesheet') || request()->is('admin/timesheet/*') ? 'style=color:#3086AF !important;"' : ''); ?>>
            <i class="bi bi-calendar3-range"></i>
            <p>Timesheet</p>
        </a>
        <a href="<?php echo e(route('admin.systemCalendar')); ?>" class="btn-barra-bottom-mobile" <?php echo e(request()->is('admin/system-calendar') || request()->is('admin/system-calendar/*') ? 'style=color:#3086AF !important;"' : ''); ?>>
            <i class="bi bi-calendar3"></i>
            <p>Calendario</p>
        </a>
        <a href="<?php echo e(route('admin.portal-comunicacion.index')); ?>" class="btn-barra-bottom-mobile" <?php echo e(request()->is('admin/portal-comunicacion') || request()->is('admin/portal-comunicacion/*') ? 'style=color:#3086AF !important;"' : ''); ?>>
    ...
    <script>
        <?php if(auth()->user()->empleado): ?>
            window.NotificationUser = <?php echo json_encode(['user' => auth()->check() ? auth()->user()->empleado->id : null]); ?>;
        <?php else: ?>
    ...
    <script src="<?php echo e(asset('js/buttons.print.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('js/yearpicker.js')); ?>"></script>
...
<?php endif; ?>
    ...
    <script>
        ...
        <?php echo $__env->yieldContent('x-editable'); ?>
    </script>
    <!-- x-editable -->
    ...
    <script>
        $(document).ready(function() {
            let url = "<?php echo e(route('admin.globalStructureSearch')); ?>";
