...
<div id="modal_aviso">
    <div class="contenido_modal card">
        ...
        <div class="modal_header">
            <img src="<?php echo e(asset('img/silent4business.png')); ?>">
            <h4>SILENT4BUSINESS S.A. DE C.V.</h4>
            <img src="<?php echo e(asset('img/logo_policromatico.png')); ?>" style="height: 85px;">
        </div>
        <hr>
...
<?php /**PATH /var/www/html/resources/views/auth/aviso-privacidad-s4b.blade.php ENDPATH**/ ?>