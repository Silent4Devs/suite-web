        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <div class=" alert alert-danger alert-dismissible fade show" role="alert"
                    ...
                    <?php echo e(session('deleted')); ?> <button type="button" class="close" data-dismiss="alert"
                        aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/partials/flashMessages.blade.php ENDPATH**/ ?>