        ...
        switch ($valor) {
            case 'Contexto de la organización':
                ...
                if (! $control_documento) {
                    $this->dispatch('showErrorAlert', 'No existe el control de documento:'.$control_documento->nombre);
                    ...
                    if (is_null($control_documento->clave) || is_null($control_documento->fecha_creacion) || is_null($control_documento->elaboro_id) || is_null($control_documento->reviso_id)) {
                        $this->dispatch('showErrorAlert', 'Tienes que llenar los campos faltantes del control de documento: '.$control_documento->nombre);
            ...
            case 'Test':
                ...
                break;
            default:
                $this->dispatch('showErrorAlert', 'Algo salió, no existe el control de documento con el nombre: '.$this->nombre_documento);
                break;
        }
