...
class FinanzasDashboard extends Component
{
    ...
    public function search($data)
    {
        ...
        $this->dispatch('datosActualizados', nombres:$this->nombre = $nombres, horastrabajada:$this->horastrabajada = $horas_trabajadas, horaTotal:$this->horaTotal = $totalhoras, horaCosto:$this->horaCosto = $horasCosto, proyectos:$this->proyectos = TimesheetProyecto::select('proyecto')->find($id));
    }
}
