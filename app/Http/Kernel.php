...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\Auth\AuthGates::class,
    ...
    protected $routeMiddleware = [
        ...
        'isActive' => \App\Http\Middleware\User\IsActiveUser::class,
        ...
        'admin' => \App\Http\Middleware\User\IsAdmin::class,
        '2fa' => \App\Http\Middleware\TwoFactorMiddleware::class,
        'cors' => \App\Http\Middleware\Cors::class,
        'primeros.pasos' => \App\Http\Middleware\User\PrimerosPasos::class,
