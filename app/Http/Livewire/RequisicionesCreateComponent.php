...
class RequisicionesCreateComponent extends Component
{
    ...
    {
        $this->sucursales = KatbolSucursal::getAll()->where('archivo', false);
        $this->proveedores = KatbolProveedorOC::getAll()->where('estado', false);
        $this->compradores = KatbolComprador::getAllWithUser()->where('archivo', false);
        $this->contratos = KatbolContrato::getAll();
        $this->productos = KatbolProducto::getAll()->where('archivo', false);
