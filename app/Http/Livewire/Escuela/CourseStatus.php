...
class CourseStatus extends Component
{
    ...
    public function mount(Course $course, Evaluation $evaluacionesLeccion){
        $this->course = $course;
        //Evaluaciones para el curso en general
        $this->evaluacionesGenerales= Evaluation::where('course_id',$this->course->id)->get();
        $this->evaluationsUser=UserEvaluation::where('user_id',auth()->id())->where('completed',true)->pluck('evaluation_id')->toArray();
