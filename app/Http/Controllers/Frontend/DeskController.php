...
class DeskController extends Controller
{
    ...
    public function updateSeguridad(Request $request, $id_incidente)
    {
        ...
        return redirect()->route('Frontend.desk.seguridad-edit', $id_incidente)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisSeguridad(Request $request, $id_incidente)
    {
        ...
        return redirect()->route('Frontend.desk.seguridad-edit', $analisis_seguridad->seguridad_id)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateRiesgos(Request $request, $id_riesgos)
    {
        ...
        return redirect()->route('Frontend.desk.index')->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisReisgos(Request $request, $id_riesgos)
    {
        ...
        return redirect()->route('Frontend.desk.riesgos-edit', $analisis_seguridad->riesgos_id)->with('success', 'Reporte actualizado');
    }
    ...
    public function editQuejas(Request $request, $id_quejas)
    {
        ...
        return view('Frontend.desk.quejas.edit', compact('quejas', 'procesos', 'empleados', 'areas', 'activos', 'sedes', 'analisis'));
    }
    ...
    public function updateQuejas(Request $request, $id_quejas)
    {
        ...
        return redirect()->route('Frontend.desk.quejas-edit', $id_quejas)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisQuejas(Request $request, $id_quejas)
    {
        ...
        return redirect()->route('Frontend.desk.quejas-edit', $analisis_seguridad->quejas_id)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisDenuncias(Request $request, $id_denuncias)
    {
        ...
        return redirect()->route('Frontend.desk.denuncias-edit', $analisis_seguridad->denuncias_id)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateMejoras(Request $request, $id_mejoras)
    {
        ...
        return redirect()->route('Frontend.desk.mejoras-edit', $id_mejoras)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisMejoras(Request $request, $id_mejoras)
    {
        ...
        return redirect()->route('Frontend.desk.mejoras-edit', $analisis_seguridad->mejoras_id)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateSugerencias(Request $request, $id_sugerencias)
    {
        ...
        return redirect()->route('Frontend.desk.sugerencias-edit', $id_sugerencias)->with('success', 'Reporte actualizado');
    }
    ...
    public function updateAnalisisSugerencias(Request $request, $id_sugerencias)
    {
        ...
        return redirect()->route('Frontend.desk.sugerencias-edit', $analisis_seguridad->sugerencias_id)->with('success', 'Reporte actualizado');
    }
}
