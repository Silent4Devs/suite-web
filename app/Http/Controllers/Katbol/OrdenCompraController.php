...
use App\Models\Katbol\CentroCosto as KatbolCentroCosto;
use App\Models\Katbol\Comprador as KatbolComprador;
use App\Models\Katbol\Contrato as KatbolContrato;
use App\Models\Katbol\Moneda as KatbolMoneda;
use App\Models\Katbol\ProductoRequisicion as KatbolProductoRequisicion;
...
class OrdenCompraController extends Controller
{
    ...
    public function index()
    {
            ...
            return view('katbol.ordenes-compra.index', compact('ids', 'requisiciones', 'empresa_actual', 'logo_actual', 'proveedor_indistinto'));
    ...
    public function show($id)
    {
        ...
        return view('katbol.ordenes-compra.show', compact('requisicion','organizacion'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('katbol.ordenes-compra.edit', compact('requisicion', 'proveedores', 'contratos', 'centro_costos', 'monedas'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('katbol.orden-compra.firmar', ['tipo_firma' => 'firma_comprador_orden', 'id' => $requisicion->id]));
    }
    ...
    public function firmar($tipo_firma, $id)
    {
            ...
            return view('katbol.ordenes-compra.firmar', compact('requisicion', 'proveedores', 'organizacion', 'contrato', 'comprador', 'tipo_firma', 'proveedores_catalogo'));
    }
