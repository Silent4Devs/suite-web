...
class ContratosController extends AppBaseController
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'minimo' => 'nullable|numeric|max:99999999999.99|lte:monto_pago',
            'maximo' => 'nullable|numeric|max:99999999999.99|gte:monto_pago',
            'monto_dolares' => 'nullable|numeric|max:99999999999.99',
            'maximo_dolares' => 'nullable|numeric|max:99999999999.99|lte:monto_dolares',
            'minimo_dolares' => 'nullable|numeric|max:99999999999.99|gte:monto_dolares',
