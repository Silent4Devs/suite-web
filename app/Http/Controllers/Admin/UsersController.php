...
class UsersController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = User::with(['roles', 'organizacion', 'area', 'puesto', 'team'])->select(sprintf('%s.*', (new User)->table));
        ...
        return view('admin.users.index', compact('roles', 'organizaciones', 'areas', 'puestos', 'teams'));
    }
