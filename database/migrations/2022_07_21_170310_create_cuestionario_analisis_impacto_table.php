...
class CreateCuestionarioAnalisisImpactoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cuestionario_analisis_impacto', function (Blueprint $table) {
            ...
            $table->integer('p_diaria')->default(1)->nullable();
            $table->integer('p_semanal')->default(1)->nullable();
            $table->integer('p_mensual')->default(1)->nullable();
            $table->integer('p_otro')->default(1)->nullable();
