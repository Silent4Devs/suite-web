...
class CreateCuestionarioAnalisisImpactoTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('cuestionario_analisis_impacto', function (Blueprint $table) {
            ...
            $table->integer('periodicidad_diario')->default(0)->nullable();
            $table->integer('periodicidad_quincenal')->default(0)->nullable();
            $table->integer('periodicidad_mensual')->default(0)->nullable();
            $table->integer('periodicidad_otro')->default(0)->nullable();
            ...
            $table->integer('flujo_años')->default(0)->nullable();
            $table->integer('flujo_meses')->default(0)->nullable();
            $table->integer('flujo_semanas')->default(0)->nullable();
            $table->integer('flujo_dias')->default(0)->nullable();
            $table->integer('flujo_otro')->default(0)->nullable();
