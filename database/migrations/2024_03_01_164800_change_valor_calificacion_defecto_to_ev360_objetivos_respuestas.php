...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('ev360_objetivos_calificaciones', function (Blueprint $table) {
            ...
            $table->integer('calificacion_persepcion')->nullable()->default(null)->change();
        });
    }
    ...
    public function down(): void
    {
        Schema::table('ev360_objetivos_calificaciones', function (Blueprint $table) {
            ...
            $table->integer('calificacion_persepcion')->default(0)->change(); // Change the default value as needed
        });
    }
};
