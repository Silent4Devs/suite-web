...
class CreateProcesosHistoricosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('procesos_historicos', function (Blueprint $table) {
            // $table->increments('id');
    ...
    {
        Schema::dropIfExists('procesos_historicos');
    }
}
