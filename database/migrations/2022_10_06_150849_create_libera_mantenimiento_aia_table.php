...
class CreateLiberaMantenimientoAiaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('libera_mantenimiento_aia', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('libera_mantenimiento_aia');
    }
}
