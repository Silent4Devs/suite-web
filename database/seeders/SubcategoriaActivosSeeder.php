...
class SubcategoriaActivosSeeder extends Seeder
{
    ...
    public function run()
    {
        $subcategorias = [
            ...
            [
                'subcategoria' => 'Banco de pilas',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Modulo de potencia',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Modulo de inteligente',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Rectificador de ondas',
                'categoria_id' => '1',
            ],
            [
            ...
            [
                'subcategoria' => 'Controladora de AV',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Equipo de telepresencia',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'CODEC de telepresencia',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Power supply',
                'categoria_id' => '1',
            ],
            [
                'subcategoria' => 'Consola de Videojuegos',
                'categoria_id' => '1',
            ],
            [
            ...
            [
                'subcategoria' => 'Videojuego',
                'categoria_id' => '2',
            ],
            [
                'subcategoria' => 'Respaldo',
                'categoria_id' => '2',
            ],
            [
            ...
            [
                'subcategoria' => 'Archivero',
                'categoria_id' => '3',
            ],
            [
                'subcategoria' => 'Trituradora de papel',
                'categoria_id' => '3',
            ],
            [
            ...
            [
                'subcategoria' => 'Perchero',
                'categoria_id' => '3',
            ],
            [
                'subcategoria' => 'Bote basura',
                'categoria_id' => '3',
            ],
            [
                'subcategoria' => 'Cajonera',
                'categoria_id' => '3',
            ],
            [
            ...
            [
                'subcategoria' => 'Etiquetadora',
                'categoria_id' => '4',
            ],
            [
                'subcategoria' => 'Rotulador',
                'categoria_id' => '4',
            ],
            [
                'subcategoria' => 'Detector de humo',
                'categoria_id' => '4',
            ],
            [
                'subcategoria' => 'Tóner',
            ...
            [
                'subcategoria' => 'Pinzas ponchadoras',
                'categoria_id' => '6',
            ],
            [
                'subcategoria' => 'Tester cable',
                'categoria_id' => '6',
            ],
            [
            ...
            [
                'subcategoria' => 'Control de Sistemas',
                'categoria_id' => '7',
            ],
