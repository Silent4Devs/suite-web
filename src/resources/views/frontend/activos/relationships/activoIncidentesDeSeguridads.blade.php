                        ...
                        <tr data-entry-id="{{ $incidentesDeSeguridad->id }}">
                            ...
                            <td>
                                ...
                                @can('incidentes_de_seguridad_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.incidentes-de-seguridads.edit', $incidentesDeSeguridad->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('incidentes_de_seguridad_delete')
                                    <form action="{{ route('admin.incidentes-de-seguridads.destroy', $incidentesDeSeguridad->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
