                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.profile.password") }}">
                        ...
                        <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                            <label class="required" for="password">Nueva {{ trans('cruds.user.fields.password') }}</label>
                        ...
                        <div class="form-group">
                            <label class="required" for="password_confirmation">Confirmar nueva {{ trans('cruds.user.fields.password') }}</label>
